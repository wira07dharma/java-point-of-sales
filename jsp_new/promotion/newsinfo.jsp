                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class='box-footer'>
                                        <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                            <i class="fa fa-plus"></i> <%= textListButton[SESS_LANGUAGE][0] %>
                                        </button>
            ...
            <div class="modal-dialog nonprint">
                <div class="modal-content">
                    ...
                    <form id="generalform">
                        ...
                        <input type="hidden" name="FRM_FIELD_REAL_PATH" value="<%= request.getRealPath("imgupload/marketing")%>">
                        <input type="hidden" name="FRM_FIELD_APP_ROOT" value="<%= approot%>">
    ...
    $(document).ready(function(){   
        ...
        addeditgeneral = function (elementId) {
            $(elementId).click(function () {
                ...
                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxMarketingNewsInfo", ".addeditgeneral-body", false, "json");
            });
        };
        ...
        deletegeneral = function (tableId, elementId) {
            ...
            $(tableId).on("click", elementId, function () {
                ...
                if (confirm(confirmText)) {
                    ...
                    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxMarketingNewsInfo", null, true, "json");
        ...
        function runDataTables() {
            dataTablesOptions("#newsInfoElement", "tableNewsInfoElement", "AjaxMarketingNewsInfo", "list", callBackDataTables);
        }
