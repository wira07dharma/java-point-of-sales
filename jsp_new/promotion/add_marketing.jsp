...
<%
    ...
    if(oid != 0){
       ...
       marketingType = entMarketingManagement.getMarketing_type();
            ...
            <form class="form1" id="main-form">
             <div class="col-md-9 main-bar">
                    ...
                    <div class="row row1">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="FRM_MARKETING_MANAGEMENT_TYPE">
                                <option <%=selected%> value="1">E-Katalog</option>
                                <option <%=selected1%> value="2">E-Price</option>
                                <option <%=selected2%> value="3">E-Brosur</option>                                
                            </select>
                        </div>
                    </div>
                    <div class="row row1">
                    ...
                    <div class="row row1">
                        ...
                        <div class="col-md-3 prevImage">
                          ...
                          <div class="col-md-2">
                              <button name="button" class="btn btn-upload">Upload</button>
                          </div>
                    </div>
                    <div class="row row1">
                        <div class="col-md-3">
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#btn-go-dashboard").click(function(){
                   window.location='marketing_management.jsp';
                });    
