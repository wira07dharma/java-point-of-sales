...
<%!   /* this constant used to list text of listHeader */
    ...
    public String drawListBillDetailAdd(int language, int iCommandDetail, FrmBillDetail frmObject,
        ...
        if (iCommandDetail == Command.ADD || (iCommandDetail == Command.SAVE && frmObject.errorSize() > 0)) {
            ...
            rowx.add("<div align=\"right\"><input tabindex=\"21\" type=\"text\" size=\"3\" id=\"qtyInput\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_QTY] + "\" value=\"\" class=\"formElemen\" onkeyup=\"javascript:calculate()\" onKeyPress=\"keybrdPress(this, event, this.value)\"  style=\"text-align:right\"></div>");
...
//                salesCurrencyId = sales.getDefaultCurrencyId(); 2020-01-02 by wira dalam proses peralihan sales to user
            }
//            Vector listSalesOrder = PstSales.list(0, 0, PstSales.fieldNames[PstSales.FLD_CODE] + " ='" + salesCode + "'", "");
            //long locationSales=0;
            //long salesCurrencyId=0;
...
//            }
            ...
            //Mencari selling Rate Comment 2020-01-02 Peralihan
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function keybrdPress(frmObj, event, value) {
                ...
                var notaType = document.frmcashier.nota_type.value;
                var frmObj = document.getElementById("qtyInput").getAttribute("name");
                ...
                function keybrdPressTotal(frmObj, event) {
                    ...
                    function cmdApproval(code){
                        ...
                        if(custType !=""){
                            ...
                            alert("Customer Belum di Pilih, Silahkan pilih Customer terlebih dahulu");
                        }
                    ...
                    function cmdBack(){
                        ...
                        if(oidbillmain == 0){
                            ...
                            document.frmcashier.command.value="<%=Command.BACK%>";
                            document.frmcashier.action="srcsalesordecashier.jsp";
                            document.frmcashier.submit();
                        }else{
                                                                        ...
                                                                        <td width="63%">
                                                                            <%      Vector val_notatype = new Vector(1, 1);
                                                                                        ...
                                                                                        val_notatype.add("" + PstBillMain.NONE);
                                                                                          if(typeSalesOrder==1){
                                                                                            key_notatype.add("Incoming Sales Order");
                                                                                          }else{
                                                            ...
                                                            <td colspan="2" rowspan="5" valign="top">
                                                                ...
                                                                <table width="107%" border="0" cellspacing="2" cellpadding="2">
                                                                    <tr>
                                                                        ...
                                                                        <td width="74%"><label>
                                                                                <input name="<%=frmBillMain.fieldNames[FrmBillMain.FRM_FIELD_CUSTOMER_ID]%>" type="hidden" value="<%=custId==0?"":custId%>" size="15" maxlength="64" >
                                                                                <%
                                                ...
                                                <table width="17%" align="left" border="0" cellspacing="2" cellpadding="3">
                                                    <tr>
                                                        ...
                                                        <td ><%if (transStatusTmp != 1 && idNotaType != PstBillMain.RETUR_ALL && idNotaType != PstBillMain.RETUR) {%>
                                                            ...
                                                            <input type="button" name="Button" value="Save Detail" onClick="javascript:cmdSaveDetail()"  class="styleButton">
                                                            <%}%>
                                                        </td>
