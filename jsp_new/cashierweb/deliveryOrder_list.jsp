    ...
    <head>
        ...
        <script language="JavaScript">   
            ...
            function cmdEdit(oid){
                document.frmdlvrorderlist.start.value=0;
                document.frmdlvrorderlist.oidbillmaintmp.value = oid;
                document.frmdlvrorderlist.commandDetail.value="<%=Command.LIST%>";
                document.frmdlvrorderlist.command.value="<%=Command.EDIT%>";
                document.frmdlvrorderlist.action="delivery_order.jsp";

                document.frmdlvrorderlist.submit();

            }

            function cmdListFirst(){
                document.frmdlvrorderlist.command.value="<%=Command.FIRST%>";
                document.frmdlvrorderlist.action="delivery_order.jsp";
                document.frmdlvrorderlist.submit();
            }

            function cmdListPrev(){
                document.frmdlvrorderlist.command.value="<%=Command.PREV%>";
                document.frmdlvrorderlist.action="delivery_order.jsp";
                document.frmdlvrorderlist.submit();
            }

            function cmdListNext(){
                document.frmdlvrorderlist.command.value="<%=Command.NEXT%>";
                document.frmdlvrorderlist.action="delivery_order.jsp";
                document.frmdlvrorderlist.submit();
            }

            function cmdListLast(){
                document.frmdlvrorderlist.command.value="<%=Command.LAST%>";
                document.frmdlvrorderlist.action="delivery_order.jsp";
                document.frmdlvrorderlist.submit();
            }

            function cmdBack(){
                document.frmdlvrorderlist.command.value="<%=Command.BACK%>";
                document.frmdlvrorderlist.action="srcDeliveryOrder.jsp";
                document.frmdlvrorderlist.submit();
            }
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td><!-- #BeginEditable "content" -->
                                <form name="frmdlvrorderlist" method="post" action="">
