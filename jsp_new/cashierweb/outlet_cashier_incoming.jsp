<%-- 
    Document   : outlet_cashier_incoming
    Created on : Nov 5, 2013, 5:19:49 PM
    Author     : dimata005
--%>
...
<%!   /* this constant used to list text of listHeader */
    public static final String textMaterialHeader[][] = {
        {"Nota Type", "Number", "Customer Type", "Payment Type", "Bookeeping Currency", "Sales Currency", "Date", "Delivery Address", "Tel/Hp", "Zip", "Customer", //11
            "Person", "Credit Limit", "Outstanding", "Available", "Sales", "City", "Province", "Country", "Total", "Paid", "Change", "Fax", "Discount", "Tax","Notes"}, //11
        {"Nota Type", "Number", "Customer Type", "Payment Type", "Bookeeping Curreny", "Sales Currency", "Date", "Delivery Address", "Tel/Hp", "Zip", "Customer",
            "Person", "Credit Limit", "Outstanding", "Available", "Sales", "City", "Province", "Country", "Total", "Paid", "Change", "Fax", "Discount", "Tax","Notes"}
    };
        ...
        if (iCommandDetail == Command.ADD || (iCommandDetail == Command.SAVE && frmObject.errorSize() > 0)) {
            ...
            if (idNotaType == PstBillMain.RETUR || idNotaType == PstBillMain.RETUR_ALL) {
                rowx.add("<input type=\"hidden\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_UNIT_ID] + "\" value=\"\">"
                        ...
                        + "<input tabindex=\"18\" type=\"text\" size=\"13\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_SKU] + "\" value=\"\" onKeyPress=\"javascript:keybrdPress(this, event)\" class=\"formElemen\"><a tabindex=\"19\" href=\"javascript:cmdCheckRetur()\">CHK</a>");
                rowx.add("<input type=\"text\" tabindex=\"20\" size=\"20\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_ITEM_NAME] + "\" value=\"" + "" + "\" class=\"formElemen\" onKeyPress=\"javascript:keybrdPress(this, event)\"><a href=\"javascript:cmdCheckRetur()\">CHK</a>");
            } else {
                rowx.add("<input type=\"hidden\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_UNIT_ID] + "\" value=\"\">"
                        + "<input type=\"hidden\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_MATERIAL_ID] + "\" value=\"\">"
                        + "<input tabindex=\"18\" type=\"text\" size=\"13\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_SKU] + "\" value=\"\" onKeyPress=\"javascript:keybrdPress(this, event)\" class=\"formElemen\"><a tabindex=\"19\" href=\"javascript:cmdCheck()\">CHK</a>");
                rowx.add("<input type=\"text\" size=\"20\" tabindex=\"20\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_ITEM_NAME] + "\" value=\"" + "" + "\" class=\"formElemen\" onKeyPress=\"javascript:keybrdPress(this, event)\"><a href=\"javascript:cmdCheck()\">CHK</a>");
            }
...
//            }
            ...
            //Mencari selling Rate di kasir harus di buatkan standart penggunaan.
            //String where =  PstDailyRate.fieldNames[PstDailyRate.FLD_CURRENCY_TYPE_ID] + "=" + currType.getOID()+" AND " + PstDailyRate.fieldNames[PstDailyRate.FLD_ROSTER_DATE]+"<=(NOW())";
...
<html><!-- #BeginTemplate "/Templates/main.dwt" --><!-- DW6 -->
        ...
        <SCRIPT language=JavaScript>
            ...
            function keybrdPress(frmObj, event) {
                ...
                function keybrdPressTotal(frmObj, event) {
                    ...
                    function cmdCheck2(){
                        var strvalue  = "customersearch.jsp?command=<%=Command.FIRST%>";
                        window.open(strvalue,"customer", "height=600,width=700,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes");
                    }
            ...
            <tr>
                <td valign="top" align="left">
                    <form name="frmcashier" method ="post" action="">
                        ...
                        <input type="hidden" name="<%=FrmBillMain.fieldNames[FrmBillMain.FRM_FIELD_TYPE_SALES_ORDER]%>" value="1">
                        
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td height="20" class="mainheader"><center><h2>Sales Order Incoming by <%=salesCode==""? userName : salesName%></h2></center></td>
                            </tr
                            <tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" rowspan="5" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                    <tr>
                                                                        ...
                                                                        <td width="63%">
                                                                            <%      Vector val_notatype = new Vector(1, 1);
                                                                                        ...
                                                                                        key_notatype.add("Sales Incoming Order");
                                                                   ...
                                                                   <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td></td>
                                                                        <td><%=ControlDate.drawTimeSec(FrmBillMain.fieldNames[FrmBillMain.FRM_FIELD_BILL_DATE], (billMain.getBillDate() == null) ? new Date() : billMain.getBillDate(),"formElemen")%></td>
                                                                    </tr>
                                                                    <tr>
                                                        ...
                                                        <td widht="15%">
                                                            ...
                                                            if(!privApprovalSalesOrder && salesCode == ""){
                                                                        if (transStatusTmp != 1 && idNotaType != PstBillMain.RETUR_ALL && idNotaType != PstBillMain.RETUR) {
                                                                            ...
                                                                            if (idNotaType == PstBillMain.RETUR_ALL) {%>
                                                            <input type="button" name="ButtonSalesOrder" value="Save Retur" onClick="javascript:confrmSaveRetur(0)" class="styleButton">
                                                            <%} else if (idNotaType == PstBillMain.RETUR) {%>
                                                            <input type="button" name="ButtonSalesOrder" align="right" value="Save Retur" onClick="javascript:confrmSaveRetur(1)" class="styleButton">
                                                            <%} else {%>
                                                            <input type="button" name="ButtonSalesOrder" align="right" value="Save Sales Order" onClick="javascript:cmdSaveAll()" class="styleButton">
                                                            <%}
                                                                        }
                                                                }%>
                                                        </td>
    ...
    <script type="text/javascript">
                //var billdetailid = document.frmcashier.billdetailTmp.value;

                alert("Item is already exist !");
                document.frmcashier.commandTmp.value =0;
                /*var con = confirm("Item is already exist! \n Do you want to edit this item ?");
                    if (con ==true)
                    {
                        billDetailEdit(billdetailid);
                    }*/
