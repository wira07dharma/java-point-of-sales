    ...
    public String drawListBillDetail(int language, int iCommandDetail, FrmBillDetail frmObject,
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (index == i && (iCommandDetail == Command.EDIT || iCommandDetail == Command.ASK)) {
                ...
                rowx.add("<div align=\"right\"><input tabindex=\"33\" type=\"text\" size=\"3\" onKeyUp=\"javascript:calculate()\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_QTY] + "\" value=\"" + (qty) + "\" onKeyPress=\"javascript:keybrdPress(this, event)\"  class=\"formElemenR\" style=\"text-align:right\"></div>");
                ...
                if (requiredSerialNumber == PstMaterial.REQUIRED) {
                    rowx.add("<div align=\"right\">" + qty + "</div>");
                } else {
                    rowx.add("<div align=\"right\">" + qty + "</div>");
                }
...
<%
           ...
           // long idCustomer = FRMQueryString.requestLong(request, "customerId");
            ...
            <tr>
                <td height="20" ID="MAINMENU"> <!-- #BeginEditable "menumain" -->
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#E1CA9F">
                        ...
                        <tr>
                            <td nowrap class="menus" height="12">
                                    ...
                                    <table width="98%" border="0" cellspacing="0" cellpadding="0" align="left">
                                        <tr>
                                            <td align="right">
                                                ...
                                                <div align="right"><input type="button" name="Closing Shift" value="Closing Shift" onClick="javascript:closeshift()" class="styleButton"> <input type="button" name="Logout" value="Logout" onClick="javascript:logout()" class="styleButton"></div>
                                            </td>
                                                            ...
                                                            <td colspan="2" rowspan="5" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><label><%
                                                                                ...
                                                                                <input name="<%=frmBillMain.fieldNames[FrmBillMain.FRM_FIELD_RATE]%>" type="text" size="12" value="<%=(billMain.getOID()==0) ? sellingRate : billMain.getRate()%>">
                                                                            </label>
                                                                        </td>
                                                                    </tr>
                                                                </table></td>
