...
<%!    /* this constant used to list text of listHeader */
    public static final String textMaterialHeaderMain[][] = {
        {"", "CASH INVOICE", "RETUR", "GIFT", "SALES ORDER", "CREDIT INVOICE","RETURN INVOICE"},
        {"", "CASH INVOICE", "RETUR", "GIFT", "SALES ORDER", "CREDIT INVOICE","RETURN INVOICE"}
    };
    public static final String textMaterialHeader[][] = {
        {"Nota Type", "Number", "Customer Type", "Payment", "Bookeeping Currency", "Sales Currency", "Date", "Delivery Address", "Tel/Hp", "Zip", "Customer",//10
            "Person", "Credit Limit", "Outstanding", "Available", "Sales", "City", "Province", "Country", "Total", "Bayar", "Kembali", "Fax", "Diskon",//23
            "Tax", "Company", "Address","Notes","Tanggal Jatuh Tempo"}, //11
        {"Nota Type", "Number", "Customer Type", "Payment", "Bookeeping Curreny", "Sales Currency", "Date", "Delivery Address", "Tel/Hp", "Zip", "Customer", 
            ...
            "Tax", "Company", "Address","Notes","Due Date Payment"}
    };
    public static final String textListOrderItem[][] = { 
        {"No", "Sku/Barcode", "Item Name", "Quantity", "Price", "Disc", "1.Disc%", "2.Disc%",//7
            "Disc. Val", "Total Disc.", "Net Price", "Note", "Ser.Number", "Status", "Due Date", "Amount", "Disc. Global", "Unit"},//17
...
<%
            ...
            Date termOfDate = billMain.getDateTermOfPayment();
            if(termOfDate==null){
                termOfDate = new Date();
            }
                                                        ...
                                                        <td colspan="4">
                                                            <table width="100%" border="0" cellpadding="1">
                                                                <tr>
                                                                    ...
                                                                    <td class="title" align="center" width="70%"><b>&nbsp;<%=textMaterialHeaderMain[SESS_LANGUAGE][idNotaType].toUpperCase()%></b></td>
                                                                    <td width="15%"></td>
                                                                </tr>
                                                            </table>                                                        </td>
                                                    </tr>
                                                                    ...
                                                                    <td colspan="2" rowspan="5" valign="top">
                                                                        <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                //Vector listSales = PstSales.list(0, 0, PstSales.fieldNames[PstSales.FLD_CODE] + " ='" + billMain.getSalesCode()+"'", "");//PstAppUser.listFullObj(0, 0, PstAppUser.fieldNames[PstAppUser.FLD_USER_ID] + " ='" + billMain.getSalesCode() + "'", "");
                                                                                if (sale.size() > 0) {
                                                                                    AppUser appUser = (AppUser) sale.get(0);
                                                                    ...
                                                                    <td colspan="2" rowspan="5" valign="top">
                                                                        <table width="100%" border="0" cellspacing="2" cellpadding="2" >
                                                                            ...
                                                                            <tr>
                                                                             ...
                                                                             <tr>
                                                                                <td width="30%"><%=textMaterialHeader[SESS_LANGUAGE][28]%></td>
                                                                                <td width="5%">:</td>
                                                                                <td width="65%"><%=Formater.formatDate(termOfDate, "dd MMM yyyy")%></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    <td></td>
                                                                    ...
                                                                    <td height="22" valign="middle" colspan="3">
                                                                        <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="5%" align="right" class="listgensell">&nbsp;<%=(billdetail.getDisc1())%></td>
                                                                                <td width="5%" align="right" class="listgensell">&nbsp;<%=(billdetail.getDisc2())%></td>
                                                                                ...
                                                                                <td width="10%" align="right" class="listgensell">&nbsp;<%=FRMHandler.userFormatStringDecimal(billdetail.getTotalPrice())%></td>
                                                                            ...
                                                                            <tr>
                                                                                    ...
                                                                                    <table width="20%" align="right">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td height="5%" align="right">
                                                                                                <%if (billMain.getDiscType() == PstBillDetail.DISC_TYPE_PERCENT) {%>
                                                                                ...
                                                                                <td width="10%" align="right" class="listgensell">
                                                                                    <table width="30%" align="right">
                                                                                        ...
                                                                                        double grandtotalTmp = (amounttotalTmp - discValTmp) + taxValTmp;

                                                                                        %>
                                                                                        <tr>
                                                                                            <td height="5%" align="right">
                                                                                                <b><%=(amounttotalTmp == 0) ? "0.00" : FRMHandler.userFormatStringDecimal(amounttotalTmp)%></b>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%if(!privApprovalSalesOrder){%>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td height="5%" align="right">
                                                                                                <b><%=(billMain.getTaxValue() == 0) ? "0.00" : FRMHandler.userFormatStringDecimal(billMain.getTaxValue())%></b>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td height="5%" align="right">
                                                                                                <b><%=FRMHandler.userFormatStringDecimal(grandtotalTmp)%></b>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%}%>
                                                                                    </table>
