<%-- 
    Document   : pomaterial_cashier_list
    Created on : Apr 25, 2014, 3:53:17 PM
    Author     : dimata005
--%>
...
if(iCommand==Command.BACK || iCommand==Command.FIRST || iCommand==Command.PREV || iCommand==Command.NEXT || iCommand==Command.LAST)
{
	 ...
	 { 
		...
		if (srcPurchaseOrder == null) srcPurchaseOrder = new SrcPurchaseOrder();
	 }
	 catch(Exception e)
	 { 
	 ...
	 session.putValue(SessPurchaseOrder.SESS_SRC_ORDERMATERIAL, srcPurchaseOrder);
}
...
vectSize = sessPurchaseOrder.getCountPurchaseOrderMaterial(srcPurchaseOrder,docType,"");
if(iCommand==Command.FIRST || iCommand==Command.NEXT || iCommand==Command.PREV || iCommand==Command.LAST || iCommand==Command.LIST){
	start = ctrlPurchaseOrder.actionList(iCommand,start,vectSize,recordToGet);
}	
Vector records = sessPurchaseOrder.searchPurchaseOrderOutletMaterial(srcPurchaseOrder,docType,start,recordToGet,"");
