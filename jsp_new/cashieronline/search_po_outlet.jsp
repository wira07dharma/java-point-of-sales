<%-- 
    Document   : cashier_warehause
    Created on : Apr 25, 2014, 3:40:17 PM
    Author     : dimata005
--%>
...
FrmSrcPurchaseOrder frmSrcPurchaseOrder = new FrmSrcPurchaseOrder();
try
{
	srcPurchaseOrder = (SrcPurchaseOrder)session.getValue(SessPurchaseOrder.SESS_SRC_ORDERMATERIAL);
}
catch(Exception e)
{
	srcPurchaseOrder = new SrcPurchaseOrder();
}
...
try
{
	session.removeValue(SessPurchaseOrder.SESS_SRC_ORDERMATERIAL);
}catch(Exception e){
}
%>
...
function cmdSearch(){
	...
	document.frmsrcordermaterial.action="pomaterial_cashier_list.jsp";
	document.frmsrcordermaterial.submit();
}
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr> 
                        ...
                        <td height="21" width="90%">&nbsp; 
                          <input type="text" name="<%=frmSrcPurchaseOrder.fieldNames[FrmSrcPurchaseOrder.FRM_FIELD_PRMNUMBER] %>"  value="<%= srcPurchaseOrder.getPrmnumber() %>" class="formElemen" size="20">
                        </td>
                      </tr>
                      <tr> 
