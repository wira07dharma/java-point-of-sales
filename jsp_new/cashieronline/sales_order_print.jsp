...
<%!    /* this constant used to list text of listHeader */
    public static final String textMaterialHeaderMain[][] = {
        {"INVOICE", "INVOICE", "RETUR", "GIFT", "SALES ORDER", "CREDIT INVOICE","RETURN INVOICE"},
        {"INVOICE", "INVOICE", "RETUR", "GIFT", "SALES ORDER", "CREDIT INVOICE","RETURN INVOICE"}
    };
                                                        ...
                                                        <td colspan="4">
                                                            <table width="100%" border="0" cellpadding="1">
                                                                <tr>
                                                                    ...
                                                                    <%if(billMain.getTransctionType()==0){%>
                                                                        <td class="title" align="center" width="70%"><b>&nbsp;<%=textMaterialHeaderMain[SESS_LANGUAGE][1].toUpperCase()%></b></td>
                                                                    <%}else{%>
                                                                        <td class="title" align="center" width="70%"><b>&nbsp;<%=textMaterialHeaderMain[SESS_LANGUAGE][1].toUpperCase()%></b></td>
                                                                    <%}%>
                                                                    <td width="15%"></td>
