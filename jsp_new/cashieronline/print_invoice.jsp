...
*/
public String drawListPoItem(int language,int iCommand, long oidOpenBill,Vector objectMaterialIssue, long hidden_cash_bill_detail_id) {
                    ...
                    <form name="frmcashier" method ="post" action=""  role="form">
                        ...
                        <div class="box-bodyx">
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <%= drawListPoItem(SESS_LANGUAGE,iCommand,oidOpenbillmain,lisBillDetailIssue,hidden_cash_bill_detail_id)%>
                                </div>
                                <div class="col-xs-12">
                                    <table width="100%">
