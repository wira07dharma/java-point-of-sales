...
<%
    ...
    if ((vctCashCashier!=null)&&(vctCashCashier.size()>0)){
             //CashCashier oldCashCashier=(CashCashier)vctCashCashier.get(0);
             if(typeListCashier==0){//sales order
                ...
                response.sendRedirect("src_list_open_bill.jsp");
                                                            ...
                                                            <table id="location">
                                                                ...
                                                                <tr>
                                                                    <td width="20%">
                                                                        ...
                                                                        Vector listLoc = PstLocation.listLocationCreateDocument(0, 0, whereClausex, "");
