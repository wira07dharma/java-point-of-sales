...
public static final String textListPaymentInfo[][] = {
	...
	"Kadarluwarsa","Tempat Pembayaran","Nomor BG/Check","Jatuh Tempo","Tanggal Pencairan"}, //8-11
	{"Bank Name","Bank Address","Swift Code","Account Name","Account Number","Name on Card","Card Number","Card Id", //0-7
	"Expired Date","Pay Address","BG/Check Number","Due Date","Tanggal Pencairan"} //8-11
};
%>
...
function changePaymentSystem() {
    ...
    %>
            if(paymentId == '<%=vDueDateInfo.get(i)%>'){
                ...
                document.all.TanggalPencairan.style.display = '';
            }
    <%
    }
    %>
    ...
    if(!dueDateSts){
        ...
        document.all.TanggalPencairan.style.display = 'none';
    }
                                            ...
                                            <td colspan="5"  class="listgensell">
                                              <table>
                                                    ...
                                                    <tr id="dueDate" style="YES; display: none;">
                                                     ...
                                                     <tr id="TanggalPencairan" style="YES; display: none;">
                                                      <td><%=textListPaymentInfo[SESS_LANGUAGE][12]%></td>
                                                      <td>:</td>
                                                      <td><%=ControlDate.drawDate(FrmPaymentInfo.fieldNames[FrmPaymentInfo.FRM_FIELD_TANGGAL_PENCAIRAN], cashCreditPaymentInfo.getChequeDueDate() == null ? new Date(): cashCreditPaymentInfo.getChequeDueDate(),"formElemen", 0, 0)%></td>
                                                    </tr>
                                              </table>
                                            </td>
                                     </tr>
