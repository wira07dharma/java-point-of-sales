    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdAsk(oidBillMain)
            {
                ...
                document.frmsrcretur.action="src_list_retun_bill.jsp";
            ...
            function cmdEdit(oidBillMain){
                ...
                document.frmsrcretur.command.value="<%=Command.ADD%>";
                document.frmsrcretur.hidden_bill_main_id.value=oidBillMain;
                //document.frmsrcretur.oidbillmaintmp.value=oidBillMain;
                document.frmsrcretur.nota_type.value="<%=PstBillMain.RETUR%>";
                document.frmsrcretur.typeCashier.value="1";
                document.frmsrcretur.action="cashier_lyt.jsp";
                document.frmsrcretur.submit();
