<%-- 
    Document   : src_list_issue_bill_m
    Created on : Feb 9, 2015, 4:19:29 PM
    Author     : dimata005
--%>
...
//                    salesName = PstSales.getNameSales(billMain.getSalesCode());
                ...
                rowx.add("<div align=\"center\"><a href=\"javascript:cmdProses('"+String.valueOf(billMain.getOID())+"','"+salesName+"','"+billMain.getStatusInv()+"','2')\">Proses</a></div>");
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdAsk(oidBillMain)
            {
                ...
                document.frmopenbill.action="src_list_issue_bill_m.jsp";
            ...
            function cmdProses(oidBillMain,SalesName,StatusInvoice,typeBill){
                if(StatusInvoice==2){
                    ...
                    document.frmopenbill.oidBillMain.value=oidBillMain;
                    ...
                    document.frmopenbill.typeListBill.value="1";
            ...
            function modifKey(frmObj, event,value){
                if(event.keyCode == 13) { //enter
                  cmdSearch();
                        ...
                        strvalue  = "src_list_issue_bill_m.jsp";
                        window.open(strvalue,"openbill", "height=1000,width=1200,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes");
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Search List Issue Store Request
                        <small></small>
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">
                    <form name="frmopenbill" method ="post" action=""  role="form">
                        ...
                        <input type="hidden" name="oidBillMain" value="">
