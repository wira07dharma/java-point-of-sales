...
function setMainFrameUrl(url){  
 <% if(0 > 0){ %>
	   // if(confirm("Apakah anda ingin pindah menu?")){
    ...
    <div id="tabs25">
        <ul class="flatflipbuttons">
            <%if(privApprovalHeaderHome){%>
                    <li><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=home')"><img src="<%=approot%>/menustylesheet/icon_pos/home_pos.png" /></a><%=homeActive.length()==0?"Home":"<b>Home</b>"%></li>
            <%}else{%>
            ...
            <%if(privApprovalHeaderPenjualan){%>
                <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=penjualan')"><span><img src="<%=approot%>/menustylesheet/icon_pos/sales_pos.png" /></span></a><%=employeeActive.length()==0?"Penjualan":"<b>Penjualan</b>"%></li>
            <%}else{%>
            ...
            <%if(privApprovalHeaderPembelian){%>
                <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=pembelian')"><span><img src="<%=approot%>/menustylesheet/icon_pos/purchase_pos.png" /></span></a><%=trainingActive.length()==0?"Pembelian":"<b>Pembelian</b>"%></li>
            <%}else{%>
                <li style="border-left: 1px solid <%=garis2%>;"><a href="#"><span><img src="javascript:setMainFrameUrl('<%=approot%>/menustylesheet/icon_pos/purchase_pos_enable.png')" /></span></a><%=trainingActive.length()==0?"Pembelian":"<b>Pembelian</b>"%></li>
            <%}%>
            <%if(privApprovalHeaderPenerimaan){%>
                 <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=penerimaan')"><span><img src="<%=approot%>/menustylesheet/icon_pos/receive_pos.png" /></span></a><%=reportsActive.length()==0?"Gudang":"<b>Gudang</b>"%></li>
            <%}else{%>
                 <li style="border-left: 1px solid <%=garis2%>;"><a href="#"><span><img src="javascript:setMainFrameUrl('<%=approot%>/menustylesheet/icon_pos/receive_pos_enable.png')" /></span></a><%=reportsActive.length()==0?"Gudang":"<b>Gudang</b>"%></li>
            <%}%>
            <%if(privApprovalHeaderPembiayaan){%>
                <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=pembiayaan')"><span><img src="<%=approot%>/menustylesheet/icon_pos/costing_pos.png" /></span></a><%=lockerActive.length()==0?"Pembiayaan":"<b>Pembiayaan</b>"%></li>
            <%}else{%>
                <li style="border-left: 1px solid <%=garis2%>;"><a href="#"><span><img src="javascript:setMainFrameUrl('<%=approot%>/menustylesheet/icon_pos/costing_pos_enable.png" /></span></a><%=lockerActive.length()==0?"Pembiayaan":"<b>Pembiayaan</b>"%></li>
            <%}%>
            <%if(privApprovalHeaderStok){%>
                <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=stock')"><span><img src="<%=approot%>/menustylesheet/icon_pos/stok_pos.png" /></span></a><%=masterDataActive.length()==0?"Stok":"<b>Stok</b>"%></li>
            <%}else{%>
                <li style="border-left: 1px solid <%=garis2%>;"><a href="#"><span><img src="javascript:setMainFrameUrl('<%=approot%>/menustylesheet/icon_pos/stok_pos_enable.png')" /></span></a><%=masterDataActive.length()==0?"Stok":"<b>Stok</b>"%></li>
            <%}%>
            <%if(privApprovalHeaderMasterdata){%>
                 <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=masterdata')"><span><img src="<%=approot%>/menustylesheet/icon_pos/masterdata.png" /></span></a><%=systemActive.length()==0?"Masterdata":"<b>Masterdata</b>"%></li>
            <%}else{%>
                 <li style="border-left: 1px solid <%=garis2%>;"><a href="#"><span><img src="javascript:setMainFrameUrl('<%=approot%>/menustylesheet/icon_pos/masterdata_enable.png')" /></span></a><%=systemActive.length()==0?"Masterdata":"<b>Masterdata</b>"%></li>
            <%}%>
            <%if(privApprovalHeaderSistem){%>
                 <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon_rtc.jsp?menu=sistem')"><span><img src="<%=approot%>/menustylesheet/icon_pos/sistem_pos.png" /></span></a><%=payrollSetupActive.length()==0?"Sistem":"<b>Sistem</b>"%></li>
            <%}else{%>
                 <li style="border-left: 1px solid <%=garis2%>;"><a href="#"><span><img src="javascript:setMainFrameUrl('<%=approot%>/menustylesheet/icon_pos/sistem_pos_enable.png')" /></span></a><%=payrollSetupActive.length()==0?"Sistem":"<b>Sistem</b>"%></li>
            <%}%>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:logOut('<%=approot%>/logout.jsp')"><span><img src="<%=approot%>/menustylesheet/icon_pos/keluar_pos.png" /></span></a><%=overtimeActive.length()==0?"Keluar":"<b>Keluar</b>"%></li>
        </ul>
    </div>
<%}else{%>
    <div id="tabs25">
        <ul class="flatflipbuttons">
            <li><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=home')"><img src="<%=approot%>/menustylesheet/icon_pos/home_pos.png" /></a><%=homeActive.length()==0?"Home":"<b>Home</b>"%></li>
            <%if(privViewCashierMenu){%>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=kasir')"><span><img src="<%=approot%>/menustylesheet/icon_pos/cashier.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Kasir":"Cashier"%></li>
            <%}%>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=penjualan')"><span><img src="<%=approot%>/menustylesheet/icon_pos/sales_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?" Penjualan":"Sales"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=pembelian')"><span><img src="<%=approot%>/menustylesheet/icon_pos/purchase_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Pembelian":"Purchase"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=penerimaan')"><span><img src="<%=approot%>/menustylesheet/icon_pos/receive_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Penerimaan":"Receive"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=return')"><span><img src="<%=approot%>/menustylesheet/icon_pos/return_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Return":"Return"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=transfer')"><span><img src="<%=approot%>/menustylesheet/icon_pos/transfer_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Transfer":"Dispatch"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=pembiayaan')"><span><img src="<%=approot%>/menustylesheet/icon_pos/costing_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Pembiayaan":"Costing"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=stock')"><span><img src="<%=approot%>/menustylesheet/icon_pos/stok_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Stok":"Stock"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=masterdata')"><span><img src="<%=approot%>/menustylesheet/icon_pos/masterdata.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Data Master":"Masterdata"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:setMainFrameUrl('<%=approot%>/homepage_menuicon.jsp?menu=sistem')"><span><img src="<%=approot%>/menustylesheet/icon_pos/sistem_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Sistem":"System"%></li>
            <li style="border-left: 1px solid <%=garis2%>;"><a href="javascript:logOut('<%=approot%>/logout.jsp')"><span><img src="<%=approot%>/menustylesheet/icon_pos/keluar_pos.png" /></span></a><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ?"Keluar":"Exit"%></li>
        </ul>
    </div>
<%}%>
