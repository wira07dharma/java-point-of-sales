<%-- 
    Document   : home
    Created on : Jun 26, 2014, 9:44:04 AM
    Author     : dimata005
--%>
...
<%@page import="java.util.Vector"%>
 <%
                        ...
                        if(MODUS_TRANSFER == MODUS_TRANSFER_SERVER){
                            ...
                            <tr>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>1.&nbsp;Document Order Pembelian  <a href="<%=approot%>/purchasing/material/pom/pomaterial_edit.jsp">( Click Here )</a></b></td>
                            </tr>
                            <%if((orderPembelianInformation != null) && (orderPembelianInformation.size() > 0)) {%>
                                ...
                                <tr>
                                    <%--document penerimaan dari pembelian--%>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Document Order Pembelian dengan Status 
                                        <%if(i==0 && temp.get(1).equals(0)){%>
                                        draft
                                        <%} else if (i==2 && temp.get(1).equals(2)){%> 
                                        final 
                                        <%}else if (i==3 && temp.get(1).equals(10)){%>
                                        Approved
                                         <%}else if (i==1 && temp.get(1).equals(1)){%>
                                        To be Approved
                                        <%}%>
                                        = <%=temp.get(0)%>&nbsp;Document 
                                    
                                    <%if(i==0  && temp.get(1).equals(0) ){%> 
                                        <a href="<%=approot%>/purchasing/material/pom/pomaterial_list.jsp?command=1&FRM_FIELD_PRMSTATUS=0"> Click Here</a>  
                                        <%}else if (i==2 && temp.get(1).equals(2)){%> 
                                        <a href="<%=approot%>/purchasing/material/pom/pomaterial_list.jsp?command=1&FRM_FIELD_PRMSTATUS=2"> Click Here</a>  
                                        <%}else if (i==3 && temp.get(1).equals(10)){%> 
                                        <a href="<%=approot%>/purchasing/material/pom/pomaterial_list.jsp?command=1&FRM_FIELD_PRMSTATUS=10"> Click Here</a>  
                                        <%} else if (i==1 && temp.get(1).equals(1)) {%>
                                        <a href="<%=approot%>/purchasing/material/pom/pomaterial_list.jsp?command=1&FRM_FIELD_PRMSTATUS=1"> Click Here</a>  
                                        <%}%>
                                    </td>
                                </tr>
                                <%
                            ...
                            <tr>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>2.&nbsp;Document Penerimaan dari Pembelian  <a href="<%=approot%>/warehouse/material/receive/receive_wh_supp_po_material_edit.jsp">( With PO )</a>
                                  <a href="<%=approot%>/warehouse/material/receive/receive_wh_supp_material_edit.jsp">( Without PO )</a></b></td>
                            </tr>
                            <%if((ReceiveMaterialInformation != null) && (ReceiveMaterialInformation.size() > 0)) {%>
                                ...
                                <tr>
                                    <%--document penerimaan dari pembelian--%>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Document Penerimaan dari Pembelian dengan Status
                                      
                                         <%if(i==0 && temp.get(1).equals(0)){%>
                                        draft
                                         <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        Approved
                                         <%}else if (i==1 && temp.get(1).equals(1)){%>
                                        To be Approved
                                        <%}%>
                                        ...
                                        <%if(i==0  && temp.get(1).equals(0) ){%>
                                        <a href="<%=approot%>/warehouse/material/receive/receive_material_list.jsp?command=1&FRM_FIELD_RECEIVESTATUS=0"> Click Here</a>  
                                        <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        <a href="<%=approot%>/warehouse/material/receive/receive_material_list.jsp?command=1&FRM_FIELD_RECEIVESTATUS=10"> Click Here</a>  
                                        <%}else if (i==1 && temp.get(1).equals(1)){%>
                                        <a href="<%=approot%>/warehouse/material/receive/receive_material_list.jsp?command=1&FRM_FIELD_RECEIVESTATUS=1"> Click Here</a>  
                                         <%}%>
                            ...
                            <tr>
                             ...
                             <tr>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>3.&nbsp;Document Penerimaan dari Toko <a href="<%=approot%>/warehouse/material/receive/receive_store_wh_material_edit.jsp">( Click Here )</a></b></td>
                            </tr>
                            <%if((ReceiveMaterialNonSupplierInformation != null) && (ReceiveMaterialNonSupplierInformation.size() > 0)) {%>
                                <%
                                
                                int oidDraft = FRMQueryString.requestInt(request, "hidden_draft");
                                for (int i = 0; i < ReceiveMaterialNonSupplierInformation.size(); i++) {
                                     Vector temp = (Vector)ReceiveMaterialNonSupplierInformation.get(i);
                                     
                                 %>
                                <tr>    
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Document Penerimaan Dari Toko dengan Status 
                                       <%if(i==0 && temp.get(1).equals(0)){%>
                                        draft
                                         <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        Approved
                                    ...
                                    <%--document penerimaan dari pembelian--%>
                                        <%if(i==0 && temp.get(1).equals(0)){%>
                                        <a href="<%=approot%>/warehouse/material/receive/receive_store_wh_material_list.jsp?command=23&draft=0">  Click Here</a>  
                                        <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        <a href="<%=approot%>/warehouse/material/receive/receive_store_wh_material_list.jsp?command=23&draft=10">  Click Here </a>
                                        <%}else if (i==1 && temp.get(1).equals(1)) {%>
                                         <a href="<%=approot%>/warehouse/material/receive/receive_store_wh_material_list.jsp?command=23&draft=10">  Click Here </a>
                                        <%}%>
                            ...
                            <tr>
                              ...
                              <%--document Transfer --%>
                            <tr>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>4.&nbsp;Document Transfer <a href="<%=approot%>/warehouse/material/dispatch/df_stock_wh_material_edit.jsp">( Click Here )</b></td>
                            </tr>
                            <%if((matDispatchInformation != null) && (matDispatchInformation.size() > 0)) {%>
                                ...
                                <tr>
                                    <%--document penerimaan dari pembelian--%>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Document Transfer dengan Status 
                                       <%if(i==0 && temp.get(1).equals(0)){%>
                                        draft
                                         <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        Approved
                                        ...
                                        <%if(i==0  && temp.get(1).equals(0) ){%>
                                       <a href=" <%=approot%>/warehouse/material/dispatch/df_stock_wh_material_list.jsp?command=1&select_status=0&date_status=true"> Click Here</a>  
                                        <%}else if (i==2 && temp.get(1).equals(10)){%>
                                       <a href=" <%=approot%>/warehouse/material/dispatch/df_stock_wh_material_list.jsp?command=1&select_status=10&date_status=true"> Click Here</a>  
                                        <%}else if (i==1 && temp.get(1).equals(1)) {%>
                                      <a href=" <%=approot%>/warehouse/material/dispatch/df_stock_wh_material_list.jsp?command=1&select_status=1&date_status=true"> Click Here</a>  
                                       <%}%>
                                    </td>
                                </tr>
                                <%
                           ...
                           <tr>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>5.&nbsp;Document Transfer Unit <a href="<%=approot%>/warehouse/material/dispatch/df_unit_wh_material_edit.jsp">( Click Here )</b></td>
                            </tr>
                            <%if((matDispatchUnitInformation != null) && (matDispatchUnitInformation.size() > 0)) {%>
                                ...
                                <tr>
                                    <%--document penerimaan dari pembelian--%>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Document Transfer Unit dengan Status 
                                       <%if(i==0 && temp.get(1).equals(0)){%>
                                        draft
                                         <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        Approved
                                     ...
                                     <%if(i==0  && temp.get(1).equals(0) ){%>
                                        <a href=" <%=approot%>/warehouse/material/dispatch/df_unit_wh_material_list.jsp?command=1&select_status=0&date_status=true"> Click Here</a>  
                                        <%} else if (i==2 && temp.get(1).equals(10)) {%> 
                                        <a href=" <%=approot%>/warehouse/material/dispatch/df_unit_wh_material_list.jsp?command=1&select_status=10&date_status=true"> Click Here</a>  
                                        <%} else if (i==1 && temp.get(1).equals(1)){%>
                                        <a href=" <%=approot%>/warehouse/material/dispatch/df_unit_wh_material_list.jsp?command=1&select_status=1&date_status=true"> Click Here</a>  
                                         <%}%>
                            ...
                            <tr>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>6.&nbsp;Document Return <a href="<%=approot%>/warehouse/material/return/return_wh_material_edit.jsp">(With Note Receipt )</a>
                                 <a href="<%=approot%>/warehouse/material/return/return_wh_supp_material_edit.jsp">(Without Note Receipt )</a>   </b></td>
                            </tr>
                            <%if((returnInformation != null) && (returnInformation.size() > 0)) {%>
                                ...
                                <tr>
                                    <%--document penerimaan dari pembelian--%>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Document Return dengan Status 
                                         <%if(i==0 && temp.get(1).equals(0)){%>
                                        draft
                                         <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        Approved
                                     ...
                                     <%if(i==0  && temp.get(1).equals(0) ){%>
                                        <a href=" <%=approot%>/warehouse/material/return/return_material_list.jsp?FRM_FIELD_RETURNSTATUS=0"> Click Here</a>  
                                        <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        <a href=" <%=approot%>/warehouse/material/return/return_material_list.jsp?FRM_FIELD_RETURNSTATUS=10"> Click Here</a>  
                                        <%}  else if (i==1 && temp.get(1).equals(1))    {%>
                                        <a href=" <%=approot%>/warehouse/material/return/return_material_list.jsp?FRM_FIELD_RETURNSTATUS=1"> Click Here</a>  
                                     <%}%>
                                    </td>
                                </tr>
                                <%
                            ...
                            <tr>
                              <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>7.&nbsp;Document Pembiayaan (Costing) <a href="<%=approot%>/warehouse/material/dispatch/costing_material_edit.jsp">( Click Here )</b></td>
                            </tr>
                            <%if((pembiayaanInformation != null) && (pembiayaanInformation.size() > 0)) {%>
                                ...
                                <tr>
                                    <%--document penerimaan dari pembelian--%>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Document Pembiayaan (Costing) dengan Status
                                       <%if(i==0 && temp.get(1).equals(0)){%>
                                        draft
                                         <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        Approved
                                     ...
                                     <%if(i==0  && temp.get(1).equals(0) ){%>
                                        <a href=" <%=approot%>/warehouse/material/dispatch/costing_material_list.jsp?command=1&select_status=0&date_status=true"> Click Here</a>  
                                        <%}else if (i==2 && temp.get(1).equals(10)){%>
                                        <a href=" <%=approot%>/warehouse/material/dispatch/costing_material_list.jsp?command=1&select_status=10&date_status=true"> Click Here</a>  
                                        <%} else if (i==1 && temp.get(1).equals(1)) {%>
                                        <a href=" <%=approot%>/warehouse/material/dispatch/costing_material_list.jsp?command=1&select_status=1&date_status=true"> Click Here</a>  
                                      <%}%>
                                    </td>
                                </tr>
                                <%
