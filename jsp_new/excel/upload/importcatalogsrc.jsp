  ...
  <tr> 
    <td valign="top" align="left"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">  
        <tr> 
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->Upload Excel &gt; Upload Catalog <!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td><!-- #BeginEditable "content" -->
 				<form name="frmimportcatalog" method="post" action="importcatalogprocess.jsp" enctype="multipart/form-data">
				    <table width="100%" border="0">
                      <tr>
                        <td><i>Pilih file daftar catalog (.xls) untuk di-export
                      ...
                      <tr>
                        <td>
						  ...
						  <select name="col_sheet">
						    ...
						    <option value="1">Sell Price % Discount</option>
						    <option value="2">Supplier Buying Price</option>
						  </select>
