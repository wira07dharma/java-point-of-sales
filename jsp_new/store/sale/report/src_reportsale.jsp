...
{
       {"Laporan Penjualan > Penjualan Per Invoice","Lokasi","Tipe","Kasir","Mata Uang","Semua Shift","Semua Kasir","Semua Lokasi"},
       {"Report Sales > Sales Per Invoice","Location","Type","Cashier","Currency","All Shift","All Cashier","All Location"}
};
...
function cmdSearch(){
	...
	document.frmsrcreportsale.action="reportlistsale.jsp";
                  ...
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
                      ...
                      <tr>
						...
						val_saletype.add(""+SrcSaleReport.TYPE_CASH_CREDIT+"");
                                                key_saletype.add(SrcSaleReport.reportType[SESS_LANGUAGE][SrcSaleReport.TYPE_CASH_CREDIT]);
