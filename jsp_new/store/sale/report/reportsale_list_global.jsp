...
function printForm() {
    ...
    window.open("reportsale_list_global_html.jsp?global_group=<%=global_group%>","sale","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no"); 
}
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top"> 
                  <td height="18" valign="top" colspan="3"> <table width="100%" border="0">
                     <!-- Note if Group by supplier -->
                    <tr width="75%">
                      <td>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                               <%if(global_group == SrcSaleReport.GROUP_BY_SUPPLIER){%>
                             <tr>
                              <td>
                                  <br><b>Laporan penjualan persupplier tidak disertakan grand total, karena satu barang bisa mempunyai beberapa supplier.
                                  <br>Barang yang tidak mempunyai supplier tidak muncul.</b></td>
                             </tr>
                            <% }%>
                          </table>
                        ...
                        <td width="25%"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <% if(vectSize>0) { %>
                              ...
                              <td width="5%" valign="top"><a href="javascript:printFormExcel()"><img src="<%=approot%>/images/BtnPrint.gif" width="31" height="27" border="0"></a></td>
                               <td width="45%" nowrap>&nbsp; <a href="javascript:printFormExcel()" class="command" >Export Excel
                              </a>
                              </td>
                              <% } %>
                            </tr>
