<%-- 
    Document   : src_reportsale_spesial_request
    Created on : Aug 7, 2015, 2:50:09 PM
    Author     : dimata005
--%>
...
public static final String textListHeader[][] = {
    {"Lokasi","Shift","Kasir","Supplier","Kategori","Merk",
     ...
     "Tipe Transaksi","Grup","Tampilkan Foto","Semua","Ya","Tidak"},
    {"Location","Shift","Cashier","Supplier","Category","Mark",
     "Period","Sort By","Sales Person","Sub Category",
     "Transaction Type","Group","View Photo","All","Yes","No"}
};
...
function cmdSearch(){
    ...
    document.frmsrcreportsale.action="reportsale_list_detail_spesial_request.jsp";
          ...
          <td><!-- #BeginEditable "content" -->
            <form name="frmsrcreportsale" method="post" action="">
			 ...
			 %> <%=ControlCombo.draw(frmSrcSaleReport.fieldNames[FrmSrcSaleReport.FRM_FLD_GROUP_BY], null, default_groupby, val_groupby, key_groupby, "onChange=\"javascript:cmdSwitchGroup()\"", "formElemen")%>
                      ...
                      <tr id="category_combo" style="YES; display: none;"> 
                      ...
                      <tr id="sales_combo" style="YES; display: none;">
                        ...
                        Vector val_sales= new Vector(1,1);
                         ...
                         Vector vt_sales= PstSales.list(0,0,"","");
                         for(int d=0;d<vt_sales.size();d++) {
                             Sales sales= (Sales)vt_sales.get(d);
                             val_sales.add(""+sales.getOID()+"");
                             key_sales.add(sales.getName());
                         }
                      ...
                      <tr id="shift_combo" style="YES; display: none;">
                      ...
                      <tr id="supplier_combo" style="YES; display: none;">
                      ...
                      <tr id="merk_combo" style="YES; display: none;">
                      ...
                      <tr> 
                        ...
                        <td height="21" width="86%" valign="top" align="left"> 
                          <table width="40%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td class="command" nowrap width="90%"><a class="btn-primary btn-lg" href="javascript:cmdSearch()"><i class="fa fa-search"> &nbsp;<%=textListTitleHeader[SESS_LANGUAGE][3]%></i></a></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
