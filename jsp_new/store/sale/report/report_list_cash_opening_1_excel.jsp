<%-- 
    Document   : report_list_cash_opening_1_excel
    Created on : May 3, 2016, 4:55:49 PM
    Author     : dimata005
--%>
            ...
            rowx.add("<table class=\"listgensell\"><tr><td rowspan =\"2\">" +generateSummaryCash(cashCashier.getOID()) + "</td><td><b>DETAIL PEMBAYARAN</b>" +drawListDetailPayment(language, listDetailPayment, start, currencyId, cashCashier.getOID(), iSaleReportType) +
               ...
               rowx.add("<table class=\"listgensell\"><tr><td><div align=\"center\">"+textListMaterialHeaderFilter[language][6]+"</div></td></tr></table>");
                ...
                if (paymentDinamis == PstPaymentSystem.USING_PAYMENT_DINAMIS) {
                    ...
                    rowx.add("<div align=\"left\"></div>");
                    if (list != null && list.size() > 0) {
                        rowx.add("<table border=\"1\" class=\"listgensell\"><tr><td rowspan =\"3\">" + generateSummaryCash(cashCashier.getOID()) + "</td><td><b><color=\"FFFFFF\">DETAIL PEMBAYARAN</b></color>" + drawListDetailPaymentDinamis(language, listDetailPayment, start, currencyId, cashCashier.getOID(), iSaleReportType)
                                + "</td><td>" + generateSummaryTransaction2(language, cashCashier.getOID())
                                + "</td></tr></table>");
                    } else {
                        rowx.add("<table border=\"1\" class=\"listgensell\"><tr><td><div align=\"center\">" + textListMaterialHeaderFilter[language][6] + "</div></td></tr></table>");
                    }
                } else {
...
//Summary Cash
    public String generateSummaryCash(long oidCashCashier) {
        ...
        result
                = //"<tr><table width=\"50%\" >"
                //"<tr>" +
                "<table width =\"50%\"><tr><td><table width=\"50%\" border=\"1\"  class=\"listgen\"> "
                + "<tr>"
                + "<td width=\"4%\" class=\"listgentitle\" colspan =\"4\" border=\"1\" ><div align=\"left\">SUMMARY CASH</div></td></tr>"
                + "<tr><td class=\"listgentitle\" border=\"1\" >NO</td>"
                + "<td class=\"listgentitle\"border=\"1\" >TRANSAKSI</td>"
                + "<td width=\"5%\" class=\"listgentitle\"border=\"1\" >CURRENCY</td>"
                + "<td class=\"listgentitle\" border=\"1\" >AMOUNT</td>"
                + "</tr>"
                + "<tr>"
                + "<td width=\"5%\" class=\"listgentitle\"border=\"1\" >1.</td>"
                + "<td width=\"10%\" class=\"listgentitle\" nowrap width=\"95\" border=\"1\" ><div align=\"left\">Saldo Awal</div></td>"
                + "<td width=\"24%\" class=\"listgensell\" border=\"1\" >" + defaultCurrency + "</td>"
                + "<td width=\"20%\" class=\"listgensell\" border=\"1\" ><div align=\"right\">" + FRMHandler.userFormatStringDecimal(saldoAwal) + "</div></td>"
                + "</tr>"
...
<%    CtrlBillMain ctrlBillMain = new CtrlBillMain(request);
    ...
    int iSaleReportType = -1;//FRMQueryString.requestInt(request, "sale_type");
...
//}
    ...
    response.setHeader("Content-Disposition","attachment; filename=report_list_cash_opening_1_excel.xls" ); 
%>
<!-- End of Jsp Block -->
...
<html><!-- #BeginTemplate "/Templates/main.dwt" --><!-- DW6 -->
    ...
    <body onload="window.print()" bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">    
...
%>
                        ...
                        <tr align="left" valign="top"> 
                           <td height="75" valign="middle" colspan="3">Telah di cek dan benar,</td>
                       </tr>
                        <tr> 
