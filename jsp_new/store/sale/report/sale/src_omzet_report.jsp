<%-- 
    Document   : src_omzet_report
    Created on : 25 Jul 20, 10:31:51
    Author     : gndiw
--%>
...
<html>
        ...
        <script language="javascript">
            $(document).ready(function () {
                ...
                $('#search-form-btn').click(function () {
                    ...
                    var url = "<%=approot%>/store/sale/report/sale/list_omzet_report.jsp?" + formData.serialize();
    ...
    <body>
        <section class="content-header">
            <h3>Laporan Omzet<small> Pencarian</small> </h3>
            <ol class="breadcrumb">
                <li>Laporan</li>
                <li>Penjualan</li>
            </ol>
