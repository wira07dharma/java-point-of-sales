<%-- 
    Document   : src_reportsale_detail_global_100
    Created on : Sep 27, 2016, 12:09:30 PM
    Author     : dimata005
--%>
...
public static int FLD_VIEW_STOCK=15;

public static final String textListHeader[][] = {
    {"Lokasi","Shift","Kasir","Supplier","Kategori","Merk","Periode","Urut Berdasar","Kode Sales",
             "Sub Kategori","Tipe Transaksi","Grup", " s/d ","View", "Urut Berdasarkan","Lihat Stok"},
    {"Location","Shift","Cashier","Supplier","Category","Mark","Period","Sort By","Sales Code",
             "Sub Category","Transaction Type","Group", " to ","View", "Order By","View Stock"}
};

public static final String textListTitleHeader[][] = {
    {"Laporan Penjualan","Laporan 100 Item Terlaris","Pencarian","Cari Laporan","Semua Lokasi"},
    {"Sale Report","Best 100 Item","Searching","Search Report","All Location"}
};
...
int urutan = FRMQueryString.requestInt(request, "urutan");
...
srcSaleReport.setBillDateStatus(urutan);
%>
...
function cmdSearch(){
    ...
    if(typeView==1){
        document.frmsrcreportsale.action="reportsale_list_detail_global_100.jsp?fromglobal=0";
    }else{
        ...
        <tr> 
          <td><!-- #BeginEditable "content" --> 
                  ...
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
                      <tr> 
                        ...
                        <td height="21">:</td>
                        <td height="21">&nbsp;
                            <input type="radio" name="<%=frmSrcSaleReport.fieldNames[frmSrcSaleReport.FRM_FIELD_BILLDATESTATUS] %>" <%if(srcSaleReport.getBillDateStatus()==1){%>checked<%}%> value="1" onKeyDown="javascript:fnTrapKD()">
                            &nbsp; Semua Tanggal
                        </td>
                      </tr>
                      <tr> 
                        ...
                        <td height="21"></td>
                        <td height="21">&nbsp; 
                        <input type="radio" name="<%=frmSrcSaleReport.fieldNames[frmSrcSaleReport.FRM_FIELD_BILLDATESTATUS]%>" <%if(srcSaleReport.getBillDateStatus()==0){%>checked<%}%> value="0" onKeyDown="javascript:fnTrapKD()">    &nbsp;
                        <%=ControlDate.drawDate(frmSrcSaleReport.fieldNames[frmSrcSaleReport.FRM_FLD_FROM_DATE],srcSaleReport.getDateFrom(),"formElemen",4,-8)%> 
			...
			%>
                      ...
                      <tr id="supplier_combo" style="display: none;">
                        ...
                        Vector val_supplier= new Vector(1,1);
                         ...
                         String whClause = ""+PstContactList.fieldNames[PstContactList.FLD_CONTACT_TYPE]+" = "+PstContactList.EXT_COMPANY+
                      ...
                      <%--tambahan dapur indo --%>
                      <tr>
                        <td height="21" valign="top" width="14%" align="left"><%=getJspTitle(FLD_VIEW_REPORT,SESS_LANGUAGE,"",true)%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="85%" valign="top" align="left">&nbsp;
                        <%
                        ...
                        int default_viewreport = SrcSaleReport.VIEW_BY_DETAIL;
			%>
			<%=ControlCombo.draw(frmSrcSaleReport.fieldNames[FrmSrcSaleReport.FRM_FLD_VIEW_REPORT], null, ""+default_viewreport, val_view, key_view, "", "formElemen")%></td>
                      </tr>
                      <tr>
                        <td height="21" valign="top" width="14%" align="left"><%=getJspTitle(FLD_ORDER_BY,SESS_LANGUAGE,"",true)%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="85%" valign="top" align="left">&nbsp;
                        <%
			...
			<%=ControlCombo.draw(frmSrcSaleReport.fieldNames[FrmSrcSaleReport.FRM_FLD_ORDER_BY], null, ""+srcSaleReport.getSortBy(), val_order, key_order, "", "formElemen")%></td>
                      ...
                      <tr>
                        <td height="21" valign="top" width="14%" align="left"><%=getJspTitle(FLD_VIEW_STOCK,SESS_LANGUAGE,"",true)%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="85%" valign="top" align="left">&nbsp;
			<%
                                 ...
                                 prTypeKey.add("View");
                        %>
                        <%=controlCheckBox.draw(frmSrcSaleReport.fieldNames[FrmSrcSaleReport.FRM_FLD_VIEW_STOCK], prTypeVal, prTypeKey, new Vector())%>
                        </td>
                      </tr>
            ...
            <script language=JavaScript>
                document.frmsrcreportsale.<%=frmSrcSaleReport.fieldNames[FrmSrcSaleReport.FRM_FLD_GROUP_BY]%>.value = "<%=SrcSaleReport.GROUP_BY_ITEM%>";
                cmdSwitchGroup();
            </script>
            <!-- #EndEditable --></td> 
        </tr> 
