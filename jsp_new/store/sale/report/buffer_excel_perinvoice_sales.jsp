...
<!-- #EndTemplate --></html>
<script language="JavaScript">
    document.location="<%=approot%>/servlet/com.dimata.printman.SalePerInvoiceExcel?sale_type=<%=iSaleReportType%>&command=<%=Command.LIST%>","corectionwh","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no";
</script>