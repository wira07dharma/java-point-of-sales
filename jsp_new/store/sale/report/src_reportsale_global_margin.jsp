<%-- 
    Document   : src_reportsale_global_margin
    Created on : Aug 9, 2016, 10:30:48 AM
    Author     : dimata005
--%>
...
{
	{"Laporan Penjualan","Laporan Margin Penjualan ","Pencarian","Cari Laporan","Semua","s/d","Urut Naik","Urut Turun"},
	{"Transaction Report","Transaction Margin Report","Searching","Report Search","All","to","Ascending","Descending"}	
};
...
function cmdSearch(){
    ...
    document.frmsrcreportsale.action="reportsale_list_global_margin.jsp";
