...
{
	{"Laporan Transaksi","Laporan Pelunasan Piutang","Pencarian","Cari Laporan"},
	{"Transaction Report","Receivable Payment","Searching","Report Search"}   	
};
...
function cmdSearch(){
	...
	document.frmsrcreportsale.action="reportlistsalepaymentcredit.jsp";
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
                      ...
                      <tr>
                        <td height="21"><%=textGlobal[SESS_LANGUAGE][13]%></td>
                        <td height="21">:</td>
