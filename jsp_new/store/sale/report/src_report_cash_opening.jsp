...
function cmdSearch(){
	...
	document.frmsrcreportsale.action="report_list_cash_opening_1.jsp";
        ...
        <tr> 
          <td><!-- #BeginEditable "content" --> 
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left"><%=textGlobal[SESS_LANGUAGE][2]%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                        <%
						...
						key_saletype.add("Penjualan Cash");
						
						val_saletype.add(""+PstBillMain.TRANS_TYPE_CREDIT);
						key_saletype.add("Penjualan Kredit");

                                                //val_saletype.add(""+PstBillMain.TRANS_TYPE_ALL);
						//key_saletype.add("Semua tipe penjualan");

						//String select_saletype = "" + iSaleReportType;
                                                  //String select_saletype = "0";
                                                String select_saletype = "-1";
						%>
			...
			<tr>
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left">View</td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                        <%
