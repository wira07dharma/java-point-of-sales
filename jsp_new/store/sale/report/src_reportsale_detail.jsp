...
public static final String textListGlobal[][] = {
	{"Laporan Penjualan", "Laporan Penjualan Invoice Detail","Semua Lokasi",
            "Tipe","Shift","Semua Lokasi","Semua Shift","Mata Uang","Tipe Item", "Penjualan","Penitipan"},
	{"Sale Report", "Detail Invoice Sale Report","All Location",
            "Type","Shift","All Location","All Shift","Currency","Item Type","Sale","Consignment"}
};
...
function cmdSearch(){
	...
	document.frmsrcreportsale.action="reportlistsale_detail.jsp";
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
                      <tr> 
                        <td height="21" valign="top" width="9%" align="left"><%=textListGlobal[SESS_LANGUAGE][2]%></td>
							...
							//Vector vt_loc = PstLocation.listLocationStore(0,0,"",PstLocation.fieldNames[PstLocation.FLD_NAME]);
                                                        ...
                                                        if(checkDataAllLocReportView){
                                                           val_locationid.add("0");
                                                            key_locationid.add(textListGlobal[SESS_LANGUAGE][5]);
                                                        }
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left"><%=textListGlobal[SESS_LANGUAGE][3]%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                        <%
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left"><%=textListGlobal[SESS_LANGUAGE][8]%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                          <%
                                                Vector val_itemype = new Vector(1,1);
						Vector key_itemype = new Vector(1,1);

						
						val_itemype.add("0");
						key_itemype.add(textListGlobal[SESS_LANGUAGE][9]);
						
						val_itemype.add("1");
						key_itemype.add(textListGlobal[SESS_LANGUAGE][10]);
						%>
                          <%=ControlCombo.draw("item_type", null, "", val_itemype, key_itemype, "", "formElemen")%></td>
                      </tr>
                      <tr>
                        ...
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                          <%
							...
							val_shiftid.add("0");
							key_shiftid.add(textListGlobal[SESS_LANGUAGE][6]);
					  ...
					  <tr>
                        <td height="21" valign="top" width="9%" align="left"><%=textListGlobal[SESS_LANGUAGE][7]%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
							<%
							...
							%>
							<%=ControlCombo.draw(frmSrcSaleReport.fieldNames[FrmSrcSaleReport.FRM_FLD_CURRENCY], null, ""+srcSaleReport.getCurrencyOid(), vectCurrVal, vectCurrKey, "")%>  
						</td>
                      </tr>
                      <tr>
