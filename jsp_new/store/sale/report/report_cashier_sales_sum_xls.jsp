...
<%
    ...
    String startDate = Formater.formatDate(FRMQueryString.requestString(request, ""+FrmSrcSaleReport.fieldNames[frmSrcSaleReport.FRM_FLD_FROM_DATE]+""),"yyyy-MM-dd","yyyy-MM-dd 00:00:00");
    String endDate = Formater.formatDate(FRMQueryString.requestString(request, ""+FrmSrcSaleReport.fieldNames[frmSrcSaleReport.FRM_FLD_FROM_DATE]+""),"yyyy-MM-dd","yyyy-MM-dd 23:59:59");
