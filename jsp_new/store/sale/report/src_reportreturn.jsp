...
{
           {"Laporan Penjualan > Retur Per Invoice","Lokasi","Semua Location","Tipe","Return Penjualan Cash","Return Penjualan Credit","Mata Uang"},
           {"Sales Report > Retur Per Invoice","Location","All Location","Type","Return Sales Cash","Return Credit Sales","Currency"}
};
...
function cmdSearch(){
	...
	document.frmsrcreportsale.action="reportlistreturn.jsp";
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
                      <tr> 
                        <td height="21" valign="top" width="9%" align="left"><%=textGlobal[SESS_LANGUAGE][1]%></td>
                          ...
                          <%
							...
							//Vector vt_loc = PstLocation.listLocationStore(0,0,"",PstLocation.fieldNames[PstLocation.FLD_NAME]);
                                                        ...
                                                        if(checkDataAllLocReportView){
                                                            ...
                                                            key_locationid.add(textGlobal[SESS_LANGUAGE][2]);
                                                        }
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left"><%=textGlobal[SESS_LANGUAGE][3]%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                        <%
                            ...
                            key_saletype.add(textGlobal[SESS_LANGUAGE][4]);

                            val_saletype.add(""+PstBillMain.TRANS_TYPE_CREDIT);
                            key_saletype.add(textGlobal[SESS_LANGUAGE][5]);
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left"><%=textGlobal[SESS_LANGUAGE][6]%></td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                            <%
