...
{
    {"Rekap Harian","Laporan Compliment","--Pilih--","Cari Laporan"},
    {"Daily Report","Compliment Report" ,"--Select--","Get Report"}
};
    ...
    $(document).ready(function(){
        ...
        function getReport(){
            $('#searchReport').click(function(){
                $('#command').val(<%= Command.LOAD%>);
                var url = ""+base+"/SaleReportHandler";
                var data = $('#frmsrcreportsale').serialize();
                data = data + "&lang="+language+"";
                //alert(data);
                ajaxSalesReportHandler(url,data,"POST","#reportPlace","getComplimentReport");
