...
function cmdSearch(){
	...
	document.frmsrcreportsale.action="reportlistrekap.jsp";
                    ...
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
					  ...
					  <tr>
                        ...
                        <td height="21" width="90%" valign="top" align="left">&nbsp; 
							...
							%>
							<%=ControlCombo.draw(frmSrcSaleReport.fieldNames[FrmSrcReportSale.FRM_FIELD_CURRENCY_ID], null, ""+srcSaleReport.getCurrencyId() , vectCurrVal, vectCurrKey, "formElemen")%></td>
                      </tr>
                      <tr>
