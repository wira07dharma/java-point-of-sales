<%-- 
    Document   : reportlistsale_detail_html
...
public static final String textListGlobal[][] = {
	{"Laporan Penjualan", "Laporan Penjualan Invoice Detail","Semua Location","Penjualan Cash","Penjualan Credit","Semua Penjualan"},
	{"Sale Report", "Invoice Detail Sale Report","All Location","Cash Sales"," Credit Sales","All Sales"}
};
          ...
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportsale" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top"> 
                  <td height="22" valign="middle" colspan="3"><%=drawList(SESS_LANGUAGE, records, start, srcSaleReport, srcSaleReport.getCurrencyOid(),paymentDinamis)%></td>
                </tr>
              </table>
            </form>
            <!-- #EndEditable --></td> 
