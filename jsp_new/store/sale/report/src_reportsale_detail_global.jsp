<%-- 
    Document   : src_reportsale_detail_global
...
public static final String textListTitleHeader[][] = {
    {"Laporan Penjualan","Laporan Penjualan Detail","Pencarian","Cari Laporan","Semua Lokasi"},
...
function cmdSearch(){
    ...
    if(typeView==1){
        document.frmsrcreportsale.action="reportsale_list_detail_global.jsp?fromglobal=0";
    }else{
        ...
        <tr> 
          <td><!-- #BeginEditable "content" --> 
			...
			%>
                      ...
                      <tr id="supplier_combo" style="display: none;">
                        ...
                        Vector val_supplier= new Vector(1,1);
                         ...
                         String wClause = ""+PstContactList.fieldNames[PstContactList.FLD_CONTACT_TYPE]+" = "+PstContactList.EXT_COMPANY+
			...
			<%=ControlCombo.draw(frmSrcSaleReport.fieldNames[FrmSrcSaleReport.FRM_FLD_ORDER_BY], null, ""+srcSaleReport.getSortBy(), val_order, key_order, "", "formElemen")%></td>
                      ...
                      <tr>
                        <td height="21" valign="" width="14%" align="left"><%=getJspTitle(FLD_VIEW_STOCK,SESS_LANGUAGE,"",true)%></td>
                        <td height="21" valign="" width="1%" align="left">:</td>
                        <td height="21" width="85%" valign="" align="left">&nbsp;
			<%
