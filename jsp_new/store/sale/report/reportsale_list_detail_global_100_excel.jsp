<%-- 
    Document   : reportsale_list_detail_global_100_excel
    Created on : Sep 27, 2016, 1:27:19 PM
    Author     : dimata005
--%>
...
public static final String textListTitleHeader[][] = {
    ...
    {"REPORT TOP 100 ITEM ", "DREPORT TOP 100 ITEM  ", "No transaction data available", "LOCATION", "SHIFT", 
...
response.setHeader("Content-Disposition","attachment; filename=" + "top100.xls" ); 
%>
<!-- End of Jsp Block -->
