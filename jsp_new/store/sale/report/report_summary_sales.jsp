...
{
    {"Rekap Harian","Laporan Rangkuman Harian","--Pilih--","Cari Laporan"},
    {"Daily Report","Sales Summary Report" ,"--Select--","Get Report"}
};
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function onDone(data,title){
           if (title=="getSummarySalesReport") {
               printReport();
           }
        }
        ...
        function getReport(){
            $('#searchReport').click(function(){
                ...
                //alert(data);
                ajaxSalesReportHandler(url,data,"POST","#reportPlace","getSummarySalesReport");
