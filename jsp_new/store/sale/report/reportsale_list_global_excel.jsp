...
public Vector drawList(int language,Vector objectClass,SrcSaleReport srcSaleReport) {
    ...
    if(objectClass!=null && objectClass.size()>0) {
        ...
        ctrlist.dataFormat(groupTitle.toUpperCase()+""+textListTitleHeader[language][10]+"","25%","0","0","center","bottom");
...
response.setHeader("Content-Disposition","attachment; filename=" + "reportsale_list_global_excel.xls" );
%>
<!-- End of Jsp Block -->
              ...
              <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr align="left" valign="top"> 
                  <td height="14" valign="middle" colspan="1" width="10%">
                    <b><%=(textListTitleHeader[SESS_LANGUAGE][12]).toUpperCase()%> : <%=(Formater.formatDate(srcSaleReport.getDateFrom(), "dd-MM-yyyy"))%> <%=textListTitleHeader[SESS_LANGUAGE][9]%>
                ...
                <tr align="left" valign="top">
                  <td height="14" valign="middle" colspan="1" width="10%">
                    <b><%=(textListTitleHeader[SESS_LANGUAGE][3]).toUpperCase()%> : <%=location.getName()%> </b>
                  </td>
                  <td height="14" valign="middle" colspan="2" width="90%">
