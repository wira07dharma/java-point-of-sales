                  ...
                  <td colspan="3" class="command"> 
                    <table width="15%" border="0" cellspacing="2" cellpadding="3">
                      <tr> 
                        ...
                        <td nowrap width="80%"><a class="btn btn-primary" href="javascript:addNew()" class="command"><i class="fa fa-plus-circle"></i> <%=ctrLine.getCommand(SESS_LANGUAGE,listTextGlobal[SESS_LANGUAGE][1],ctrLine.CMD_ADD,true)%></a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                  ...
                  <td colspan="3" class="command"> 
                    <table width="15%" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr> 
                        ...
                        <td nowrap width="80%"><a class="btn btn-primary" href="javascript:cmdEditObj('<%=appPrivOID%>')" class="command"><i class="fa fa-pencil"></i> <%=listTextGlobal[SESS_LANGUAGE][10]+" "+listTextGlobal[SESS_LANGUAGE][6]%></a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
