    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdListFirst() {
                ...
                document.frmList.command.value = "<%=Command.FIRST%>";
            ...
            function cmdListPrev() {
                ...
                document.frmList.command.value = "<%=Command.PREV%>";
                document.frmList.action = "privilegeedit.jsp";
                document.frmList.submit();
            }
            ...
            function cmdListNext() {
                ...
                document.frmList.command.value = "<%=Command.NEXT%>";
                document.frmList.action = "privilegeedit.jsp";
                document.frmList.submit();
            }
            function cmdListLast() {
                document.frmList.list_command.value = "<%=Command.LAST%>";
                document.frmList.command.value = "<%=Command.LAST%>";
                document.frmList.action = "privilegeedit.jsp";
                document.frmList.submit();
            }
                                ...
                                <table width="100%">
                                    <tr> 
                                        <td colspan="2" valign="top"> 
                                            <form name="frmList" method="post" action="privilegeedit.jsp">
                                                <table width="100%">
                                                    ...
                                                    <tr> 
                                                        <td colspan="2" class="command"> 
                                                            <% if (iCommand == Command.LIST || iCommand == Command.SAVE || iCommand == Command.DELETE || iCommand == Command.BACK || iCommand == Command.FIRST || iCommand == Command.PREV || iCommand == Command.NEXT || iCommand == Command.LAST) {%>
                                                            <table width="45%" border="0" cellspacing="1" cellpadding="2">
                                                                ...
                                                                <tr> 
                                                                  <!--td width="9%"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100111','','<%=approot%>/images/BtnNewOn.jpg',1)">
                                                                    ...
                                                                    <td nowrap width="41%"><a class="btn btn-primary" href="javascript:cmdAdd()" class="command">
                                                                            <i class="fa fa-plus-circle"></i> <%=ctrLine.getCommand(SESS_LANGUAGE, listTextGlobal[SESS_LANGUAGE][6], ctrLine.CMD_ADD, true)%></a>
                                                                    </td>
                                        <!--td width="7%"><a href="javascript:goPrivilege()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('G2','','<%=approot%>/images/BtnBackOn.jpg',1)">
                                                                    ...
                                                                    <td class="command" width="43%"><a class="btn btn-primary" href="javascript:goPrivilege()">
                                                                            <i class="fa fa-arrow-left"></i> <%=ctrLine.getCommand(SESS_LANGUAGE, listTextGlobal[SESS_LANGUAGE][1], ctrLine.CMD_BACK, true)%></a>
                                                                    </td>
                                                                </tr>
                                                                <% }%>
                                                            </table>
