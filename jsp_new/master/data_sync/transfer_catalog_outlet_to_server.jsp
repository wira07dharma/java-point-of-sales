<%-- 
    Document   : transfer_catalog_outlet_to_server
    Created on : Aug 2, 2013, 11:06:21 AM
    Author     : dimata005
--%>
...
<%
            ...
            int queryDelete = PstDataSyncSql.getCount(PstDataSyncSql.fieldNames[PstDataSyncSql.FLD_DATA_SYNC_ID] + " not in (select " + PstDataSyncSql.fieldNames[PstDataSyncSql.FLD_DATA_SYNC_ID] + " from " + PstDataSyncStatus.TBL_P2_DATA_SYNC_STATUS + ")" );
        ...
        <script language="JavaScript">
            ...
            <%}%>
                ...
                function cmdStart()
                {
                    ...
                    document.frmconn.action="transfer_catalog_outlet_to_server.jsp";
                                                        ...
                                                        <td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" border="0">
                                                                <tr>
                                                                    ...
                                                                    <td width="6"><img src="<%=approot%>/images/spacer.gif" width="1" height="1"></td>
                                                                    <td height="22" valign="middle" colspan="3" width="172"><a href="javascript:cmdResetQuery()" class="command">Reset data </a></td>
