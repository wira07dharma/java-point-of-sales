<%-- 
    Document   : contractregistrationhistory
    Created on : Mar 4, 2014, 2:23:55 PM
    Author     : dimata005
--%>
...
if(((iCommand==Command.SAVE)&&(frmMemberRegistrationHistory.errorSize()==0))||(iCommand==Command.DELETE)){
	response.sendRedirect(""+approot+"/master/contact/contact_company_edit.jsp?command="+Command.EDIT+"&&hidden_contact_id="+oidMemberReg+"&&hidden_member_registration_history_id="+oidMemberRegistrationHistory);
}
...
function cmdEditHistory(oidHistory,oidMemberReg)
{
	...
	document.frmmemberregistrationhistory.action="contractregistrationhistory.jsp";	
...
function cmdBack2Member(oidMemberRegistrationHistory,oidContact){
	document.frmmemberregistrationhistory.hidden_member_registration_history_id.value=oidMemberRegistrationHistory;
	document.frmmemberregistrationhistory.hidden_contact_id.value=oidContact;
	document.frmmemberregistrationhistory.command.value="<%=Command.EDIT%>";
	document.frmmemberregistrationhistory.action="contact_company_edit.jsp";
	document.frmmemberregistrationhistory.submit();
	}
                      ...
                      <tr align="left" valign="top"> 					  						
                          <table width="17%" border="0" cellspacing="2" cellpadding="3">
                            <tr> 
                              ...
                              <td nowrap width="82%"><a href="javascript:cmdBack2Member('<%=oidMemberRegistrationHistory%>','<%=oidMemberReg%>')" class="command">Kembali ke Data Member</a></td>
                            </tr>
                          </table>
                      </tr>						  					  					  
                    </table>
