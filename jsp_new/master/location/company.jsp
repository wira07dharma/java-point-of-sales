...
{
	{"No","Kode Perusahaan","Nama Perusahaan","Nama","Nama Akhir","Alamat Bus","Kota","Provinsi","Negara","Telepon","No Handphone","Fax","Kode Post","Postal Code"},
	{"No","Company Code","Company Name","Person Name","Person Last Name","Buss Address","Town","Province","Country","Telp_nr","Telp Mobile","Fax","Email Company","Postal Code"}
};
...
public String drawList(int language,int iCommand,FrmCompany frmObject,Company objEntity,Vector objectClass,long unitId,int start)
{
	...
	for(int i = 0; i < objectClass.size(); i++) 
	{
		...
		start = start + 1;
			...
			rowx.add(company.getPersonName());
                        rowx.add(company.getPersonLastName());
...
String companyTitle = textListHeader[SESS_LANGUAGE][5]; //com.dimata.posbo.jsp.JspInfo.txtMaterialInfo[SESS_LANGUAGE][com.dimata.posbo.jsp.JspInfo.MATERIAL_SALES];
...
function cmdAdd()
{
	...
	document.frmmatcompany.action="company.jsp";
...
function cmdDelPict(oidCompany)
{
	...
	document.frmimage.action="company.jsp";
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">  
        <tr> 
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" --> 
            Masterdata &gt; <%=textListHeader[SESS_LANGUAGE][4]%><!-- #EndEditable --></td>
        </tr>
        <tr> 
                ...
                <tr align="left" valign="top"> 
                  <td height="8"  colspan="3"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr align="left" valign="top"> 
                        <td height="14" valign="middle" colspan="3" class="comment">&nbsp;<u><%=SESS_LANGUAGE==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT ? "Daftar "+companyTitle : companyTitle+" List"%></u></td>
						</tr>
                      <%
							try{
							%>
                        ...
                        <td height="22" valign="middle" colspan="3"> 
                          ...
                          <table width="17%" border="0" cellspacing="2" cellpadding="3">
                            <tr> 
                              ...
                              <td nowrap width="82%"><a href="javascript:cmdAdd()" class="command"><%=ctrLine.getCommand(SESS_LANGUAGE,textListHeader[SESS_LANGUAGE][5],ctrLine.CMD_ADD,true)%></a></td>
		                      <%}%>							  
                            </tr>
                          </table>
	                      <%}%>					  					  						  
                        ...
                        <td height="100%" width="100%" colspan="2"> 
                          <table border="0" cellspacing="1" cellpadding="1" width="100%">
                            ...
                            <tr align="left"> 
                              ...
                              <td width="1%" valign="top">:</td>
                              <td width="87%" valign="top"> 
                                <textarea name="<%=frmCompany.fieldNames[FrmCompany.FRM_FLD_PERSON_NAME] %>" class="formElemen" cols="39" rows="2" wrap="VIRTUAL"><%= company.getPersonName() %></textarea>
                                * <%= frmCompany.getErrorMsg(FrmCompany.FRM_FLD_PERSON_NAME) %> </td>
                            </tr>
                            <tr align="left"> 
                              <td width="12%"><%=textListHeader[SESS_LANGUAGE][4]%></td>
                              <td width="1%" valign="top">:</td>
                              <td width="87%" valign="top"> 
                                <input type="text" name="<%=frmCompany.fieldNames[FrmCompany.FRM_FLD_PERSON_LAST_NAME] %>"  value="<%= company.getPersonLastName() %>" class="formElemen" size="20">
                              </td>
                            </tr>
                            <tr align="left"> 
                              ...
                              <td width="1%" valign="top">:</td>
                              <td width="87%" valign="top"> 
                                <input type="text" name="<%=frmCompany.fieldNames[FrmCompany.FRM_FLD_BUSS_ADDRESS] %>"  value="<%= company.getBusAddress() %>" class="formElemen" size="20">
                              </td>
                            </tr>
                            <tr align="left"> 
