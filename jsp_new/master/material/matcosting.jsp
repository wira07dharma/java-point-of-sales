...
<%@ page import = "java.util.*,
                   ...
                   com.dimata.posbo.form.masterdata.CtrlCosting,
                   com.dimata.posbo.form.masterdata.FrmCosting,
...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_MASTERDATA, AppObjInfo.G2_MASTERDATA, AppObjInfo.OBJ_MASTERDATA_COST_TYPE); %>
...
{
	{"No.","Nama","Keterangan", "Tipe Biaya"},
	{"No.","Name","Description", "Costing"}
};
...
public String drawList(int language,Vector objectClass,long costingId, int start)
{
	...
	for(int i=0; i<objectClass.size(); i++)
	{
		...
		rowx.add(costing.getDescription());
...
/*switch statement */
iErrCode = ctrlCosting.action(iCommand , oidCosting, request);
/* end switch*/
FrmCosting frmCosting = ctrlCosting.getForm();

/*count list All Costing*/
int vectSize = PstCosting.getCount(whereClause);

/*switch list Costing*/
if((iCommand == Command.FIRST || iCommand == Command.PREV )||
  (iCommand == Command.NEXT || iCommand == Command.LAST)){
		start = ctrlCosting.actionList(iCommand, start, vectSize, recordToGet);
  }
/* end switch list*/

Costing costing = ctrlCosting.getCosting();
msgString =  ctrlCosting.getMessage();

/* get record to display */
listCosting = PstCosting.list(start,recordToGet, whereClause , orderClause);
...
function cmdAdd()
{
	...
	document.frmcosting.command.value="<%=Command.ADD%>";
	document.frmcosting.prev_command.value="<%=prevCommand%>";
	document.frmcosting.action="matcosting.jsp";
...
function cmdAsk(oidCosting)
{
	...
	document.frmcosting.command.value="<%=Command.ASK%>";
	document.frmcosting.prev_command.value="<%=prevCommand%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
...
{
	document.frmcosting.hidden_costing_id.value=oidCosting;
	document.frmcosting.command.value="<%=Command.DELETE%>";
	document.frmcosting.prev_command.value="<%=prevCommand%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
function cmdSave()
{
	document.frmcosting.command.value="<%=Command.SAVE%>";
	document.frmcosting.prev_command.value="<%=prevCommand%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
...
{
	document.frmcosting.hidden_costing_id.value=oidCosting;
	document.frmcosting.command.value="<%=Command.EDIT%>";
	document.frmcosting.prev_command.value="<%=prevCommand%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
...
function cmdBack()
{
	document.frmcosting.command.value="<%=Command.BACK%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
...
{
	document.frmcosting.command.value="<%=Command.FIRST%>";
	document.frmcosting.prev_command.value="<%=Command.FIRST%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
...
{
	document.frmcosting.command.value="<%=Command.PREV%>";
	document.frmcosting.prev_command.value="<%=Command.PREV%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
...
{
	document.frmcosting.command.value="<%=Command.NEXT%>";
	document.frmcosting.prev_command.value="<%=Command.NEXT%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
...
{
	document.frmcosting.command.value="<%=Command.LAST%>";
	document.frmcosting.prev_command.value="<%=Command.LAST%>";
	document.frmcosting.action="matcosting.jsp";
	document.frmcosting.submit();
}
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr align="left" valign="top">
                  <td height="8"  colspan="3">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  %>
                      <tr align="left" valign="top">
                        <td height="22" valign="middle" colspan="3"> <%=drawList(SESS_LANGUAGE,listCosting,oidCosting,start)%> </td>
                      </tr>
                      <%
					  }
					  %>
                ...
                <tr align="left" valign="top">
                  <td height="8" valign="middle" colspan="3">
                    ...
                    <table width="100%" border="0" cellspacing="2" cellpadding="0">
                      ...
                      <tr align="left">
                        ...
                        <td colspan="8" width="90%">
                          <input type="text" name="<%=frmCosting.fieldNames[FrmCosting.FRM_FIELD_NAME] %>"  value="<%= costing.getName() %>" class="formElemen" size="30">
                          * <%=frmCosting.getErrorMsg(frmCosting.FRM_FIELD_NAME)%>
                      <tr align="left">
                        <td width="9%" valign="top">&nbsp;<%=textListHeader[SESS_LANGUAGE][2]%></td>
                        <td width="1%" valign="top">:
                        <td colspan="8" width="90%">
                          <textarea name="<%=frmCosting.fieldNames[FrmCosting.FRM_FIELD_DESCRIPTION] %>" cols="30" rows="5" class="formElemen"><%= costing.getDescription()  %></textarea>
                      <tr align="left" >
                      ...
                      <tr align="left" >
                        <td colspan="10" class="command" valign="top">
                          <%
							...
							String sconDelCom = "javascript:cmdConfirmDelete('"+oidCosting+"')";
					...
					<script language="javascript">
						document.frmcategory.<%=frmCosting.fieldNames[FrmCosting.FRM_FIELD_NAME]%>.focus();
					</script>
                    <%}%>
                  </td>
                </tr>
