...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_MASTERDATA, AppObjInfo.G2_MASTERDATA, AppObjInfo.OBJ_MASTERDATA_COLOR); %>
<%@ include file = "../../main/checkuser.jsp" %>
<%!    public static final String textListHeader[][]
            = {
                {"Warna", "Judul", "Tgl Mulai", "Tgl Berakhir", "Keterangan", "Gambar", "Lokasi"},
                {"Color", "Title", "Valid Start", "Valid End", "Description", "Image", "Location"}
            };

    public static final String textListButton[][]
            = {
                {"Tambah Baru", "Tambah Warna", "Ubah Warna", "Unggah Gambar"},
                {"Add New", "Add Color", "Edit Color", "Upload Image"}
            };
%>
<html>
    <head>
        ...
        $(document).ready(function () {
            ...
            addeditgeneral = function (elementId) {
                $(elementId).click(function () {
                    ...
                    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxColor", ".addeditgeneral-body", false, "json");
                });
            };
            ...
            deletegeneral = function (tableId, elementId) {
                ...
                $(tableId).on("click", elementId, function () {
                    ...
                    if (confirm(confirmText)) {
                        ...
                        getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxColor", null, true, "json");
            ...
            function runDataTables() {
                dataTablesOptions("#countryElement", "tableCountryElement", "AjaxColor", "list", callBackDataTables);
            }
