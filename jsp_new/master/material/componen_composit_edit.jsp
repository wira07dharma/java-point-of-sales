...
*/
public Vector drawListCompositItem(int language,Vector objectClass,int start,boolean privManageData,int iCommand,FrmMaterialComposit frmObject, long oidMatComposit, boolean isDiveCenter){
   ...
   if((objectClass!=null && objectClass.size()>0) || iCommand == Command.ADD){
	...
	if (isDiveCenter){
		ctrlist.addHeader("Index","5%","0","0");
		ctrlist.addHeader("Auto Fill","5%","0","0");
	}
	...
	ctrlist.addHeader(textListTitleHeader[language][16],"10%","0","0");
		...
		Vector sel_value = new Vector(1,1);
		Vector sel_key = new Vector(1,1);
		sel_key.add("No");
		sel_value.add("0");
		sel_key.add("Yes");
		sel_value.add("1");
        ...
        if(index==i && (iCommand==Command.EDIT || iCommand==Command.ASK)) {
			...
			if (isDiveCenter){
				rowx.add("<div align=\"right\"><input type=\"text\" size=\"3\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_SEQUENCE_IDX] +"\" value=\""+materialComposit.getSequenceIdx()+"\" class=\"formElemen\" style=\"text-align:right\"></div>");
				rowx.add("<div align=\"center\">"+ControlCombo.draw(frmObject.fieldNames[frmObject.FRM_FIELD_AUTO_FILL], null, ""+materialComposit.getAutoFill(), sel_value, sel_key,"","formElemen")+"</div>");
			}
			...
			if (isDiveCenter){
				rowx.add("<div align=\"center\">"+materialComposit.getSequenceIdx()+"</div>");
				rowx.add("<div align=\"center\">"+(materialComposit.getAutoFill() == 1 ? "Yes" : "No")+"</div>");
			}
            //add opie 28-06-2012
        ...
        if(iCommand==Command.ADD || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
			...
			if (isDiveCenter){
				rowx.add("<div align=\"right\"><input type=\"text\" size=\"3\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_SEQUENCE_IDX] +"\" class=\"formElemen\" style=\"text-align:right\"></div>");
				rowx.add("<div align=\"center\">"+ControlCombo.draw(frmObject.fieldNames[frmObject.FRM_FIELD_AUTO_FILL], null, ""+0, sel_value, sel_key,"","formElemen")+"</div>");
			}
...
boolean isDiveCenter = false;
try {
	long diveCenterLocation = Long.valueOf(PstSystemProperty.getValueByName("OID_DIVE_CENTER_LOCATION"));
	Location location = PstLocation.fetchExc(diveCenterLocation);
...
if (isDiveCenter){
	orderClauseItem = " MC."+PstMaterialComposit.fieldNames[PstMaterialComposit.FLD_SEQUENCE_IDX];;
}
...
%>
	<jsp:forward page="componen_composit_edit.jsp">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">  
        <tr> 
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->Material
          	 &gt; <%=textListTitleHeader[SESS_LANGUAGE][0]%>
		  <!-- #EndEditable --></td>
        </tr>
        <tr> 
                ...
                <tr>
                  <td colspan="3">
                    <table width="100%" border="0" cellpadding="1">
                      <tr>
                        <td width="10%" align="left"><%=textListTitleHeader[SESS_LANGUAGE][1]%></td>
                        <td width="25%" align="left">: <b><a href="javascript:editbarang('<%=oidMaterial%>')"><%=mat.getSku()%></a> (* <%=textListTitleHeader[SESS_LANGUAGE][2]%></b></td>
                      </tr>
                      <tr>
                        <td width="10%" align="left"><%=textListTitleHeader[SESS_LANGUAGE][3]%></td>
                        <td width="25%" align="left"> : <%=mat.getName()%>
                        </td>
                     </tr>
                      <tr>
                        <td align="left">&nbsp;</td>
                  ...
                  <td colspan="3">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr align="left" valign="top">
                        ...
                        <%
                            Vector list = drawListCompositItem(SESS_LANGUAGE,listMatComposit,startItem,privManageData,iCommand,frmMaterialComposit, oidMatComposit,isDiveCenter);
                      ...
                      <tr align="left" valign="top">
                        <td height="22" valign="middle" colspan="3">
                          ...
                          <table width="50%" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                              <td width="6%"><a href="javascript:addItem()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image200','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image200" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,recCode+" Item Componen",ctrLine.CMD_ADD,true)%>"></a></td>
                              <td width="42%"><a href="javascript:addItem()"><%=ctrLine.getCommand(SESS_LANGUAGE,recCode+" Item",ctrLine.CMD_ADD,true)%></a></td>
                              <td width="6%"><a href="javascript:cmdPrint()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image200','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image200" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,recCode+" Item Componen",ctrLine.CMD_ADD,true)%>"></a></td>
                              <td width="42%"><a href="javascript:cmdPrint()">Export Excel</a></td>
                            </tr>
                          </table>
                           <%}%>
                        </td>
                    ...
                    <table width="100%" border="0">
                      ...
                      <tr>
                        <td width="80%">
                          ...
                          String scomDel = "javascript:cmdAsk('"+oidMatComposit+"')";
                          String sconDelCom = "javascript:cmdConfirmDelete('"+oidMatComposit+"')";
                          String scancel = "javascript:cmdEdit('"+oidMatComposit+"')";
                          ...
                          if(iCommand==Command.SAVE && frmMaterialComposit.errorSize()==0){
