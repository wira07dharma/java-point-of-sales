...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_MASTERDATA, AppObjInfo.G2_MASTERDATA, AppObjInfo.OBJ_MASTERDATA_EMAS_LANTAKAN); %>
...
<%!
    ...
    {
        {"Tambah Baru","Tambah Emas Lantakan","Ubah Emas Lantakan","Unggah Gambar"},
...
<script type="text/javascript">
    $(document).ready(function(){   
        ...
        addeditgeneral = function (elementId) {
            $(elementId).unbind().click(function () {
                ...
                if (dataFor == 'showform') {
                    ...
                    $('#btngeneralform').show();
                } else if (dataFor == 'showhistory') {
                    $(".addeditgeneral-title").html("History Emas Lantakan");
                    $('#btngeneralform').hide();
                }
                dataSend = {
                ...
                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxEmasLantakan", ".addeditgeneral-body", false, "json");
            });
        };
        ...
        deletegeneral = function (tableId, elementId) {
            ...
            $(tableId).on("click", elementId, function () {
                ...
                if (confirm(confirmText)) {
                    ...
                    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxEmasLantakan", null, true, "json");
        ...
        function runDataTables() {
            dataTablesOptions("#countryElement", "tableCountryElement", "AjaxEmasLantakan", "list", callBackDataTables);
        }
