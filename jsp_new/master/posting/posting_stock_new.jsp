...
<%
    ...
    Vector listLocation = PstLocation.listLocationCreateDocument(0, 0, whereClausex, "");
                                             ...
                                             <%}else{%>
                                                <table width="100%" border="0" cellspacing="3" cellpadding="0">
                                                      <tr>
                                                            ...
                                                            <tr>
                                                            <td colspan = "2" ><b>Opname and Posting Rules:</b></td>
                                                            </tr>
                                                            <tr>
                                                            <td>1.</td>
                                                            <td>All stock transaction documents (receipts, sale, etc..) Must be posted prior to the date of of opname </td>
                                                            </tr>
                                                            <tr>
                                                            <td>2.</td>
                                                            <td>    Before day of opname, date and time of opname must be registered in the prochain system by creating a document of 
                                                                <br>opname draft status by filling with complete document data of opname without of opname item. 
                                                                <br>The goal: to avoid the transaction documents after the date and time of opname can be posted before the document entry to the system estate of opname. 
                                                            </td>
                                                            </tr>
                                                            <tr>
                                                            <td>3.</td>
                                                            <td>Documents of opname that are not used, should be delete from the system. </td>
                                                            </tr>
                                                            <tr>
                                                                    <td>4.</td>
                                                            <td>After of opname document entry and posted ,that the other transaction documents can only be posted.
                                                                    </td>
                                                            </tr>
                                                </table>
                                             <%}%>	
