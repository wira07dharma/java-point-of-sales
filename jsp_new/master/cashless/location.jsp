...
//String minimumTitle = com.dimata.material.jsp.JspInfo.txtMaterialInfo[SESS_LANGUAGE][com.dimata.material.jsp.JspInfo.MATERIAL_MINIMUM];
	...
	if (appUser.getCompanyId() != 0){
		...
		whereClause = "loc."+PstLocation.fieldNames[PstLocation.FLD_COMPANY_ID]+"="+appUser.getCompanyId();
	}
                            ...
                            <td><!-- #BeginEditable "content" --> 
                                <form name="frmlocation" method ="post" action="">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr align="left" valign="top"> 
                                            <td height="22" valign="middle" colspan="3"> <%= drawList(SESS_LANGUAGE, listLocation, oidLocation, approot, startLocation, recordToGet)%> </td>
                                        </tr>
                                        <tr align="left" valign="top"> 
                                            ...
                                            <td> 
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr> 
                                                        ...
                                                        <br><td height="22" valign="middle" colspan="3" width="172"><a class="btn-sm btn-primary" href="javascript:cmdAdd()" class="command"><i class="fa fa-plus-circle"></i> <%=ctrLine.getCommand(SESS_LANGUAGE, locationTitle, ctrLine.CMD_ADD, true)%></a></td>
                                                        <%}%>
                                                    </tr>
                                                </table>
                                                <%}%>
                                    ...
                                    <tr align="left"> 
                                        ...
                                        <td width="87%" valign="top">
                                            <% Vector company_value = new Vector();
                                                ...
                                                Vector vlistCompany = PstCompany.list(0, 0, whereCompany, "");
