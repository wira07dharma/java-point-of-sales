...
<html class="bg-black">
    ...
    <body class="bg-olive-">
        <div class="form-box" id="login-box">
            <div ><center><img src="<%=approot%>/images/logo_prochain.jpg"></center><br></div>
            ...
            <form name="frmLogin" action="">
                ...
                <div class="body bg-gray">
                    <div ><br><center><img src="<%=approot%>/imgcompany/<%=pictureCompany == null || pictureCompany.getNamaPicture() == null ? "dimata_system_logo.png" : pictureCompany.getNamaPicture()%>"></center><br></div>
            ...
            <div class="margin text-center">
                <span>Copyright &copy; 2010 Dimata&reg; IT Solution <br>
                              Version 3.0 ( Build : 2016.07.26 )<br>
