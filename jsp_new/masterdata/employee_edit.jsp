...
Vector listCompany = PstCompany.list(0, 0, PstCompany.fieldNames[PstCompany.FLD_COMPANY_ID]+"="+userSession.getAppUser().getCompanyId(), "");
if (employeeOid!=0){
    employee = PstEmployee.fetchExc(employeeOid);
}

if (iCommand==Command.SAVE && iErrCode==0){
    response.sendRedirect("master_employee.jsp");
}
...
<head>
    ...
    <script language="JavaScript">
        ...
        function cmdBack(){
            window.location="master_employee.jsp";
        }
    </script>
