...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_MASTERDATA, AppObjInfo.G2_MASTERDATA, AppObjInfo.OBJ_MASTERDATA_GUIDE); %>
 ...
 */
	...
	{"Data","Harus diisi","0=cash ; >0 Kredit"},
...
//FrmMemberReg frmContact = ctrlMemberReg.getForm();
...
/*
if((iCommand==Command.SAVE)&&(frmContact.errorSize()==0)||iCommand==Command.DELETE){
...
String nationality = FRMQueryString.requestString(request, FrmMemberReg.fieldNames[FrmMemberReg.FRM_FIELD_NATIONALITY]);
	...
	if(((iCommand==Command.SAVE)||(iCommand==Command.DELETE))&&(frmContact.errorSize()<1)) 
        {
	%>
...
function cmdAdd()
{
	...
	document.frmcontact.action="guide_edit.jsp";
...
function cmdBack()
{
	...
	document.frmcontact.action="guidereg_list.jsp";
	document.frmcontact.submit();
}
                            ...
                            <tr>
                              <td width="50%" valign="top">
                                ...
                                <tr id="nama" align="left" valign="top">
                                    ...
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=FrmContact.fieldNames[FrmContact.FRM_FIELD_PERSON_NAME] %>"  value="<%= contact.getPersonName() %>" class="formElemen" size="50" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_PERSON_NAME%>')">
                                    ...
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_PERSON_LASTNAME] %>"  value="<%= contact.getPersonLastname()%>" class="formElemen" size="50" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_PERSON_LASTNAME%>')">
                                   ...
                                   <tr id="username" align="left" valign="top">
                                    ...
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_USER_ID] %>"  value="<%= contact.getUserId() %>" class="formElemen" size="50" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_USER_ID%>')">
                                ...
                                <%--   <tr id="password" align="left" valign="top">
                                    ...
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="password" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_RE_PASSWORD] %>"  value="<%= contact.getPassword() %>" class="formElemen" size="50">
                                ...
                                <table width="90%" border="0" cellspacing="1" cellpadding="1">           
                                   ...
                                   <tr id="company">
                                    <td width="39%"><%=textListHeader[SESS_LANGUAGE][12]%></td>
                                    <td width="4%">:</td>
                                    <td colspan="3">
                                  ...
                                  <tr id="address">
                                    ...
                                    <td colspan="3">
                                      <textarea name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_BUSS_ADDRESS]%>" class="formElemen" cols="50" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_BUSS_ADDRESS%>')"><%= contact.getBussAddress() %></textarea>
                                    </td>
                                  </tr>
                                  <tr id="address">
                      ...
                      <tr>
                        <td colspan="6">
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <%if(privAdd){%>
                              <td height="22" valign="middle" width="15%"><a class="btn btn-lg btn-primary" href="javascript:cmdAdd()"><i class="fa fa-plus-circle"></i> <%=ctrLine.getCommand(SESS_LANGUAGE,textListTitle[SESS_LANGUAGE][0],ctrLine.CMD_ADD,true)%></a></td>
                              <%}%>
                              <!--td height="22" valign="middle" width="3%">
                              ...
                              <td height="22" valign="middle" width="79%"><a class="btn btn-lg btn-primary" href="javascript:cmdAddDiscount('<%=oidContact%>')"><i class="fa fa-file"></i> <%=textListHeader[SESS_LANGUAGE][20]%></a></td>
                            </tr>
                          </table>
                          <%}%>
                        </td>
                                  ...
                                  <tr align="left" valign="top">
                                      ...
                                      <td height="22" valign="middle" width="3%">
                                        <div align="center">
                                            ...
                                            &nbsp;&nbsp;
                                            <a class="btn btn-lg btn-primary" href="javascript:cmdViewHistory('<%=oidContact%>')"><i class="fa fa-file"></i> <%=textListHeader[SESS_LANGUAGE][31]%></a></div>
                                      </td>
                                  </tr>
                              </table>
                          </td>
