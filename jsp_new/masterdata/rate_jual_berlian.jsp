<%-- 
    Document   : rate_jual_berlian
    Created on : Apr 21, 2018, 9:51:14 AM
    Author     : PC
--%>
...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_MASTERDATA, AppObjInfo.G2_MASTERDATA, AppObjInfo.OBJ_MASTERDATA_SELLING_RATE); %>
<%@ include file = "../main/checkuser.jsp" %>
<%!
    public static final String textListHeader[][] = 
    {
        {"Rate Jual","Judul","Tgl Mulai","Tgl Berakhir","Keterangan","Gambar","Lokasi"},
        {"News and Info","Title","Valid Start", "Valid End","Description","Image","Location"}
    };
    
    public static final String textListButton[][]=
    {
        {"Tambah Baru","Tambah Rate Jual","Ubah Rate Jual","Unggah Gambar"},
            ...
            <div class="col-md-12">
                <div class='box box-primary'>
                    <div class='box-header with-border'>
                        <h3 class="box-title">Rate Jual</h3>
                    </div>
                    <div class='box-footer'>
                      <button class="btn btn-sm btn-primary btnaddgeneral" data-toggle="modal" data-target="#modalmodal" data-oid="0" data-for="showform">
                        <i class="fa fa-plus"></i> Add Rate Jual
                      </button>
                    </div>
                    <div class="box-body">                        
...
<script src="../styles/datepicker/bootstrap-datetimepicker.js" charset="UTF-8" type="text/javascript"></script>
<script src="../styles/datepicker/bootstrap-datetimepicker.id.js" charset="UTF-8" type="text/javascript"></script>
    ...
    $(document).ready(function(){   
        ...
        addeditgeneral = function (elementId) {
            $(elementId).unbind().click(function () {
                ...
                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxRateJualBerlian", ".addeditgeneral-body", false, "json");
            });
        };
        ...
        deletegeneral = function (tableId, elementId) {
            $(tableId).on("click", elementId, function () {
                ...
                if (confirm(confirmText)) {
                    ...
                    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxRateJualBerlian", null, true, "json");
        ...
        function runDataTables() {
            dataTablesOptions("#countryElement", "tableCountryElement", "AjaxRateJualBerlian", "list", callBackDataTables);
        }
