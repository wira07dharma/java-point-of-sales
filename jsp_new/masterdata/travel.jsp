...
{             //0          1      2        3           4        5          6          7
	{"Tipe Member","Status","Kode","Nama","Alamat","No Telp","No HP","Tmp/Tgl Lahir",//7
	...
	"Tgl Akhir Berlaku","Nama Produk","Persen","Jumlah","Data Utama","Potongan Khusus","Status Pendaftaran","Status Akhir","Consigment Limit",//9
        "Payment History Note","Member Currency ID","Fax","City","Province","Negara","Kode Pos","View History","Waktu Jatuh Tempo","hari",//23
        "Tanggal Registrasi", "E-mail","Username","Password","re-type Password","No Handphone","Fax","Akun Bank","Akun Bank 2","Alamat Perusahaan"},//43
...
if(iCommand==Command.DELETE){
    if(frmContact.errorSize()==0){
	    response.sendRedirect(approot+"/masterdata/travelreg_list.jsp?command="+Command.FIRST);
    }else{
        //iCommand = Command.EDIT;
...
<%          
          ...
          String sCompCountry =  FRMQueryString.requestString(request,FrmContact.fieldNames[FrmContact.FRM_FIELD_COUNTRY]);
          String sCompProvince =  FRMQueryString.requestString(request,FrmContact.fieldNames[FrmContact.FRM_FIELD_PROVINCE]);
          String sCompRegency =  FRMQueryString.requestString(request,FrmContact.fieldNames[FrmContact.FRM_FIELD_TOWN]);
	...
	/*if(((iCommand==Command.SAVE)))*/
        //{
	%>
        <%-- <jsp:forward page="travelreg_list.jsp"> 
...
function cmdAdd()
{
	...
	document.frmcontact.action="travel.jsp";
...
function cmdBack()
{
	...
	document.frmcontact.action="travelreg_list.jsp";
	document.frmcontact.submit();
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" bgcolor="#FCFDEC" >
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->
            Masterdata &gt; Travel <!-- #EndEditable --></td>
        </tr>
        <tr>
                              ...
                              <td width="50%" valign="top">
                                <table width="85%" border="0" cellspacing="0" cellpadding="1">
                                  <tr id="jumlah" align="left" valign="top">
                                    <td height="21" valign="top" class="mainheader"></td>
                                    ...
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                    <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_CONTACT_CODE] %>"  value="<%= contact.getContactCode() %>" class="formElemen">
                                    ...
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=FrmContact.fieldNames[FrmContact.FRM_FIELD_PERSON_NAME] %>"  value="<%= contact.getPersonName() %>" class="formElemen" size="40" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_PERSON_NAME%>')">
                                    ...
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_PERSON_LASTNAME] %>"  value="<%= contact.getPersonLastname()%>" class="formElemen" size="40" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_PERSON_LASTNAME%>')">
                                      * <%= frmContact.getErrorMsg(FrmContact.FRM_FIELD_PERSON_LASTNAME) %>
                                        
                                  <%--   <tr id="email" align="left" valign="top">
                                    <td height="21" valign="top" width="18%"><%=textListHeader[SESS_LANGUAGE][35]%></td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_EMAIL] %>"  value="<%= contact.getEmail() %>" class="formElemen" size="50" onKeyDown="javascript:cmdEnters('<%=FrmContact.FRM_FIELD_EMAIL%>')"> --%>
                                   <tr id="username" align="left" valign="top">
                                    <td height="21" valign="top" width="18%"><%=textListHeader[SESS_LANGUAGE][36]%></td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_USER_ID] %>"  value="<%= contact.getUserId() %>" class="formElemen" size="40" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_USER_ID%>')">
    ...
    function checkForm(form)
  {
    ...
    return true;
                                       ...
                                       <%--      
                                 <tr id="data_agen">
                                    <td class="mainheader" colspan="5"><u>Data Pribadi</u></td>
                                  </tr>      --%>
                                  ...
                                  <tr align="left" valign="top">
                                    ...
                                    <td height="21" colspan="3"><%
                                                                                                                        ...
                                                                                                                        if (sHomeCountry !="" || sHomeCountry != null ){
                                                                                                                            
                                                                                                                            contact.getHomeCountry();
                                                                                                                        }
                                                                                                                           
                                                                                                                        %>
                                                                                                                        <%= ControlCombo.draw(frmContact.fieldNames[FrmContact.FRM_FIELD_HOME_COUNTRY], "formElemen", null, "" + contact.getHomeCountry(), neg_value, neg_key)%>
                                                                                                                    </td>
                                                                                                                </tr>
                                      <!-- add by fitra -->
                                                                                                             <td width="55%">
                                  <tr align="left" valign="top">
                                    <td height="21" valign="top" width="8%">Provinsi</td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3"><%
                                                                                                                        ...
                                                                                                                        for (int i = 0; i < listPro.size(); i++) {
                                                                                                                            ...
                                                                                                                            pro_value.add(String.valueOf(prov.getNmProvinsi()));
                                                                                                                               ...
                                                                                                                               if (sHomeProvince != "" || sHomeProvince != null){
                                                                                                                                   contact.getHomeProvince();
                                                                                                                                     }

                                                                                                                        %>
                                                                                                                        <%= ControlCombo.draw(frmContact.fieldNames[FrmContact.FRM_FIELD_HOME_PROVINCE], "formElemen", null, "" + contact.getHomeProvince(), pro_value, pro_key)%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <!-- add by fitra -->
                                                                                                                <td width="55%">
                                  <tr align="left" valign="top">
                                    <td height="21" valign="top" width="8%">Kota</td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3"><%
                                                                                                                        ...
                                                                                                                        for (int i = 0; i < listKab.size(); i++) {
                                                                                                                            ...
                                                                                                                            if(sRegency !="" || sRegency != null){
                                                                                                                                
                                                                                                                                contact.getHomeTown();
                                                                                                                            }

                                                                                                                                
                                                                                                                        %> <%= ControlCombo.draw(frmContact.fieldNames[FrmContact.FRM_FIELD_HOME_TOWN], "formElemen", null, "" + contact.getHomeTown() , kab_value, kab_key)%>
                                                                                                                    </td>
                                                                                                                </tr>
                                    ...
                                    <td height="21" valign="top" width="8%"><%=textListHeader[SESS_LANGUAGE][4]%></td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <textarea cols="30" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_HOME_ADDR] %>"  class="formElemen" onKeyDown="javascript:cmdenters('<%=FrmContact.FRM_FIELD_HOME_ADDR%>')"><%= contact.getHomeAddr() %></textarea>
                                    ...
                                    <tr id="no_telp" align="left" valign="top">
                                    <td height="21" valign="top" width="8%"><%=textListHeader[SESS_LANGUAGE][5]%></td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_HOME_TELP] %>"  value="<%= contact.getHomeTelp() %>" class="formElemen" onKeyDown="javascript:cmdenters('<%=FrmContact.FRM_FIELD_HOME_TELP%>')">
                                  
                                     <tr id="no_mobile" align="left" valign="top">
                                    <td height="21" valign="top" width="8%"><%=textListHeader[SESS_LANGUAGE][39]%></td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_TELP_MOBILE] %>"  value="<%= contact.getTelpMobile() %>" class="formElemen" onKeyDown="javascript:cmdenters('<%=FrmContact.FRM_FIELD_TELP_MOBILE%>')">
                                    ...
                                    <td height="21" width="17%">
                                      <% Vector membersex_value = new Vector(1,1);
                                       ...
                                       %>
                                      <%= ControlCombo.draw(frmContact.fieldNames[FrmContact.FRM_FIELD_MEMBER_SEX],null, sel_membersex, membersex_key, membersex_value, cmdSex, "formElemen") %>       
                                    
                                    
                                    
                                    <td id="agama" height="21" width="7%">
                                    <td width="55%">
                                  <tr align="left" valign="top">
                                  ...
                                  <tr align="left" valign="top">
                                    ...
                                    <td height="21" colspan="3"><%
                                        ...
                                        //String selectNegara ="";
                                        String nationality = FRMQueryString.requestString(request, FrmContact.fieldNames[FrmContact.FRM_FIELD_NATIONALITY]);
                                ...
                                <tr id="consigment_limit">
                                    ...
                                    %>
                                    <%=ControlCombo.draw(frmContact.fieldNames[FrmContact.FRM_FIELD_CURRENCY_TYPE_ID_MEMBER_CONSIGMENT_LIMIT],"formElemen", null, ""+contact.getCurrencyTypeIdMemberConsigmentLimit(), vectCurrVal, vectCurrKey, "")%>
                                    </td>
                                  ...
                                  <tr id="credit_limit">
                                    ...
                                    <td width="4%">:</td>
                                    <td valign="top">
                                    <%=ControlCombo.draw(frmContact.fieldNames[FrmContact.FRM_FIELD_CURRENCY_TYPE_ID_MEMBER_CREDIT_LIMIT],"formElemen", null, ""+contact.getCurrencyTypeIdMemberCreditLimit(), vectCurrVal, vectCurrKey, "")%>
                                    </td>
                                    <td colspan="0">
                                ...
                                <table width="60%" border="0" cellspacing="1" cellpadding="1">           
                                  ...
                                  <!-- add by fitra -->
                                                                                                                    <td width="55%">
                                  <tr align="left" valign="top">
                                    <td height="21" valign="top" width="39%">Country</td>
                                    ...
                                    <td height="21" colspan="3">                                                        <%
                                                                                                                        ...
                                                                                                                        for (int i = 0; i < listNegg.size(); i++) {
                                                                                                                           Negara nega = (Negara) listNegg.get(i);
                                                                                                                            ...
                                                                                                                            nega_value.add(String.valueOf(nega.getNmNegara()));
                                                                                                                        }


                                                                                                                          if(sCompCountry !="" || sCompCountry != null){
                                                                                                                              
                                                                                                                              contact.getCompCountry();
                                                                                                                                        }
                                                                                                                        %>
                                                                                                                        
                                                                                                                        
                                                                                                                        
                                                                                                                        <%= ControlCombo.draw(FrmContact.fieldNames[FrmContact.FRM_FIELD_COMP_COUNTRY], "formElemen", null, "" +  contact.getCompCountry(), nega_value, nega_key)%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                <!-- add by fitra -->
                                                                                                                <td width="55%">
                                  <tr align="left" valign="top">
                                    <td height="21" valign="top" width="39%">Province</td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">                                                        <%
                                                                                                                        ...
                                                                                                                        prov_key.add("select ...");
                                                                                                                        //Vector listPro = PstProvinsi.list(0, 0, "", " NAMA_PROP ");
                                                                                                                        //String strWheres = PstProvinsi.fieldNames[PstProvinsi.FLD_ID_NEGARA] + "= '"+oidCnegara + "'";
                                                                                                                        Vector listProv = PstProvinsi.list(0, 0, "", "NAMA_PROP");
                                                                                                                        for (int i = 0; i < listProv.size(); i++) {
                                                                                                                            Provinsi provv = (Provinsi) listProv.get(i);
                                                                                                                            prov_key.add(provv.getNmProvinsi());
                                                                                                                            prov_value.add(String.valueOf(provv.getNmProvinsi()));
                                                                                                                        }

                                                                                                                            if (sCompProvince !="" || sCompProvince !=null){
                                                                                                                                     contact.getCompProvince();   
                                                                                                                              }


                                                                                                                        %>
                                                                                                                        <%= ControlCombo.draw(FrmContact.fieldNames[FrmContact.FRM_FIELD_COMP_PROVINCE], "formElemen", null, "" + contact.getCompProvince(), prov_value, prov_key)%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                               <!-- add by fitra --> 
                                                                                                                <td width="55%">
                                  <tr align="left" valign="top">
                                    <td height="21" valign="top" width="39%">Regency</td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3"><%
                                                                                                                        ...
                                                                                                                        kabb_key.add("select ...");
                                                                                                                        //Vector listKab = PstKabupaten.list(0, 0, "", " NAMA_KAB ");
                                                                                                                        //String strWhereKabb = PstKabupaten.fieldNames[PstKabupaten.FLD_ID_PROPINSI] + "=" + oidCprovinsi;
                                                                                                                        Vector listKabb = PstKabupaten.list(0, 0, "", "NAMA_KAB");
                                                                                                                        for (int i = 0; i < listKabb.size(); i++) {
                                                                                                                             Kabupaten town = (Kabupaten) listKabb.get(i);
                                                                                                                            kabb_key.add(town.getNmKabupaten());
                                                                                                                            kabb_value.add(String.valueOf(town.getNmKabupaten()));
                                                                                                                        }
                                                                                                                            
                                                                                                                        if (sCompRegency != "" || sCompRegency != null){
                                                                                                                            
                                                                                                                            contact.getCompRegency();
                                                                                                                                }
                                                                                                                        %><%= ControlCombo.draw(FrmContact.fieldNames[FrmContact.FRM_FIELD_COMP_REGENCY], "formElemen", null, "" + contact.getCompRegency() , kabb_value, kabb_key)%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                 <tr id="Area">
                                    <td width="39%">Area</td>
                                    ...
                                    <td colspan="3">
                                     ...
                                     <tr id="address">
                                    <td width="39 valign="top"><%=textListHeader[SESS_LANGUAGE][4]%></td>
                                    <td width="4%" valign="top">:</td>
                                    <td colspan="3">
                                      <textarea name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_BUSS_ADDRESS]%>" class="formElemen" cols="35" onKeyDown="javascript:cmdEnter('<%=FrmContact.FRM_FIELD_BUSS_ADDRESS%>')"><%= contact.getBussAddress() %></textarea>
                                    </td>
                                  </tr>                                                                            
                                   <tr id="address">
                                    <td width="39%" valign="top">Email</td>
                                    <td width="4%" valign="top">:</td>
                                    <td colspan="3">
                                      ...
                                      <tr id="no_telp" align="left" valign="top">
                                    <td height="21" valign="top" width="39%"><%=textListHeader[SESS_LANGUAGE][5]%></td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_TELP_NR] %>"  value="<%= contact.getTelpNr() %>" class="formElemen" onKeyDown="javascript:cmdenters('<%=FrmContact.FRM_FIELD_TELP_NR%>')">
                                  
                                      
                                     <tr id="fax" align="left" valign="top">
                                    <td height="21" valign="top" width="39%"><%=textListHeader[SESS_LANGUAGE][40]%></td>
                                    <td height="21" valign="top">:</td>
                                    <td height="21" colspan="3">
                                      <input type="text" name="<%=frmContact.fieldNames[FrmContact.FRM_FIELD_FAX] %>"  value="<%= contact.getFax() %>" class="formElemen" onKeyDown="javascript:cmdenters('<%=FrmContact.FRM_FIELD_FAX%>')"> 
                                                                                                               
                                  <tr id="zip">
                                    <td width="39%"><%=textListHeader[SESS_LANGUAGE][30]%></td>
                                    <td width="4%">:</td>
                                    <td colspan="3">
                      ...
                      <tr>
                        <td colspan="6">
                          ...
                          <%--<%
                          int maxFld = FrmContact.fieldNames.length;
                             for(int idx=0;idx< maxFld;idx++)
                             {     
                                String msgX = frmContact.getErrorMsg(idx); 
                                if(msgX!=null && msgX.length()>0){
                                   out.println( FrmContact.fieldNamesUser[idx]+" = "+ frmContact.getErrorMsg(idx)+";");
                                 }
                             }
                        %>--%>
                        </td>
