...
<%    /* VARIABLE DECLARATION */
    ...
    String whereClause = PstEmployee.fieldNames[PstEmployee.FLD_COMPANY_ID] +" = "+userSession.getAppUser().getCompanyId();
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdListFirst() {
                ...
                document.frmEmployee.action = "master_employee.jsp";
                document.frmEmployee.submit();
            }
            ...
            function cmdEditMaxDisc(oidEmp, oidAss, maxDiscAmount) {
                ...
                $('#btn-savemaxdisc').click(function () {
                    ...
                    document.formmaxdisc.action = "master_employee.jsp";
