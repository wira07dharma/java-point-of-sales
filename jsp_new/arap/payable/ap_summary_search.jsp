...
<%
  /* 
 * Page Name  		:  ap_summary_search.jsp
...
<%!  public static final String textListHeader[][] = {
    {"Supplier", "Nomor Invoice", "Tanggal Invoice", "Mata Uang", "Urut Berdasar", "dari", "s/d", "Cari Rekap Utang", "Gudang", "Penerimaan Barang", "Laporan", "Rekap Hutang", "Lokasi"},
    {"Supplier", "Invoice Number", "Invoice Date", "Currency", "Order By", "from", "to", "Search List AP", "Warehouse", "Receive Goods", "Report", "AP Summary", "Location"}
  };
  ...
  <head>
    ...
    <script language="JavaScript">
      function cmdSearch() {
        ...
        document.frmSrcOpname.action = "ap_summary_view.jsp";
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">  
            <tr> 
              <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->
                <%=textListHeader[SESS_LANGUAGE][8]%> &gt; <%=textListHeader[SESS_LANGUAGE][9]%> &gt; <%=textListHeader[SESS_LANGUAGE][10]%> &gt; <%=textListHeader[SESS_LANGUAGE][11]%>
                <!-- #EndEditable --></td>
            </tr>
            <tr> 
                    ...
                    <tr> 
                      <td> 
                        ...
                        <table width="100%" border="0" cellspacing="2" cellpadding="2">
						  ...
						  <tr>
                            <td height="13" valign="top" width="12%" align="left">Term Of Payment</td>
                          ...
                          <tr> 
                            ...
                            <td width="87%" > <table width="35%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="90%" class="command" nowrap><a class="btn-primary btn-lg" href="javascript:cmdSearch()"><i class="fa fa-search"> &nbsp;<%=textListHeader[SESS_LANGUAGE][7]%></i></a></td>
                                </tr>
                              </table></td>
                          </tr>
                        </table>
