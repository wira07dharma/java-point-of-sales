						...
						<tr> 
						  <td nowrap align="left" class="command">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                    <td height="22" valign="middle" colspan="3"><a class="btn-primary btn-lg" href="javascript:cmdBackToSearch()" class="command"><i class="fa fa-backward"> &nbsp;<%=textGlobalTitle[SESS_LANGUAGE][4]%></i></a></td>
                                <% if(records.size() > 0) { %>
                                    <td width="195" nowrap>&nbsp; <a class="btn-primary btn-lg" href="javascript:printForm()" class="command" ><i class="fa fa-print">&nbsp;<%=textGlobalTitle[SESS_LANGUAGE][8]%></a></i></td>
                                <% } %>
                              </tr>
                            </table></td>
						</tr>						
