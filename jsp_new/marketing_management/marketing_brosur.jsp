...
<%
    Vector brosurSize = PstMarketingManagement.list(0, 0, "", "");
...
#btn-add-brosur {
    ...
    <script type="text/javascript" src="../styles/select2/js/select2.min.js"></script>
       ...
       <div class="container">
           ...
           <div class="row">
               ...
               <div class="col-md-3 wrapper-total">
                   <div class="card-wrapper">
                       <button class="btn" id="btn-add-brosur">Add Brosur</button>
                   </div>
  ...
  $('[data-toggle="tooltip"]').tooltip()
            ...
            $(".btn_edit").click(function(){
               ...
               // moving page
               window.location ="add_brosur.jsp?command=<%=Command.EDIT%>&oid="+oid;
           });
           ...
           $(".btn_view").click(function(){
               ...
               var oid = $(this).data('oid');
               // moving page
               window.location ="add_brosur.jsp?command=<%=Command.VIEW%>&oid="+oid;
           });
           $(".btn_delete").click(function(){
               
               var oid = $(this).data('oid');
               // moving page
               window.location ="add_brosur.jsp?command=<%=Command.DELETE%>&oid="+oid;
           });
