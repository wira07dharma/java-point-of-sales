<%-- 
    Document   : srcprforpomaterial
    Created on : Feb 20, 2014, 2:25:34 PM
    Author     : dimata005
--%>
...
FrmSrcPurchaseRequest frmSrcPurchaseRequest = new FrmSrcPurchaseRequest();
try
{
...
function cmdAdd(){
	...
	document.<%=FrmSrcPurchaseRequest.FRM_NAME_SRCORDERMATERIAL%>.action="#";
...
function cmdSearch(){
	...
	document.<%=FrmSrcPurchaseRequest.FRM_NAME_SRCORDERMATERIAL%>.action="pofromprmaterial_list.jsp";
	document.<%=FrmSrcPurchaseRequest.FRM_NAME_SRCORDERMATERIAL%>.submit();
}
                ...
                <tr>
                  <td colspan="2">
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        <td height="21" width="9%"><%=getJspTitle(0,SESS_LANGUAGE,poCode,false)%></td>
                        <td height="21" width="1%">:</td>
                        <td height="21" width="90%">&nbsp;
                          <input type="text" name="<%=frmSrcPurchaseRequest.fieldNames[FrmSrcPurchaseRequest.FRM_FIELD_PRMNUMBER] %>"  value="<%= srcPurchaseRequest.getPrmnumber() %>" class="formElemen" size="20">
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td height="21" width="90%" valign="top" align="left">
                          <table width="47%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td class="command" nowrap width="39%"><a class="btn-primary btn-lg" href="javascript:cmdSearch()"><i class="fa fa-search"> &nbsp;<%=ctrLine.getCommand(SESS_LANGUAGE,poTitle,ctrLine.CMD_SEARCH,true)%></i></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
