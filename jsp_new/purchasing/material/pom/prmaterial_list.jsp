<%-- 
    Document   : prmaterial_list
    Created on : Feb 5, 2014, 10:25:08 PM
    Author     : dimata005
--%>
...
function cmdAdd(){
	...
	document.frm_requestmaterial.action="prmaterial_edit.jsp";
...
function cmdBack(){
	...
	document.frm_requestmaterial.action="srcprmaterial.jsp";
	document.frm_requestmaterial.submit();
}
