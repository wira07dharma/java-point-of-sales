	    ...
	    Vector vtitem = (Vector)objectClass.get(i);
            ...
            //if(sts){
                lstLinkData.add(material.getOID()+"','"+material.getSku()+"','"+name+"','"+unit.getCode()+
                        "','"+unit.getOID()+
                        "','"+material.getDefaultCostCurrencyId()+"','"+material.getAveragePrice());
//            }else{
//                lstLinkData.add(material.getOID()+"','"+material.getSku()+"','"+name+"','"+unit.getCode()+
...
if(vectSize==0 || showAllGoods==1)
    ...
    System.out.println("Material Request to Warehouse Search");
/**
...
Vector vect = SessMinimumStock.getMaterialListMinimumStock(srcMinimumStock,start,recordToGet, objMaterial);
...
%>
    <script language="JavaScript">
       ...
       self.opener.document.forms.frm_purchaseorder.<%=FrmPurchaseRequestItem.fieldNames[FrmPurchaseRequestItem.FRM_FIELD_PRICE_BUYING]%>.value = "<%=material.getAveragePrice()%>";
...
function cmdEdit(matOid,matCode,matItem,matUnit,matUnitId,matUnitReqId, matHpp){
    ...
    self.opener.document.forms.frm_purchaseorder.<%=FrmPurchaseRequestItem.fieldNames[FrmPurchaseRequestItem.FRM_FIELD_PRICE_BUYING]%>.value = matHpp;
...
function cmdListFirst(){
    ...
    document.frmvendorsearch.action="materialrequesttowarehousesearch.jsp";
    document.frmvendorsearch.submit();
}
