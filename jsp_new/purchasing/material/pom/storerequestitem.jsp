                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <form role="form" id="frm_purchaseorder" name="frm_purchaseorder" method="post" action="">
                              ...
                              <input type="hidden" id="po_id" name="<%=FrmPurchaseOrderItem.fieldNames[FrmPurchaseOrderItem.FRM_FIELD_PURCHASE_ORDER_ID]%>" value="<%=oidPurchaseOrder%>">
                              ...
                              <div class="box-body">
                                  <div class="row">
                                           ...
                                           <div class="col-md-4">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <%
                                                      ...
                                                      %>
                                                      &nbsp;&nbsp;
                                                      <input name="<%=FrmPurchaseOrder.fieldNames[FrmPurchaseOrder.FRM_FIELD_CURRENCY_ID]%>" id='oidCurency' type="hidden" class="formElemen" size="10" value="<%=oidCurrency%>">
                                      ...
                                      <div class="row">
                                          <input type="hidden" id="language" value='<%= SESS_LANGUAGE%>'>
                                          <div class="col-md-12" id='dataPlace'>
...
<script>
    $(document).ready(function(){
        ...
        var loadContent = function(type){
            command = "<%= Command.NONE%>";
            dataFor = "showMappingForm";
            var oidActive = $("#FRM_FIELD_OID_ACTIVE_TAB").val();
            var value = "";
            if (type=="1" || type=="2"){
            ...
            dataSend = {
                "FRM_FIELD_DATA_FOR"      : dataFor,
                "FRM_FIELD_OID_LOCATION"  : oidActive,
                "FRM_FIELD_LANGUAGE"      : language,
                "FRM_FIELD_VALUE_TEMP"    : value,
                "command"		  : command
            };
            //alert(JSON.stringify(dataSend));
            onSuccess = function(data){};
            ...
            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxMappingItemStore", "#tabContent",true, "json");
            
        };
        
        var changeTab = function(elementId){
            $(elementId).click(function(){
                var oid = $(this).data("oidlocation");
                $("#FRM_FIELD_OID_ACTIVE_TAB").val(oid);
                loadContent("1");
            });
        };
        ...
        var next = function(){
            ...
            command = "<%= Command.NONE%>";
            dataFor = "showRecapitulation";
            
            dataSend = {
                "FRM_FIELD_DATA_FOR"      : dataFor,
                "FRM_FIELD_OID_LOCATION"  : locationid,
                "FRM_FIELD_LANGUAGE"      : language,
                "FRM_FIELD_PO_ID"         : poid,
                "command"		  : command
            };
        ...
        $("#dataPlace").delegate("#nextAfterFill", "click", function(){
            poId= $(this).data("poid");
        ...
        $("#dataPlace").delegate("#btnBack", "click", function(){
            //alert("test");
            loadTab();
            //loadContent("0");
        });
        
        $("#dataPlace").delegate("#btnSaveAllItem", "click", function(){
            //alert("test");
            var poid=poId;
            var locationid = locationId;
            command = "<%= Command.SAVE%>";
            dataFor = "saveAllItem";
            var oidCurrency = $("#oidCurency").val();
            var valueCurent ="";
            $(this).attr("disabled",true);
            //alert(oidCurrency);
            $(".curentQty").each(function(){
                var oid = $(this).data("oidmaterial");
                ...
                if (valueCurent.length>0){
                    valueCurent += ";"+oid+"-"+""+qtyRequest+""+"-"+value+"-"+unitId+"";
                }else{
                    valueCurent += ""+oid+"-"+""+qtyRequest+""+"-"+value+"-"+unitId+"";
                }
            });
            ...
            dataSend = {
                ...
                "FRM_FIELD_LANGUAGE"      : language,
                "FRM_FIELD_PO_ID"         : poid,
                "FRM_FIELD_VALUE_CURRENT" : valueCurent,
                "FRM_FIELD_ID_CURRENCY"   : oidCurrency,
                "FRM_FIELD_USER_ID"       : userId,
                "FRM_FIELD_USER_NAME"     : userName ,
                "command"		  : command
            };
            //alert(JSON.stringify(dataSend));
            onSuccess = function(data){};
            onDone = function(data){
                ...
                if (data.FRM_FIELD_HTML=="0"){
                    document.frm_purchaseorder.hidden_material_order_id.value=poid;                   
