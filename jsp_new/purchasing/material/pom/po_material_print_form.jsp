                                        ...
                                        <tr align="center"> 
                                                ...
                                                <table width="100%" border="0" cellpadding="1">
                                                    <tr align="left" class="listgensell">
                                                        <td colspan="4">
                                                            <table width="100%" border="0" cellpadding="1">
                                                                <tr>
                                                                    <td class="title" align="left" width="15%"><center><img src="../../../images/company_pdf.jpg"></center></td>
                                                                    <%if(typeRequest==0){%>
                                                    ...
                                                    <tr class="listgensell"> 
                                                        ...
                                                        <td width="30%" align="left"> : <%=po.getPoCode()%> </td>
                                                        <td width="19%" align="left" valign="bottom">&nbsp; </td>
                                                    <td width="41%" align="left"><%=textHeaderMain[SESS_LANGUAGE][4]%>                                                     </tr>
                                                    <tr class="listgensell"> 
                                                        <td width="10%" align="left"><%=textHeaderMain[SESS_LANGUAGE][3]%></td>
                                                        <td width="30%" align="left">: <%=Formater.formatDate(po.getPurchDate(), "dd-MM-yyyy")%></td>
                                                        <td width="19%" align="left" valign="bottom">&nbsp; </td>
                                                        <td width="41%" align="left"><%=textHeaderMain[SESS_LANGUAGE][5]%> :
                                                            <%
                                            ...
                                            %>
                                                    ...
                                                    <tr class="listgensell"> 
                                                        ...
                                                        <td width="41%" align="left"><%=textHeaderMain[SESS_LANGUAGE][6]%> : 
                                                            <%=cnt.getBussAddress()%>                                                        </td>
                                                    </tr>

                                                    <tr class="listgensell"> 
                                                        <td width="10%" align="left">&nbsp;</td>
                                                        <td width="30%" align="left">: <%=loc.getAddress()%></td>
                                                        <td width="19%" align="left" valign="bottom">&nbsp; </td>
                                                        <td width="41%" align="left"><%=textHeaderMain[SESS_LANGUAGE][7]%> : 
                                                            <%=cnt.getTelpNr()%>                                                        </td>
                                                    </tr>
                                                     <tr class="listgensell"> 
                                                        ...
                                                        <td width="19%" align="left" valign="bottom">&nbsp; </td>
                                                        <td width="41%" align="left"><%=textHeaderMain[SESS_LANGUAGE][8]%> : 
                                                            <%=cnt.getTelpNr()%>                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                    ...
                                                    <tr> 
                                                        ...
                                                        <td width="35%" valign="top">
                                                            <table width="100%" border="0">
                                                                ...
                                                                %>
                                                                <!--tr class="listgensell">
                                                                    <td width="56%"><div align="right"><input type="checkbox" disabled=\"true\" name="<%//=FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_INCLUDE_PPN]%>" value="1" <% if (po.getIncludePpn() == 1) {%>checked<%}%>><%//=textHeaderMain[SESS_LANGUAGE][9]%>&nbsp;<%//=textHeaderMain[SESS_LANGUAGE][7]%>
                                                                            <input type="text" disabled=\"true\"  class="formElemen" name="<%//=FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_TOTAL_PPN]%>" value="<%if (ppn != 0.0) {%><%//=FRMHandler.userFormatStringDecimal(ppn)%><%} else {%><%//=FRMHandler.userFormatStringDecimal(defaultPpn)%><%}%>"  size="5" style="text-align:right">&nbsp;<%//=textHeaderMain[SESS_LANGUAGE][9]%></div>
                                                                    </td>
                                                                <!--<td width="15%">
                                                                </td>-->
                                                                <!--td width="30%">
                                                        ...
                                                        <td width="27%" valign="top"> 
                                                            <table width="100%" border="0">
                                                                <tr class="listgensell"> 
                                                                    ...
                                                                    <td width="41%"> 
                                                                        <div align="right"> 
                                                                            <%                                                                                //ppn = totalharga * rec.getTotalPpn() / 100;
                                                                                //ppn = totalharga + ppn;
