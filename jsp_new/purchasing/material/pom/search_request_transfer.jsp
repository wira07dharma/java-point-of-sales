<%-- 
    Document   : search_request_transfer
    Created on : Feb 5, 2020, 3:25:28 PM
    Author     : Regen
--%>
...
//        Date Picker
      ...
      function cmdAdd() {
        ...
        document.frmPurchaseRequest.action = "prtowarehousematerial_edit.jsp";
  ...
  <body>
    <section class="content-header">
      <h1>Transfer<small> Request</small> </h1>
      <ol class="breadcrumb">
        <li>Pencarian</li>
        <li>Transfer</li>
      </ol>
                  ...
                  <div class="form-group">
                    ...
                    <div class=" col-sm-8">
                      <select class="form-control input-sm select2" name="<%=frmSrcPurchaseRequest.fieldNames[FrmSrcPurchaseRequest.FRM_FIELD_PRMSTATUS]%>" multiple="" id="doc_status">
                        <%
                            for (int i = 0; i < SrcPurchaseRequest.statusRequestKey.length; i++) {
                           long oidStatus = Long.parseLong(SrcPurchaseRequest.statusRequestValue[i]);
                            String selected = "";
                            ...
                            %>
                        <option value="<%=SrcPurchaseRequest.statusRequestValue[i] %>" <%=selected %>><%=SrcPurchaseRequest.statusRequestKey[i]%></option>
                        <%}
                        %>
                      </select>
                    </div>
            ...
            <div class="col-md-12">
              <div id="requestTableElement">
                <table id="listRequestTransfer" class="table table-striped table-bordered table-responsive" style="font-size: 14px">
                    ...
                    <tbody>
                      <%
                        whereClause += " MAT." + PstPurchaseRequest.fieldNames[PstPurchaseRequest.FLD_REQUEST_SOURCE]+" = "+PurchaseRequest.TYPE_SOURCE_TRANSFER;
                        ...
                        if(sortBy.equals("0")){
                            ...
                            order = "MAT."+PstPurchaseRequest.fieldNames[PstPurchaseRequest.FLD_LOCATION_ID]+ " ASC";
                            ...
                            order = "MAT."+PstPurchaseRequest.fieldNames[PstPurchaseRequest.FLD_PURCH_REQUEST_DATE]+ " ASC";
                        }else  if(sortBy.equals("4")){
                            order = "MAT."+PstPurchaseRequest.fieldNames[PstPurchaseRequest.FLD_PR_STATUS]+ " ASC";
                        }

                        Vector listPurchase = SessPurchaseRequest.listPurchaseRequest(start, record, whereClause, order);
