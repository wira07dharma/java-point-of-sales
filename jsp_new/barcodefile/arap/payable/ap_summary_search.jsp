...
public static final String textListHeader[][] = {
	{"Supplier","Nomor Invoice","Tanggal Invoice","Mata Uang","Urut Berdasar","dari","s/d","Cari Rekap Utang","Gudang","Penerimaan Barang","Laporan","Rekap Hutang"},
	{"Supplier","Invoice Number","Invoice Date","Currency","Order By","from","to","Search List AP","Warehouse","Receive Goods","Report","AP Summary"}
};
