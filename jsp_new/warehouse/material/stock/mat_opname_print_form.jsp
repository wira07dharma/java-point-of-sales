                                                    ...
                                                    <%
                                                        ...
                                                        for (int i = 0; i < listMatStockOpnameItem.size(); i++) {
                                                            ...
                                                            if (headerCompare.equals(header)) {
                                                                ...
                                                                out.println("<tr><td colspan='10'><b>" + header + "</b></td><tr>");
                                                            }

                                                            start = start + 1;
                                                            out.println("<tr>");
                                                            out.println("<td>" + start + "</td>");
                                                            out.println("<td nowrap>" + mat.getSku() + "</td>");
                                                            out.println("<td>" + mat.getBarCode() + "</td>");
                                                            out.println("<td>" + mat.getName() + "</td>");
                                                            ...
                                                            out.println("<td align='right'>" + opname + "</td>");
                                                            out.println("<tr>");
                                        ...
                                        <tr>
                                            <td valign="top">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                    ...
                                                    <tr> 
                                                        <td width="25%" align="center" nowrap>PETUGAS 1</td>  
                                                        <td width="25%" align="center" nowrap>PETUGAS 2</td>
                                                        <td width="25%" align="center" nowrap>KEPALA TOKO</td>
                                                        <td width="25%" align="center" nowrap>EDP/INVENTORY</td>
                                                    </tr>
                                                    <tr align="left" valign="top"> 
