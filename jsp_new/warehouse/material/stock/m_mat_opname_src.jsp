...
String oidNumber = FRMQueryString.requestString(request, frmSrcMatStockOpname.fieldNames[frmSrcMatStockOpname.FRM_FIELD_PRMNUMBER] );
...
if (oidDate == 1 || oidLoc != 0 || oidNumber != "" || oidCat != 0) {   
...
function cmdAdd(){
	...
	document.frmsrcmatstockopname.action="m_mat_opname_edit.jsp";
...
function cmdSearch(){
	...
	document.frmsrcmatstockopname.action="m_mat_opname_src.jsp";
	document.frmsrcmatstockopname.submit();
}
           ...
           <!-- Right side column. Contains the navbar and content of the page -->
            <aside class="right-side">
                ...
                <section class="content">
                    <form name="frmsrcmatstockopname" method ="post" action=""  role="form">
                        <!--form hidden -->
                        ...
                        <!--body-->
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><%=textListHeader[SESS_LANGUAGE][14]%> </label><br>
                                            <input type="text" class="form-control"  placeholder="Nomor Dokument" name="<%=frmSrcMatStockOpname.fieldNames[frmSrcMatStockOpname.FRM_FIELD_PRMNUMBER] %>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"><%=textListHeader[SESS_LANGUAGE][0]%> </label><br>
                                            <%= ControlCombo.drawBootsratap(frmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_LOCATION_ID], null, selectValue, locationid_value, locationid_key, "", "form-control")%>	
                                        </div>
                                        
                                        <div class="form-group">
                                            
                                            <label for="exampleInputEmail1"><%=textListHeader[SESS_LANGUAGE][2]%></label><br>
                                            <select id="<%=FrmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_CATEGORY_ID]%>"  name="<%=FrmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_CATEGORY_ID]%>" class="form-control">
                                                ...
                                                if(materGroup!=null && materGroup.size()>0) {
                                                   ...
                                                   // Vector<Category> resultTotal= new Vector();
                                                    ...
                                                    for(int i=0; i<materGroup.size(); i++) {
                                                        ...
                                                        %>
                                                            <option value="<%=mGroup.getOID()%>" <%=mGroup.getOID()==oidCat?checked:""%> ><%=parent%><%=mGroup.getName()%></option>
                                                        <%
                                                    }
                                                } else {
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">  <%=textListHeader[SESS_LANGUAGE][4]%></label><br>
                                       ...
                                       <input type="radio" class="formElemen" name="<%=frmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_STATUS_DATE] %>" <%if(srcMatStockOpname.getStatusDate()==1){%>checked<%}%> value="1">
                                        <%=textListHeader[SESS_LANGUAGE][6]%> <%=ControlDate.drawDateWithBootstrap(frmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_FROM_DATE],srcMatStockOpname.getFromDate(),1,-5,"form-control-date","") %> 
                                        <%=textListHeader[SESS_LANGUAGE][7]%> <%=ControlDate.drawDateWithBootstrap(frmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_TO_DATE],srcMatStockOpname.getToDate(),1,-5,"form-control-date","")%> 
						  ...
						  %> 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <b>Aturan Opname dan Posting :</b> <br>
                                        1. Semua dokumen transaksi stock (penerimaan, sale, dsb.) harus sudah diposting sebelum tanggal opname <br>
                                        2. Sebelum hari opname, Tanggal dan jam opname harus didaftarkan di sistem prochain dengan membuat 
   						...
   						<br>Tujuannya : untuk menghindari dokumen transaksi setelah tgl dan jam opname bisa diposting sebelum 
							dokumen opname real dientry ke sistem.<br>
                                        3. Dokumen opname yang tidak dipakai harus dihapus dari sistem.<br>
                                        4. Setelah dokumen opname dientry dan diposting maka dokumen transaksi lainnya baru bisa diposting.
                                    </div>
