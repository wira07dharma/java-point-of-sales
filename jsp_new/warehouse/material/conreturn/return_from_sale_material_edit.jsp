<%-- 
    Document   : return_from_sale_material_edit
    Created on : Jan 14, 2014, 6:17:51 AM
    Author     : dimata005
--%>
...
function cmdBack()
{
	...
	document.frminvoice.action="return_from_sale_list.jsp";
...
function gostock(oid) {
    ...
    document.frminvoice.action="return_from_sale_stockcode.jsp";
    document.frminvoice.submit();
}
...
function cmdSave(){
    ...
    document.frminvoice.action="return_from_sale_material_edit.jsp";
    document.frminvoice.submit();
}
...
function printDeliveryOrder()
{
    ...
    window.open("return_from_sale_material_edit_print_form.jsp?command=<%=Command.EDIT%>&type_print_tranfer="+typePrint+"&timemls=1&hidden_bill_main_id=<%=oidBillMainOid%>","pireport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}
  ...
  <tr>
    <td valign="top" align="left">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->&nbsp;Return Dari Pengiriman Barang > Cari Return > List Retur > Edit Retur<!-- #EndEditable --></td>
        </tr>
        <tr>
