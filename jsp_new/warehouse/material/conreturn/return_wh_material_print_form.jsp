...
{
	{"Nomor","Consignee","Tanggal","Supplier","Status","Keterangan"},
	{"No","Consignee","Date","Supplier","Status","Remark"}	
};
...
public static final String textListOrderItem[][] = 
{
	...
	{"No","Code","Name","Unit","Cost","Price","Currency","Qty","Total Beli"}
};
...
String retTitle = "Stok Keluar (ke consignor)"; //i_pstDocType.getDocTitle(docType);
                                ...
                                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                  ...
                                  <%
									...
									for(int i=0; i<listMatConReturnItem.size(); i++)
									{
										...
										MatConReturnItem recItemx = (MatConReturnItem)temp.get(0);
										Material mat = (Material)temp.get(1);
										Unit unit = (Unit)temp.get(2);
										CurrencyType currencyType = (CurrencyType)temp.get(3);
										start = start + 1;
