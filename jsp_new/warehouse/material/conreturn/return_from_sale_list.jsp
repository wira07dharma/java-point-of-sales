<%-- 
    Document   : return_from_sale_list
    Created on : Jan 14, 2014, 6:10:52 AM
    Author     : dimata005
--%>
...
if(iSaleReportType==1){
      whereCashCredit = PstBillMain.fieldNames[PstBillMain.FLD_BILL_DATE]+" BETWEEN '"+startDate+"' AND '"+endDate+"'"+
			" AND ("+
                        "("+PstBillMain.fieldNames[PstBillMain.FLD_DOC_TYPE]+"="+PstBillMain.TYPE_RETUR+
...
function cmdEdit(oid){
	...
	document.frm_reportsale.action="return_from_sale_material_edit.jsp";
	document.frm_reportsale.submit();
}

function cmdListFirst(){
	document.frm_reportsale.command.value="<%=Command.FIRST%>";
	document.frm_reportsale.action="return_from_sale_list.jsp";
	document.frm_reportsale.submit();
}
...
function cmdBack(){
	...
	document.frm_reportsale.action="src_return_from_sale.jsp";
	document.frm_reportsale.submit();
	//history.back();
}
  ...
  <tr>
    <td valign="top" align="left">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->&nbsp;Return Dari Pengiriman Barang > Cari Return > List Retur<!-- #EndEditable --></td>
        </tr>
        <tr>
