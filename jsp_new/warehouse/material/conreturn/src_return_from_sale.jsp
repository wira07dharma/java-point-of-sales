<%-- 
    Document   : src_return_from_sale
    Created on : Jan 14, 2014, 6:09:49 AM
    Author     : dimata005
--%>
...
function cmdSearch(){
	...
	document.frmsrcreportsale.action="return_from_sale_list.jsp";
  ...
  <tr>
    <td valign="top" align="left">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->&nbsp;Return Dari Pengiriman Barang > Cari Return<!-- #EndEditable --></td>
        </tr>
        <tr>
                ...
                <tr>
                  <td colspan="2">
                    <table width="100%" border="0" cellspacing="3" cellpadding="1">
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left">Tipe</td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                        <%
						...
						val_saletype.add(""+SrcSaleReport.TYPE_RETUR+"");
                                                key_saletype.add(SrcSaleReport.reportType[SESS_LANGUAGE][SrcSaleReport.TYPE_RETUR]);
                      ...
                      <tr>
                        <td height="21" valign="top" width="9%" align="left">Cashier</td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left">&nbsp;
                          <%
