...
public static final String textListGlobal[][] = {
	{"Tidak ada data penerimaan barang...", "LAPORAN PENERIMAAN BARANG PER SUPLIER", "Dari", "s/d", "Lokasi", "Suplier"},
	{"Receiving goods item not found...", "GOODS RECEIVE REPORT BY SUPPLIER", "From", "to", "Location", "Supplier"}
};
...
public Vector drawList2(int language, Vector objectClass) {
	...
	if(objectClass!=null && objectClass.size()>0) {
		...
		for(int i=0; i<objectClass.size(); i++) {
			...
			MatConReceiveItem matReceiveItem = (MatConReceiveItem)vt.get(0);
			...
			MatConReceive matReceive = (MatConReceive)vt.get(5);
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" --> 
            &nbsp;Laporan > Penerimaan > Semua Barang<!-- #EndEditable --></td>
        </tr>
        <tr> 
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportsale" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top"> 
                  <td height="14" colspan="3" align="center" ><strong><%=textListGlobal[SESS_LANGUAGE][1]%></strong></td>
                </tr>
                <tr align="left" valign="top"> 
                ...
                <tr align="left" valign="top"> 
                  <td height="22" valign="middle" colspan="3">
				    <strong><%=textListGlobal[SESS_LANGUAGE][4]%> : <%=location.getName().toUpperCase()%></strong>
				  </td>
                </tr>
                <tr align="left" valign="top"> 
                  <td height="22" valign="middle" colspan="3">
				    <strong><%=textListGlobal[SESS_LANGUAGE][5]%> : <%=contactList.getCompName().toUpperCase()%></strong>
				  </td>
                </tr>
				<tr align="left" valign="top"> 
