...
{
	self.opener.frmsrcstockcard.<%=FrmSrcStockCard.fieldNames[FrmSrcStockCard.FRM_FIELD_MATERIAL_ID]%>.value = matOid;
	self.opener.frmsrcstockcard.txtkode.value = matCode;
	self.opener.frmsrcstockcard.txtnama.value = matItem;
	self.close();
}
            ...
            <form name="frmmaterialsearch" method="post" action="">
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="1">
                ...
                <tr>
                  <td width="17%">&nbsp;</td>
                  <td width="83%">&nbsp;
                    <input type="button" name="Button" value=" Cari Barang " onClick="javascript:cmdSearch()" class="formElemen">
                  </td>
                </tr>
                <tr>
