...
public static final String textListGlobal[][] = {
	{"Tidak ada data ...", "LAPORAN RETUR BARANG KE SUPLIER PER SUPLIER", "Periode", "Dari", "s/d", "Lokasi", "Suplier", 
	 "Merk", "Kategori", "Semua", "Laporan Retur Barang", "Cetak Laporan Retur Barang"},
	{"No data available ...", "GOODS RETURN TO SUPPLIER BY SUPPLIER REPORT", "Periode", "From", "to", "Location", "Supplier",
	 "Merk", "Category", "All", "Stock Potition Report", "Print Stock Potition Report"}
};


/* this constant used to list text of listHeader */
public static final String textListMaterialHeader[][] = {
	{"NO","SKU","NAMA BARANG","QTY","HPP","TOTAL HPP"},
	{"NO","SKU","GOODS NAME","QTY","COGS","TOTAL COGS"}
};
...
public Vector drawList(int language, Vector objectClass) {
	...
	if(objectClass!=null && objectClass.size()>0) {
		...
		ctrlist.addHeader(textListMaterialHeader[language][2],"35%","0","0");
		ctrlist.addHeader(textListMaterialHeader[language][3],"15%","0","0");
		ctrlist.addHeader(textListMaterialHeader[language][4],"15%","0","0");
		ctrlist.addHeader(textListMaterialHeader[language][5],"15%","0","0");
		...
		for(int i=0; i<objectClass.size(); i++) {				
			...
			rowx.add("<div align=\"right\">"+FRMHandler.userFormatStringDecimal(matReturnItem.getCost())+"</div>");
			rowx.add("<div align=\"right\">"+FRMHandler.userFormatStringDecimal(matReturnItem.getTotal())+"</div>");
			
			totalNilaiHpp += matReturnItem.getTotal();
          ...
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportreturn" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top"> 
                  <td width="13%" valign="middle"><strong><%=textListGlobal[SESS_LANGUAGE][2]%></strong></td>
                  <td width="87%" valign="middle"><strong>: <%=Formater.formatDate(srcReportReturn.getDateFrom(), "dd-MM-yyyy")%> <%=textListGlobal[SESS_LANGUAGE][4]%> <%=Formater.formatDate(srcReportReturn.getDateTo(), "dd-MM-yyyy")%> </strong></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td valign="middle"><strong><%=textListGlobal[SESS_LANGUAGE][5]%></strong></td>
                  <td><strong>: <%=location.getName().toUpperCase()%></strong></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td valign="middle"><strong><%=textListGlobal[SESS_LANGUAGE][6]%></strong></td>
                  <td valign="middle"><strong>: <%=contactList.getCompName().toUpperCase()%></strong></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td align="left" valign="middle" colspan="2"><%=strDrawList%></td>
                </tr>
                <tr align="left" valign="top"> 
                  <td height="22" align="right" valign="middle" colspan="3"> <h4></font><b>GRAND 
                    <%=textListMaterialHeader[SESS_LANGUAGE][5]%> :&nbsp;&nbsp;&nbsp;<%=strTotalHpp%></b></h3> 
				  </td>
                </tr>
                <tr align="left" valign="top"> 
                      ...
                      <tr> 
                        <td width="85%"> <table width="52%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              ...
                              <td class="command" nowrap width="90%"><a href="javascript:cmdBack()"><%=ctrLine.getCommand(SESS_LANGUAGE,"Retur Barang",ctrLine.CMD_BACK_SEARCH,true)%></a></td>
                            </tr>
                          </table></td>
