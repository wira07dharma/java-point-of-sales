<%-- 
    Document   : delivery_order_list
    Created on : Nov 26, 2013, 11:24:50 AM
    Author     : dimata005
--%>
...
public static final String textListMaterialHeader[][] = {
    ...
    {"No","Number","Date","Delivery Order From","Delivery Order To","Status","Keterangan"}
};
...
if(iCommand==Command.BACK || iCommand==Command.FIRST || iCommand==Command.PREV || iCommand==Command.NEXT || iCommand==Command.LAST) {
    try {
        ...
        srcMatDispatch.setStatusDeliveryOrder(1);
 ...
 */
vectSize = sessMatDispatch.getCountMatDispatch(srcMatDispatch);
if(iCommand==Command.FIRST || iCommand==Command.NEXT || iCommand==Command.PREV || iCommand==Command.LAST || iCommand==Command.LIST) {
    start = ctrlMatDispatch.actionList(iCommand,start,vectSize,recordToGet);
}
Vector records = sessMatDispatch.listMatDispatch(srcMatDispatch,start,recordToGet);
%>
<!-- End of Jsp Block -->
...
function cmdBack()
{
    ...
    document.frm_matdispatch.action="src_delivery_order.jsp";
    document.frm_matdispatch.submit();
}
