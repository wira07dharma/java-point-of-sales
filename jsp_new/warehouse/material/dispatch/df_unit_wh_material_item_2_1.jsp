...

{
    ...
    {"No","Sku","Nama Barang","Unit","Qty","Group","Source", "Target"},

    {"No","Code","Goods Name","Unit","Qty","Group","Source", "Target"}
    ...
    //if(objectClass!=null && objectClass.size()>0) {
       ...
       //ctrlist.addHeader(textListOrderItem[language][4],"5%");
        ...
        for(int i=0; i<objectClass.size(); i++){
            ...
            rowx.add(drawListSourceItem(language,iCommand,frmObject,objEntity,listItem,dfRecGroupId,start,locationId,dfRecGroupIdItem,dfRecItemId,commandType));
            rowx.add(drawListTargetItem(language,iCommand,frmObject,objEntity,listItem,dfRecGroupId,start,locationId,dfRecGroupIdItem,dfRecItemId,commandType));
...
public String drawListSourceItem(int language,int iCommand,FrmMatDispatchReceiveItem frmObject,
   ...
   for(int i=0; i<objectClass.size(); i++) {
        ...
        if(index==i && (iCommand==Command.EDIT || iCommand==Command.ASK)) {
            ...
            rowx.add("<input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_DISPATCH_MATERIAL_ITEM_ID]+"\" value=\""+dfRecItem.getSourceItem().getOID()+
                    "\"><input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_MATERIAL_SOURCE_ID]+"\" value=\""+dfRecItem.getSourceItem().getMaterialSource().getOID()+
    ...
    //if(iCommand==Command.ADD && (dfRecGroupId!=0 || dfRecGroupIdItem!=0) || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
      if(iCommand==Command.ADD && (dfRecGroupIdItem!=0) && dfRecGroupIdItem==dfRecItem.getDfRecGroupId()&& commandType == CtrlMatDispatchReceiveItem.COMMAND_TYPE_ITEM || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
        ...
        rowx.add("<input type=\"text\" size=\"40\" name=\"matItem\" value=\""+""+"\" class=\"formElemen\" onKeyUp=\"javascript:keyDownCheck(event)\">&nbsp;<a href=\"javascript:cmdCheck()\">CHK</a>");
    ...
    //add Item Group
    //if(iCommand==Command.ADD && (dfRecGroupId!=0 || dfRecGroupIdItem!=0) || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
      if(iCommand==Command.ADD && (dfRecGroupId!=0) && dfRecGroupId==dfRecItem.getDfRecGroupId() && commandType != CtrlMatDispatchReceiveItem.COMMAND_TYPE_GROUP || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
    ...
    //add Item
    //if(iCommand==Command.ADD && (dfRecGroupId!=0 || dfRecGroupIdItem!=0) || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
      //if(iCommand==Command.ADD && (dfRecGroupIdItem!=0) && commandType == CtrlMatDispatchReceiveItem.COMMAND_TYPE_ITEM || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
      if(iCommand==Command.ADD && (dfRecGroupIdItem!=0) && dfRecGroupIdItem==objEntity.getDfRecGroupId()&& commandType == CtrlMatDispatchReceiveItem.COMMAND_TYPE_ITEM || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
        if(iCommand==Command.ADD){
    ...
    //add Item Group
    //if(iCommand==Command.ADD && (dfRecGroupId!=0 || dfRecGroupIdItem!=0) || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
       if(iCommand==Command.ADD && (dfRecGroupId!=0) && dfRecGroupId==objEntity.getDfRecGroupId() && commandType != CtrlMatDispatchReceiveItem.COMMAND_TYPE_GROUP || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
        if(iCommand==Command.ADD){
...
/**
* Drawlist for target item
* By Mirahu
*/

/*public String drawListTargetItem(int language,int iCommand,FrmMatDispatchReceiveItem frmObject,
   ...
   for(int i=0; i<objectClass.size(); i++) {
        ...
        if(index==i && (iCommand==Command.EDIT || iCommand==Command.ASK)) {
            ...
            rowx.add("<div align=\"right\"><input type=\"text\" size=\"5\" onkeyup=\"javascript:cntTotal(this, event)\" style=\"text-align:right\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_QTY_SOURCE] +"\" value=\""+FRMHandler.userFormatStringDecimal(dfRecItem.getTargetItem().getQty())+"\" class=\"formElemen\" style=\"text-align:right\">"+
    ...
    if(iCommand==Command.ADD || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
        ...
        rowx.add("<input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_MATERIAL_TARGET_ID]+"\" value=\""+""+
                "\"><input type=\"text\" size=\"10\" name=\"matCode1\" value=\""+""+"\" class=\"formElemen\" onKeyUp=\"javascript:keyDownCheck(event)\">&nbsp;<a href=\"javascript:cmdCheck()\">CHK</a>");
        rowx.add("<input type=\"text\" size=\"40\" name=\"matItem1\" value=\""+""+"\" class=\"formElemen\" onKeyUp=\"javascript:keyDownCheck(event)\">&nbsp;<a href=\"javascript:cmdCheck()\">CHK</a>");
        ...
        rowx.add("<div align=\"right\"><input type=\"text\" size=\"5\" onkeyup=\"javascript:cntTotal(this, event)\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_QTY_TARGET] +"\" value=\""+""+"\" class=\"formElemen\" style=\"text-align:right;"+styleQty+"\"   >"+
   ...
   for(int i=0; i<objectClass.size(); i++) {
        ...
        if(index==i && (iCommand==Command.EDIT || iCommand==Command.ASK)) {
            ...
            rowx.add("<input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_RECEIVE_MATERIAL_ITEM_ID]+"\" value=\""+dfRecItem.getTargetItem().getOID()+
                    "\"><input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_MATERIAL_TARGET_ID]+"\" value=\""+dfRecItem.getTargetItem().getMaterialTarget().getOID()+
     ...
     //new Item Target
        ...
        if(iCommand==Command.ADD && (dfRecGroupIdItem!=0) && dfRecGroupIdItem==dfRecItem.getDfRecGroupId()&& commandType == CtrlMatDispatchReceiveItem.COMMAND_TYPE_ITEM || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
            ...
            rowx.add(""+(start+1));
            rowx.add("<input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_MATERIAL_TARGET_ID]+"\" value=\""+""+
               "\"><input type=\"text\" size=\"10\" name=\"matCode1\" value=\""+""+"\" class=\"formElemen\" onKeyUp=\"javascript:keyDownCheck1(event1)\">&nbsp;<a href=\"javascript:cmdCheck1()\">CHK</a>");
            rowx.add("<input type=\"text\" size=\"40\" name=\"matItem1\" value=\""+""+"\" class=\"formElemen\" onKeyUp=\"javascript:keyDownCheck1(event1)\">&nbsp;<a href=\"javascript:cmdCheck1()\">CHK</a>");
            rowx.add("<input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_UNIT_TARGET_ID]+"\" class=\"hiddenText\" value=\""+""+
               "\"><input type=\"text\" size=\"5\" name=\"matUnit1\" value=\""+""+"\" class=\"hiddenText\" readOnly>");
            rowx.add("<div align=\"right\"><input type=\"text\" size=\"5\" onkeyup=\"javascript:cntTotal1(this, event1)\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_QTY_TARGET] +"\" value=\""+""+"\" class=\"formElemen\" style=\"text-align:right;"+styleQty1+"\"   >"+
               "<input type=\"hidden\" name=\"avbl_qty1\" value=\"0\"></div>");
...
iErrCode = ctrlMatDispatchReceiveItem.action(iCommand,oidDispatchReceiveItem,oidDfRecGroupSame,oidDispatchMaterial,oidDfRecGroup,commandType);
...

{
    ...
    document.frm_matdispatch.action="df_unit_wh_material_item_2_1.jsp";
...

{
    ...
    //document.frm_matdispatch.hidden_dispatch_receive_item_id.value="0";
    document.frm_matdispatch.command.value="<%=Command.ADD%>";
    document.frm_matdispatch.command.value="<%=CtrlMatDispatchReceiveItem.COMMAND_TYPE_GROUP%>";
    document.frm_matdispatch.prev_command.value="<%=prevCommand%>";
        ...
        <tr> 
          ...
          <td><!-- #BeginEditable "content" -->
                        ...
                        <td colspan="3" >
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                            ...
                            <tr align="left" valign="top">
                              ...
                              Vector list = drawListGroupItem(SESS_LANGUAGE,iCommand,frmMatDispatchReceiveItem, dfRecItem,listMatDispatchReceiveItem,dfRecItem.getDfRecGroupId(),startItem,df.getLocationId(),oidDfRecGroup,oidDispatchReceiveItem, commandType);
                            ...
                            <tr align="left" valign="top">
                              ...
                              <td height="22" colspan="3" valign="middle">
                                ...
                                String scancel = "javascript:cmdEdit('"+oidDispatchReceiveItem+"')";
                                ...
                                //for add new group
                                ctrLine.setAddCaption(ctrLine.getCommand(SESS_LANGUAGE,dfCode+" New Group", ctrLine.CMD_ADD, true));
				...
				%>
                                ...
                                <table width="70%" border="0" cellspacing="2" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <td width="6%"><a href="javascript:cmdAddGroup()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image200','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image200" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Item",ctrLine.CMD_ADD,true)%>"></a></td>

                                    <td width="20%"><a href="javascript:cmdAddGroup()"><%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Item",ctrLine.CMD_ADD,true)%></a></td>
                                    ...
                                    <% if(iCommand==Command.SAVE) {%>
                                        <!--<td width="6%"><a href="javascript:cmdAddGroup()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image200','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image200" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Group",ctrLine.CMD_ADD,true)%>"></a></td>-->
                                        <!--<td width="20%"><a href="javascript:cmdAddGroup()"><%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Item",ctrLine.CMD_ADD,true)%></a></td>-->
                                   <% } %>
                              ...
                              %>                              </td>
                               ...
                               <!--for add new group-->
                               <tr>
                                  <td width="4%"><a href="javascript:cmdAddGroup()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image200','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image200" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Group",ctrLine.CMD_ADD,true)%>"></a></td>
                                  <td width="96%"><a href="javascript:cmdAddGroup()"><%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Group",ctrLine.CMD_ADD,true)%></a><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image200','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image200" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Item",ctrLine.CMD_ADD,true)%>"></a><a href="javascript:cmdAdd()"><%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Item",ctrLine.CMD_ADD,true)%></a></td>
                               <!--</tr>-->
            ...
            <script language="JavaScript">
                ...
                document.frm_matdispatch.matCode1.focus();
