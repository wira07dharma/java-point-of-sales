<%-- 
    Document   : src_delivery_order
    Created on : Nov 26, 2013, 11:04:05 AM
    Author     : dimata005
--%>
...
public static final String textListGlobal[][] = {
    {"Pengiriman Barang","Pencarian"},
    {"Delivery Order","Searching"}
};
...
function cmdAdd()
{
    ...
    document.frmsrcmatdispatch.action="delivery_order_material_edit.jsp";
...
function cmdSearch()
{
    ...
    document.frmsrcmatdispatch.action="delivery_order_list.jsp";
    document.frmsrcmatdispatch.submit();
}
