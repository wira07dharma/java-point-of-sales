<%-- 
    Document   : src_produksi
    Created on : Dec 26, 2017, 2:38:49 PM
    Author     : Ed
--%>
...
<body bgcolor = "#ffffff">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li>
                <a href="http://localhost:8080/dProchain_20161124/menuapp/menu_page.jsp?menu=transfer&titlemenu=Transfer"> Tansfer
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <div class="col-sm-10 col-sm-offset-2">
                                                    <button type="button" class="btn btn-primary" id="btnSearch" data-oid="0" data-for="searchProduksi"><i class="fa fa-search"></i>&nbsp;Cari&nbsp;Dokumen&nbsp;Produksi</button>
                                                    &nbsp;
                                                    <a href="add_produksi.jsp" class="btn btn-primary" id="btnAdd" data-oid="0" data-for="addProduksi"><i class="fa fa-plus"></i>&nbsp;Tambah&nbsp;Dokumen&nbsp;Produksi</a>
                                                </div>
                                            </div>    
                                        </div>    
                                    </div>    
...
<script>
    $(document).ready(function () {
        ...
        function runDataTables() {
            dataTablesOptions("#tableList", "tabletableList", "AjaxSrcProduksi", "listevent", null);
        }
