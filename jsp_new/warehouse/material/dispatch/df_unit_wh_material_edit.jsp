...
public Vector drawListGroupItem(int language,Vector objectClass,int start, boolean privManageData, String approot, int typeOfBusinessDetail) {
    ...
    if(objectClass!=null && objectClass.size()>0) {
       ...
       //ctrlist.addHeader(textListOrderItem[language][4],"5%");
        ...
        for(int i=0; i<objectClass.size(); i++){
            ...
            Vector listSource = drawListSourceItem(language, listItem, start,privManageData, approot, typeOfBusinessDetail); 
            ...
            Vector ListTargetItem = drawListTargetItem(language, listItem, start, typeOfBusinessDetail);
...
*/
public Vector drawListSourceItem(int language,Vector objectClass,int start, boolean privManageData, String approot, int typeOfBusinessDetail) {
...
*/
public Vector drawListTargetItem(int language,Vector objectClass,int start, int typeOfBusinessDetail) {
                  ...
                  <td colspan="3">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr align="left" valign="top">
                        ...
                        Vector list = drawListGroupItem(SESS_LANGUAGE,listMatDispatchReceiveItem,startItem, privManageData, approot, typeOfBusinessDetail); 
                      ...
                      <tr align="left" valign="top">
                        ...
                        try{
                          /*if(listError.size()> 0){
                            Vector detailList = (Vector) listError.get(0);
