...
public Vector drawListGroupItem(int language,int iCommand,FrmMatDispatchReceiveItem frmObject,
        ...
        long dfRecGroupId,int start,long locationId,long dfRecGroupIdItem, long dfRecItemId, int commandType, int startGroup) {
    ...
    //if(objectClass!=null && objectClass.size()>0) {
       ...
       //ctrlist.addHeader(textListOrderItem[language][4],"5%");
        ...
        for(int i=0; i<objectClass.size(); i++){
            ...
            //rowx.add("<div align=\"center\">"+(startGroup+i+1)+"</div>");
            //rowx.add("<div align=\"center\">"+(startGroup)+"</div>");
            //rowx.add("<div align=\"center\">"+(startGroup)+"</div><a href=\"javascript:cmdEdit('"+String.valueOf(dfRecItem.getDfRecGroupId())+"')\"><div align=\"center\">Edit</div>");
     ...
     // if(iCommand==Command.ADD || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
        ...
        if(iCommand==Command.ADD && (dfRecGroupId==0 && dfRecGroupIdItem==0) && commandType==CtrlMatDispatchReceiveItem.COMMAND_TYPE_GROUP){
            ...
            //rowx.add("");
            //rowx.add("<div align=\"center\">"+(startGroup+1)+"</div>");
...
public String drawListSourceItem(int language,int iCommand,FrmMatDispatchReceiveItem frmObject,
   ...
   for(int i=0; i<objectClass.size(); i++) {
    ...
    /*long oidDfRecGroupList = 0L;
    for (int i = 0; i < objectClass.size(); i++) {
     MatDispatchReceiveItem dfRecItem = (MatDispatchReceiveItem) objectClass.get(i);
                     oidDfRecGroupList = dfRecItem.getDfRecGroupId();
    }*/
                        ...
                        <td colspan="3" >
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                            ...
                            <tr align="left" valign="top">
                              ...
                              Vector list = drawListGroupItem(SESS_LANGUAGE,iCommand,frmMatDispatchReceiveItem, dfRecItem,listMatDispatchReceiveItem,dfRecItem.getDfRecGroupId(),startItem,df.getLocationId(),oidDfRecGroup,oidDispatchReceiveItem, commandType, startGroup);
