...
public static final String textListGlobal[][] = {
    ...
    {"Transfer Unit","Edit","Tidak ada item transfer unit","Cetak Transfer Unit","Proses transfer tidak dapat dilakukan pada lokasi yang sama"},
 ...
 * By Mirahu
*/
public String drawListItem(int language,Vector objectClass,int start) {
...
iErrCode = ctrlMatDispatch.action(iCommand , oidDispatchMaterial);
...
//iErrCode = ctrlMatDispatchReceiveItem.action(iCommand, oidMatDispatchReceiveItem);
//FrmMatDispatchReceiveItem frmdfRecItem = ctrlMatDispatchReceiveItem.getForm();
//MatDispatchReceiveItem dfRecItem = ctrlMatDispatchReceiveItem.getMatDispatchReceiveItem();
//errMsg = ctrlMatDispatchReceiveItem.getMessage();
...
//int vectSizeItem = PstMatDispatchReceiveItem.getCount(PstMatDispatchReceiveItem.fieldNames[PstMatDispatchReceiveItem.FLD_DISPATCH_MATERIAL_ID] + " = " + oidDispatchMaterial);
...
%>
	...
	<jsp:forward page="df_unit_wh_material_list.jsp">
...
function cmdEdit(oid){
    ...
    document.frm_matdispatchrecitem.action="df_unit_wh_material_edit.jsp";
...
function cmdSave() {
    ...
    %>
        ...
        //if(invSupp!=''){
            ...
            //var transfer_from = document.frm_matdispatchrecitem.<%=FrmMatDispatch.fieldNames[FrmMatDispatch.FRM_FIELD_LOCATION_ID]%>.value;

           // var transfer_to = document.frm_matdispatchrecitem.<%=FrmMatDispatch.fieldNames[FrmMatDispatch.FRM_FIELD_DISPATCH_TO]%>.value;
...
function cmdBack(){
    ...
    document.frm_matdispatchrecitem.action="df_unit_wh_material_list.jsp";
...
function printForm() {
	window.open("df_unit_wh_material_print_form.jsp?hidden_dispatch_id=<%=oidDispatchMaterial%>&command=<%=Command.EDIT%>&timemls=<%=timemls%>","pireport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}
...

{
    ...
    %>
        ...
        document.frm_matdispatchrecitem.action="df_unit_wh_material_item.jsp";
...
%>
              ...
              <input type="hidden" name="<%=FrmMatDispatch.fieldNames[FrmMatDispatch.FRM_FIELD_LOCATION_TYPE]%>" value="<%=PstMatDispatch.FLD_TYPE_TRANSFER_UNIT%>">
			...
			%>
                      ...
                      <tr>
                        ...
                        if(listMatDispatchReceiveItem.size()>0){
                        ...
                        <td height="22" valign="middle" colspan="3">
                          ...
                          <table width="24%" border="0" cellspacing="2" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td width="10%"><a href="javascript:addGroupItem()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image200','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image200" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Group Item",ctrLine.CMD_ADD,true)%>"></a></td>
                              <td width="90%"><a href="javascript:addGroupItem()"><%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Group Item",ctrLine.CMD_ADD,true)%></a></td>
                        ...
                        <td width="23%">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td width="95%" nowrap>&nbsp; <a href="javascript:printForm('<%=oidDispatchMaterial%>')" class="command" ><%=textListGlobal[SESS_LANGUAGE][3]%></a></td>
