...
public String drawList(int language,Vector objectClass,int start,int docType,I_DocStatus i_status) {
    ...
    if(objectClass!=null && objectClass.size()>0) {
        ...
        for(int i=0; i<objectClass.size(); i++) {
            ...
            //MatDispatchReceiveItem dfRecItem = (MatDispatchReceiveItem)vt.get(0);
...
vectSize = sessMatDispatch.getCountMatDispatchReceive(srcMatDispatch);
if(iCommand==Command.FIRST || iCommand==Command.NEXT || iCommand==Command.PREV || iCommand==Command.LAST || iCommand==Command.LIST) {
    start = ctrlMatDispatch.actionList(iCommand,start,vectSize,recordToGet);
}
Vector records = sessMatDispatch.listMatDispatchReceive(srcMatDispatch,start,recordToGet);    
%>
...
function cmdSearch()
{
    ...
    document.frm_matdispatch.action="srcdf_unit_wh_material.jsp";
        ...
        <tr>
          <td><!-- #BeginEditable "content" -->
            <form name="frm_matdispatch" method="post" action="">
              ...
              <input type="hidden" name="<%=frmSrcMatDispatch.fieldNames[FrmSrcMatDispatch.FRM_FIELD_LOCATION_TYPE]%>" value="<%=PstMatDispatch.FLD_TYPE_TRANSFER_UNIT%>">
                  ...
                  <td height="18" valign="top" colspan="3">
                    <table width="52%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <%}%>
                        ...
                        <td nowrap width="1%">&nbsp;</td>
                        <td class="command" nowrap width="48%"></td>
                      </tr>
                    </table>
                  </td>
                </tr>
