...
public String drawListMaterial(int language,Vector objectClass, Vector vectDf, int start, int tranUsedPriceHpp, int typeOfBusinessDetail) {
    String result = "";
...
if(vect.size() == 1 && typeOfBusinessDetail != 2) {
    ...
    <script language="JavaScript">
        <% if(oidDfItem == 0) { %>
            ...
            self.opener.document.forms.frm_matdispatch.<%=FrmMatDispatchReceiveItem.fieldNames[FrmMatDispatchReceiveItem.FRM_FIELD_COST_TARGET]%>.value = "<%=FRMHandler.userFormatStringDecimal(material.getAveragePrice())%>";
...
function cmdEdit(matOid,matCode1,matItem1,matUnit1,matHpp1,matUnitId1,oidDfItem,avblQty1){
    if(oidDfItem==0){
        ...
        self.opener.document.forms.frm_matdispatch.<%=FrmMatDispatchReceiveItem.fieldNames[FrmMatDispatchReceiveItem.FRM_FIELD_COST_TARGET]%>.value = matHpp1;
            ...
            <form name="frmvendorsearch" method="post" action="">
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="1">
               <tr>
                  ...
                  --%>
                  <select  name="txt_materialgroup1" class="formElemen">
                ...
                <tr>
                  ...
                  <td width="82%">
                    <input type="text" onKeyDown="javascript:keyDownCheck(event)" name="txt_materialname1" size="30" value="<%=materialname%>" class="formElemen" id="txt_materialname" >
                  </td>
                </tr>
                <tr>
                  <td width="18%">&nbsp;</td>
                ...
                <tr>
                  <td colspan="2"><%=drawListMaterial(SESS_LANGUAGE,vect,vectCos,start,tranUsedPriceHpp, typeOfBusinessDetail)%></td>
                </tr>
                <tr>
