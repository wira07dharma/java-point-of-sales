...
function printForm()
{
    ...
    window.open("df_stock_wh_material_print_form.jsp?hidden_dispatch_id=<%=oidDispatchMaterial%>&command=<%=Command.EDIT%>&type_print_tranfer="+typePrint+"","pireport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}
                        ...
                        <td height="22" valign="middle" colspan="3">
                          ...
                          <table width="50%" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                              ...
                              <td width="94%"><a href="javascript:addItemReceive()"><%=ctrLine.getCommand(SESS_LANGUAGE,dfCode+" Item Receive",ctrLine.CMD_ADD,true)%></a></td>
                              <% } %>
                            </tr>
                          </table>
                            <%}%>
