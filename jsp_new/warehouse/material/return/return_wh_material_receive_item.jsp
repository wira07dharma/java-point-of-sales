...
public static final String textListGlobal[][] = {
    {"Tambah Item","Dari Penerimaan","Ke Retur","Daftar","Item","Penerimaan"},
    {"Add Item", "From Receive","For Return","List","Item","Receive"}
};
...
oidReceiveMaterial = ret.getReceiveMaterialId();
...
String whereClauseItem = ""+PstMatReceive.fieldNames[PstMatReceive.FLD_RECEIVE_MATERIAL_ID]+"='"+oidReceiveMaterial+"'";
...
/*int recordToGetItem = 30;
String whereClause = PstMatReceive.fieldNames[PstMatReceive.FLD_INVOICE_SUPPLIER]+"='"+invoiceSupplier+"'";
...
String orderClauseItem = " RMI."+PstMatReceiveItem.fieldNames[PstMatReceiveItem.FLD_RECEIVE_MATERIAL_ITEM_ID];
int vectSizeItem = PstMatReceiveItem.getCount(whereClause);
Vector listMatReceiveItem = new Vector();
listMatReceiveItem = PstMatReceiveItem.listVectorRecItemComplete(startItem,recordToGetItem,whereClause, orderClauseItem);*/
...
//}
//Vector vect = PstMatReceiveItem.list(startItem, recordToGetItem, whereClause); //PstMaterial.getListMaterialItem(0,objMaterial,start,recordToGet, orderBy);
...
function cmdBack() {
    ...
    document.frm_recmaterial.prev_command.value="<%=prevCommand%>";
    document.frm_recmaterial.action="return_wh_material_edit.jsp";
    document.frm_recmaterial.submit();
}
        ...
        <tr>
          <td><!-- #BeginEditable "content" -->
            ...
            %>
              ...
              <input type="hidden" name="hidden_return_id" value="<%=ret%>">
			  ...
			  %>
                ...
                <tr>
                  <td colspan="3">
                    <table width="100%" border="0">
                      <tr>
                          <td nowrap width="6%"><a href="javascript:addToRetur()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnNewOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnNewOn.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,textListGlobal[SESS_LANGUAGE][4],ctrLine.CMD_ADD,true)%>"></a></td>
                              <td class="command" width="20%"><a href="javascript:addToRetur()"><%=ctrLine.getCommand(SESS_LANGUAGE,textListGlobal[SESS_LANGUAGE][4],ctrLine.CMD_ADD,true)%></a></td>
