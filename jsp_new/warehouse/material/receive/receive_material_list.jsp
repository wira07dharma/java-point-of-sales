                  ...
                  <td height="18" valign="top" colspan="3"> 
                    <table width="80%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<td class="command" nowrap width="31%"><a href="javascript:cmdAddPO()"><%=ctrLine.getCommand(SESS_LANGUAGE,textListGlobal[SESS_LANGUAGE][0]+" "+textListGlobal[SESS_LANGUAGE][5],ctrLine.CMD_ADD,true)%></a></td>
						<td nowrap width="4%"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image100" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,textListGlobal[SESS_LANGUAGE][0]+" "+textListGlobal[SESS_LANGUAGE][6],ctrLine.CMD_ADD,true)%>"></a></td>
						<td class="command" nowrap width="31%"><a href="javascript:cmdAdd()"><%=ctrLine.getCommand(SESS_LANGUAGE,textListGlobal[SESS_LANGUAGE][0]+" "+textListGlobal[SESS_LANGUAGE][6],ctrLine.CMD_ADD,true)%></a></td>
						<%}%>
                      </tr>
                    </table>
                  </td>
