<%-- 
    Document   : src_receive_material_buyback
    Created on : Jun 12, 2018, 5:03:59 PM
    Author     : dimata005
--%>
...
public static final String textListGlobal[][] = {
	{"Penerimaan","Dari Buyback","Pencarian","Daftar","Edit","Dengan PO","Buyback","Tidak ada data penerimaan barang", "Consignment Sold"},
	{"Receive","From Purchase","Search","List","Edit","With PO","Buyback","Receiving goods not found", "Consigment Sold"}
};
...
srcMatReceive.setReceiveSource(PstMatReceive.SOURCE_FROM_BUYBACK);
        ...
        <tr> 
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_recmaterial" method="post" action="">
              ...
              <input type="hidden" name="<%=frmSrcMatReceive.fieldNames[frmSrcMatReceive.FRM_FIELD_RECEIVE_SOURCE]%>" value="<%=PstMatReceive.SOURCE_FROM_BUYBACK%>">
         ...
         <tr align="left" valign="top">
          <td height="18" valign="top" colspan="3"> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                    <td class="command" nowrap width="14%"><a class="btn-primary btn-lg" href="javascript:cmdSearch()"><i class="fa fa-search"> &nbsp;<%=ctrLine.getCommand(SESS_LANGUAGE,textListGlobal[SESS_LANGUAGE][0],ctrLine.CMD_SEARCH,true)%></i></a></td>
                    <% if(privAdd){%>
                        <td class="command" nowrap width="20%"><a class="btn-primary btn-lg" href="javascript:cmdAdd()"><i class="fa fa-plus-circle"> &nbsp;<%=ctrLine.getCommand(SESS_LANGUAGE,textListGlobal[SESS_LANGUAGE][0]+" "+textListGlobal[SESS_LANGUAGE][6],ctrLine.CMD_ADD,true)%></i></a></td>
                    <%}%>
              </tr>
            </table>
          </td>
