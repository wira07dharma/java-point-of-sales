<%-- 
    Document   : search_receive_return_material
    Created on : 20 Jul 20, 13:41:00
    Author     : gndiw
--%>
            ...
            <div class="col-md-12">
              <div id="receiveTableElement">
                <table id="listReceive" class="table table-striped table-bordered table-responsive" style="font-size: 14px">
                    ...
                    <tbody>
                    <%
                        whereClause = " REC." + PstMatReceive.fieldNames[PstMatReceive.FLD_RECEIVE_MATERIAL_ID]+" <> 0 AND REC."+PstMatReceive.fieldNames[PstMatReceive.FLD_RECEIVE_SOURCE]+" IN ("+PstMatReceive.SOURCE_FROM_RETURN+")";
                        if(oidLocation > 0){
