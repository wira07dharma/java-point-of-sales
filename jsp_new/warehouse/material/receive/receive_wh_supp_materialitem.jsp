...
<%!    static String sEnableExpiredDate = PstSystemProperty.getValueByName("ENABLE_EXPIRED_DATE");
    ...
    public static final String textListOrderItem[][] = {
        {"No", "Sku", "Nama Barang", "Kadaluarsa", "Unit", "Harga Beli", "Ongkos Kirim", "Mata Uang", "Qty", "Total Beli", "Diskon Terakhir %",//10
            ...
            "Warna", "Etalase", "Harga Jual", "Harga Pokok"},//19
        {"No", "Code", "Name", "Expired Date", "Unit", "Cost", "Delivery Cost", "Currency", "Qty", "Total Cost", "last Discount %",
            ...
            "Color", "Etalase", "Selling Price", "Cost of Goods Sold"}
    };
    ...
    public Vector drawListRetItem(int language, int iCommand, FrmMatReceiveItem frmObject,
            ...
            int recType, String syspropTotalBeli, long locationId, String syspropAutoSave, String syspropHargaJual, String syspropKeterangan, String syspropPenerimaanHpp, String useForRaditya) {
        ...
        if (typeOfBusinessDetail != 2) {
            ctrlist.addHeader(textListOrderItem[language][5], "5%");//qty entry
        ...
        if (privShowQtyPrice) {
            ...
            if (useForRaditya.equals("1")) {
                ...
                if (syspropPenerimaanHpp.equals("1")) {
                    ctrlist.addHeader(textListOrderItem[language][24], "9%"); //Harga Pokok
                }
            }
        ...
        if (useForRaditya.equals("1")) {
            ...
            if (syspropHargaJual.equals("1")) {
                ctrlist.addHeader(textListOrderItem[language][23], "7%");//harga jual
            }
        }
        if (syspropEtalase.equals("1")) {
            ctrlist.addHeader(textListOrderItem[language][22], "7%");//etalase
        }
        if (syspropColor.equals("1")) {
            ctrlist.addHeader(textListOrderItem[language][21], "5%");//color
        }
        if (syspropKeterangan.equals("1")) {
            ctrlist.addHeader(textListOrderItem[language][19], "7%");//keterangan
        } else {
        }
        if (typeOfBusinessDetail == 2 && recSource == PstMatReceive.SOURCE_FROM_BUYBACK || useForRaditya.equals("1")) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            sellPrice = PstPriceTypeMapping.getSellPrice(recItem.getMaterialId(), PstPriceTypeMapping.getOidStandartRate(), PstPriceTypeMapping.getOidPriceType());
...
//update opie-eyek 20130812
                ...
                if (typeOfBusinessDetail != 2) {
                    rowx.add("<div align=\"right\"><input type=\"text\" size=\"15\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_COST] + "\" value=\"" + FRMHandler.userFormatStringDecimal(recItem.getCost()) + "\" class=\"\" onkeyup=\"javascript:cntTotal2()\"></div>"
                            + "<input type=\"hidden\" size=\"15\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_TOTAL] + "\" value=\"" + FRMHandler.userFormatStringDecimal(recItem.getTotal()) + "\">"); // <a href=\"javascript:cmdCheck()\">CHK</a>
                ...
                if (useForRaditya.equals("1")) {
                    ...
                    if (syspropHargaJual.equals("1")) {
                        rowx.add("<div align=\"center\"><input type=\"text\" size=\"5\" name=\"\" value=\"\" class=\"formElemen\"></div>");
                    }
                }
                if (syspropEtalase.equals("1")) {
                ...
                if (useForRaditya.equals("1")) {
                    ...
                    if (syspropHargaJual.equals("1")) {
                        rowx.add("<div align=\"center\">" + sellPrice + "</div>");
                    }
                }
                if (syspropEtalase.equals("1")) {
        ...
        if (readOnlyQty == "readonly") {
            ...
            if (iCommand == Command.ADD || (iCommand == Command.SAVE && frmObject.errorSize() > 0)) {
                ...
                if (useForRaditya.equals("0")) {
                    ...
                    rowx.add("<input type=\"hidden\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_MATERIAL_ID] + "\" value=\"" + ""
                            + "\"><input type=\"text\" id='barcode' size=\"15\" name=\"matCode\" value=\"" + "" + "\" class=\"formElemen\" " + (!syspropAutoSave.equals("1") ? "onKeyDown=\"javascript:keyDownCheck(event)\"" : "") + "> <a href=\"javascript:cmdCheck()\">CHK</a>"); // <a href=\"javascript:cmdCheck()\">CHK</a>
                }
                ...
                //add opie-eyek 20140108 untuk konversi satuan
                if (typeOfBusinessDetail != 2) {
                    rowx.add("<div align=\"right\"><input type=\"text\" size=\"15\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_COST] + "\" value=\"" + "" + "\" class=\"\" onkeyup=\"javascript:cntTotal2()\" ></div>"
                            //+ "<div align=\"right\"><input type=\"hidden\" size=\"10\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_TOTAL] + "\" value=\"" + "" + "\" " + read + " onKeyUp=\"javascript:cntTotal3(this, event)\">"
                            + "<input type=\"hidden\" size=\"15\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_TOTAL] + "\" value=\"" + "" + "\" class=\"hiddenText\" readOnly></div>"); // <a href=\"javascript:cmdCheck()\">CHK</a>
                ...
                if (privShowQtyPrice) {
                    ...
                    if (useForRaditya.equals("1")) {
                        ...
                        if (syspropPenerimaanHpp.equals("1")) {
                            rowx.add("<div align=\"right\"><input type=\"text\" size=\"15\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_COST] + "\" value=\"" + "" + "\" class=\"\" readOnly></div>");
                        }
                    }
                    if (syspropDiscount1.equals("1")) {
                    ...
                    if (useForRaditya.equals("1")) {
                        ...
                        if (syspropTotalBeli.equals("1") || syspropTotalBeli.equals("2") || syspropTotalBeli.equals("3")) {
                            if (syspropTotalBeli.equals("1") || syspropTotalBeli.equals(String.valueOf(recType))) {
                                rowx.add("<div align=\"right\"><input type=\"text\" size=\"10\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_COST] + "\" value=\"" + "" + "\" " + read + " onKeyUp=\"javascript:cntTotal3(this, event)\">"
                    ...
                    rowx.add("<div align=\"right\"><input type=\"hidden\" size=\"15\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_COST] + "\" value=\"" + "" + "\" " + read + " onKeyUp=\"javascript:cntTotal3(this, event)\">"
                            + "<input type=\"hidden\" size=\"15\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_TOTAL] + "\" value=\"" + "" + "\" class=\"hiddenText\" readOnly></div>");
                    if (syspropBonus.equals("1")) {
                        rowx.add("<div align=\"left\"><input type=\"hidden\"  name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_BONUS] + "\" value=\"0\"> <input type=\"checkbox\"  name=\"typeBonus\" value=\"1\" onClick=\"javascript:checkBonus()\" >Bonus</div>");
                    }
                ...
                if (useForRaditya.equals("1")) {
                    ...
                    if (syspropHargaJual.equals("1")) {
                        rowx.add("<div align=\"center\"><input type=\"text\" size=\"5\" name=\"\" value=\" " + sellPrice + " \" class=\"formElemen\"></div>");
                    }
                }
                if (syspropEtalase.equals("1")) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (index == i && (iCommand == Command.EDIT || iCommand == Command.ASK)) {
                ...
                if (privShowQtyPrice) {
                    ...
                    if (syspropPenerimaanHpp.equals("1")) {
                        rowx.add("<div align=\"right\"><input type=\"text\" size=\"15\" name=\"harga_pokok\" value=\"" + FRMHandler.userFormatStringDecimal(mat.getAveragePrice()) + "\" class=\"hiddenText\" readOnly></div>");
                    }
                } else {
                    rowx.add("<div align=\"right\"><input type=\"text\" size=\"5\" name=\"" + frmObject.fieldNames[frmObject.FRM_FIELD_QTY] + "\" value=\"" + FRMHandler.userFormatStringDecimal(recItem.getQty()) + "\" class=\"formElemen\" onKeyUp=\"javascript:cntTotal(this, event)\" style=\"text-align:right\"></div>"
                ...
                if (syspropPenerimaanHpp.equals("1")) {
                    rowx.add("<div align=\"right\"><input type=\"text\" size=\"15\" name=\"harga_poko        value=\"" + FRMHandler.userFormatStringDecimal(mat.getAveragePrice()) + "\" cl        \"hiddenText\" readOnly></div>");
                }

                //         by fitra         5-2014
                rowx.add(" <div align=\"center\"> <a href=\"javascript:c        wDelete('" + String.valueOf(recItem.getOID()) + "')\"><img src=" + approot + "/        es/x3.png align=\"center\" ></a></div>");
...
<%
    ...
    /**
     * process insert mapping master type
     */
    int masterGroupSize = FRMQueryString.requestInt(request, "groupSize");
    if (masterGroupSize > 0 && iCommand == Command.SAVE) {
        String sql = " DELETE FROM " + PstMaterialMappingType.TBL_MATERIAL_TYPE_MAPPING + " WHERE " + PstMaterialMappingType.fieldNames[PstMaterialMappingType.FLD_MATERIAL_ID] + " = " + recItem.getOID();
        ...
        for (int i = 0; i < masterGroupSize; i++) {
            ...
            map.setMaterialId(recItem.getOID());
...
<html><!-- #BeginTemplate "/Templates/main.dwt" --><!-- DW6 -->
    <head>
        ...
        <script language="JavaScript">
            document.txt_materialname.focus();
        </script>
        <style>
            select#FRM_FIELD_COLOR_ID {
                width: 150px !important;
            }
            select#MASTER_GROUP1 {
                                            ...
                                            <td colspan="3" class="title">
                                                <table width="100%" border="0" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=totalTitle%></td>
                                                        <td>:</td>
                                                        <td><input type="text" size="15" readonly="" class="hiddenText" name="<%=FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_TOTAL_HE]%>" value="<%=String.format("%,.0f", rec.getTotalHe())%>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td></td>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input type="text" size="15" readonly="" class="hiddenText" name="<%=FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_TOTAL_NOTA]%>" value="<%=String.format("%,.0f", rec.getTotalNota())%>">
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                                </table>
