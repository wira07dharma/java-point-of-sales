...
//function cmdEdit(poOid, poCode, currcode, currOid, poStatus, supplierId, ppn, locationId, includePpn) {
function cmdEdit(poOid, poCode, currcode, currOid, poStatus, supplierId, ppn, locationId) {
	if(poStatus != <%=I_DocStatus.DOCUMENT_STATUS_POSTED%>) {
		...
		self.opener.document.forms.frm_recmaterial.<%=FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_CURRENCY_ID]%>.value = 7;
