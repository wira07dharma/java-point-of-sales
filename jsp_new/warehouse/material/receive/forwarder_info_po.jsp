                  ...
                  <td colspan="3">
                    <table width="100%" border="0" cellpadding="1">
                      <tr>
                        ...
                        <td width="17%" rowspan="4" valign="top">                       <textarea name="<%=FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_REMARK]%>" class="formElemen" wrap="VIRTUAL" rows="2"><%=rec.getRemark()%></textarea>
                      </tr>
                      <tr>
                        ...
                        <td width="24%" align="left">:
						  ...
						  %>
                          <%=ControlCombo.draw(FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_LOCATION_ID], null, select_locationid, val_locationid, key_locationid, "", "formElemen")%> </td>
                        ...
                        <td>:
                          ...
                          <%if(listMatReceiveItem.size()==0){%><a href="javascript:cmdSelectPO()">CHK</a><%}%></td>
                        <td align="right">                        </tr>
                      <tr>
                        ...
                        <td>:
                          <input type="text"  class="formElemen" name="<%=FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_INVOICE_SUPPLIER]%>" value="<%=rec.getInvoiceSupplier()%>"  size="20" style="text-align:right"></td>
                        <td align="right">                        </tr>
                      <tr>
                        ...
                        <td valign="bottom"><%=textListOrderHeader[SESS_LANGUAGE][11]%></td>
                        <td>:
                            <%
                      ...
                      <tr>
						...
						%>
						<%=ControlCombo.draw(FrmMatReceive.fieldNames[FrmMatReceive.FRM_FIELD_RECEIVE_STATUS],null,select_status,val_status,key_status,"","formElemen")%> </td>
						<% } %>
                        <td valign="bottom">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td align="right">                      
