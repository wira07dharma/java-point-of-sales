...
public static final String textListPrintHeader[][]= {
    {"LAPORAN TRANSFER BARANG"," s/d ","Lokasi Asal","Lokasi Tujuan","Mengetahui","Pengirim","Penerima","Semua Lokasi"},
    {"GOODS DISPATCH REPORT"," to ","SOURCE","DESTINATION","Check by","Send by","Receive by","All Location"}
};
%>
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      Location lokasi = new Location();
                        ...
                        %>
                      <tr> 
                        <td class="listgensell" valign="middle" width="10%" ><%=textListPrintHeader[SESS_LANGUAGE][2]%></td>
                        <td class="listgensell" valign="middle" width="1%">:</td>
                        <td class="listgensell" valign="middle" width="93%"><b><%=lokasi.getName().toUpperCase()%></b></td>
                      </tr>
                      <tr> 
                        <td width="10%" class="listgensell" valign="middle" > <%=textListPrintHeader[SESS_LANGUAGE][3]%></td>
                        <td width="1%" class="listgensell" valign="middle"> : 
                        </td>
                        <td width="93%" class="listgensell" valign="middle"> <b><%=loc1.getName().toUpperCase()%> </b> </td>
                      </tr>
                    </table>
                  </td>
              </table>
