...
public Vector drawList(int language,Vector objectClass, Vector vLovation,int start,Vector vectLocWh){
	...
	if(objectClass!=null && objectClass.size()>0){
        ...
        ctrlist.dataFormat(textListMaterialHeader[language][3],""+(5*vLovation.size())+"%","1",""+(vLovation.size()+1)+"","center","center");
        ctrlist.dataFormat(textListMaterialHeader[language][4],""+(5*vLovation.size())+"%","1",""+(vLovation.size()+1)+"","center","center");
        ctrlist.dataFormat(textListMaterialHeader[language][7],""+(5*vectLocWh.size())+"%","1",""+(vectLocWh.size()+1)+"","center","center");
                        ...
                        <td width="30%">
                          <table width="55%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td class="command" nowrap width="92%"><a class="btn-primary btn-lg" href="javascript:cmdBack()"><i class="fa fa-search"> &nbsp;<%=ctrLine.getCommand(SESS_LANGUAGE,"Stock Report",ctrLine.CMD_BACK_SEARCH,true)%></i></a></td>
                            </tr>
                          </table>
                        </td>
                        <td width="70%">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <%if(typeRequest==0){%>
                                <td width="80%" align="right" nowrap><a class="btn-primary btn-lg" href="javascript:createtransfer()"><i class="fa next"> &nbsp; <%if(records.size()>0){%>Next Process Transfer Stock<%}%></i></a></td>
                                <td width="20%" align="right" nowrap><a class="btn-primary btn-lg" href="javascript:createpo()" class="command" ><i class="fa next"> &nbsp; <%if(records.size()>0){%>Next Proses PO<%}%></i></a></td>
                              <%}else{%>
                                <td width="80%" align="right" nowrap><a class="btn-primary btn-lg" href="javascript:createpr()"><i class="fa next"> &nbsp; <%if(records.size()>0){%>Next Proses PR<%}%></i></a></td>
