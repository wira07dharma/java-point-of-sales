...
try{
	session.removeValue("SESS_REKAP_PER_SUPPLIER");
}
catch(Exception e){
}
...
val_supplier.add("0");
key_supplier.add(listTextTitle[SESS_LANGUAGE][6]+" "+listTextTitle[SESS_LANGUAGE][4]);
...
String select_supplier = ""+srcReportDispatch.getSupplierId();
...
function cmdSearch() {
	...
	document.frmsrcdispatchreport.action="reportdispatchsupplier_list.jsp";
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      ...
                      <tr> 
                        <td valign="top" align="left"><strong><%=listTextTitle[SESS_LANGUAGE][4]%></strong></td>
                        <td valign="top" align="left"><strong>:</strong></td>
                        <td valign="top" align="left">&nbsp;<%=ControlCombo.draw(FrmSrcReportDispatch.fieldNames[FrmSrcReportDispatch.FRM_FIELD_SUPPLIER_ID],null,select_supplier,val_supplier,key_supplier,"","formElemen")%> </td>
                      </tr>
                      <tr> 
