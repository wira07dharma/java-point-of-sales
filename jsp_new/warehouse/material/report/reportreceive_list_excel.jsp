<%-- 
    Document   : reportreceive_list_excel
    Created on : May 4, 2016, 9:28:09 AM
    Author     : dimata005
--%>
<%@ page language = "java" %>
<!-- package java -->
...
response.setHeader("Content-Disposition","attachment; filename=" + "reportreceive_list_excel.xls" ); 
%>
<!-- End of Jsp Block -->
          ...
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportsale" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top"> 
                  <td><strong><%=textListGlobal[SESS_LANGUAGE][5]%>: <%=contactList.getCompName().toUpperCase()%></strong>
				  </td>
				  <td colspan="2"><strong></strong></td>
                </tr>
				<tr align="left" valign="top"> 
