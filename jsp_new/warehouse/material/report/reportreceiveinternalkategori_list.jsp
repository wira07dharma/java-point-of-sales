...
function cmdListFirst(){
	...
	document.frm_reportsale.action="reportreceiveinternalkategori_list.jsp";
...
function cmdBack(){
	...
	document.frm_reportsale.action="src_reportreceiveinternalkategori.jsp";
	document.frm_reportsale.submit();
}

function printForm(){
	//window.open("reportreceiveinternalkategori_form_print.jsp","receivekategorireport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
	window.open("buff_pdf_report_receive_internal_ctg.jsp", "RECEIVE_INTERNAL_CATEGORY_REPORT_PDF");
}
            ...
            <form name="frm_reportsale" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
				...
				<tr align="left" valign="top"> 
				  ...
				  <td class="command"><strong>:</strong></td>
				  <td class="command"><%=category.getName().toUpperCase()%></td>
                </tr>
                <tr align="left" valign="top"> 
