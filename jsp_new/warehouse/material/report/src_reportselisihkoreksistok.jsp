...
public static final String textListHeader[][] = {
	{"Lokasi","Supplier","Kategori","Sub Kategori","Periode","Semua tanggal"," s/d ",
		"Urut Berdasarkan","Status","Semua","Supplier","Group By"},
	{"Location Name","Supplier","Kategori","Sub Kategori","Period","All Date"," to ",
		"Sort by","Status","All","Vendor","Group By"}	
};
...
function cmdSearch(){
	...
	document.frmsrcmatstockcorrection.action="report_list_lost_correction_stock.jsp";
          ...
          <td><!-- #BeginEditable "content" --> 
            <form name="frmsrcmatstockcorrection" method="post" action="">
              ...
              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                ...
                <tr>
                        <td height="21" width="13%"> <strong><%=textListHeader[SESS_LANGUAGE][10]%> </strong></td>
                        <td height="21" width="1%" valign="top" align="left"><strong>:</strong></td>
                        <td height="21" width="86%" valign="top" align="left">
                        <%
                         ...
                         %> 
                        <%=ControlCombo.draw(frmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_SUPPLIER_ID], null, ""+srcMatStockOpname.getSupplierId(), val_supplier, key_supplier, "", "formElemen")%>
                        </td>
                </tr>
                <tr>
                ...
                <tr>
                        ...
                        <%
                          ...
                          for(int i=0; i<vectResult.size(); i++) {
                              if ((i == I_DocStatus.DOCUMENT_STATUS_DRAFT) || (i == I_DocStatus.DOCUMENT_STATUS_POSTED) || (i == I_DocStatus.DOCUMENT_STATUS_CLOSED) || (i == I_DocStatus.DOCUMENT_STATUS_FINAL))	{
                                  ...
                                  %>
                                  <input type="checkbox" class="formElemen" name="<%=FrmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_STATUS]%>" value="<%=(indexPrStatus)%>" <%if(getTruedFalse(srcMatStockOpname.getDocStatus(),indexPrStatus)){%>checked<%}%> onKeyDown="">
                                  <%=strPrStatus%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <%
                              }
                          }
                 ...
                 <tr>
                        <td height="21" width="13%"> <strong><%=textListHeader[SESS_LANGUAGE][11]%> </strong></td>
                        <td height="21" width="1%" valign="top" align="left"><strong>:</strong></td>
                        <td height="21" width="86%" valign="top" align="left">
                        <%
                        ...
                        %> 
                        <%=ControlCombo.draw(frmSrcMatStockOpname.fieldNames[FrmSrcMatStockOpname.FRM_FIELD_GROUP_BY], null, ""+srcMatStockOpname.getGroupBy(), val_groupby, key_groupby, "", "formElemen")%>
                        </td>
                </tr>
                <tr> 
