<%-- 
    Document   : src_reportstockmin_transfer
    Created on : Dec 8, 2015, 2:52:54 PM
    Author     : dimata005
--%>
...
function cmdSearch(){
	...
	document.frmsrcstockcard.action="reportstockmin_transfer_list.jsp";
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">  
        <tr> 
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->
            Create Transfer Dari Minimum Stok <!-- #EndEditable --></td>
        </tr>
        <tr> 
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td height="21" width="90%">&nbsp;
                          ...
                          <%=controlRadio.draw(frmSrcMinimumStock.fieldNames[frmSrcMinimumStock.FRM_FIELD_LOCATION_ID],val_locationid,key_locationid,new Vector())%>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td height="21" width="90%" valign="top" align="left">
                          <table width="40%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <!--td width="7%" nowrap><a href="javascript:cmdSearch()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE,"Sale Report",ctrLine.CMD_SEARCH,true)%>"></a></td-->
                              <td width="93%" nowrap class="command"><a class="btn btn-primary" href="javascript:cmdSearch()"><i class="fa fa-search"></i> <%=ctrLine.getCommand(SESS_LANGUAGE,"Stock Report",ctrLine.CMD_SEARCH,true)%></a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
