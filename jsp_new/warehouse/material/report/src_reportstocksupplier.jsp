...
public static final String textListGlobal[][] = {
	{"Stok","Laporan","Per Suplier","Pencarian","Tidak ada data","Laporan Stok","Cetak Laporan Stok per Suplier"},
	{"Stock","Report","By Supplier","Searching","No data available","Stock Report","Print Stock Report by Supplier"}
};
...
/** get period list */
Vector materPeriode = PstPeriode.list(0,0,"",""); //PstPeriode.fieldNames[PstPeriode.FLD_STATUS] + " <> " + PstPeriode.FLD_STATUS_CLOSED,"");
                  ...
                  <td colspan="2">
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr> 
                        ...
                        <td height="21" width="90%" valign="top" align="left"><%=(ControlCombo.draw(frmSrcReportStock.fieldNames[frmSrcReportStock.FRM_FIELD_PERIODE_ID],"formElemen", null, ""+srcReportStock.getPeriodeId(), vectmatPerKey, vectmatPerVal, null))%></td>
                      </tr>
                      <tr>
                      ...
                      <tr> 
                        ...
                        <td height="19" width="90%" valign="top" align="left"><%=ControlCombo.draw(frmSrcReportStock.fieldNames[frmSrcReportStock.FRM_FIELD_SUPPLIER_ID],null,select_supplier,val_supplier,key_supplier,"","formElemen")%></td>
                      </tr>
