...
public String drawList(JspWriter outObj, int language, Vector objectClass, int start, int brandInUse, long locationId, Vector listTypeHrga, int typeOfBusinessDetail) {
    String result ="";
    if(objectClass!=null && objectClass.size()>0) {
        ...
        if(typeOfBusinessDetail == 2){
            ctrlist.addHeader("Berat","10%");//berat
        } else {
        ...
        ctrlist.addHeader(textListMaterialHeader[language][8],"10%");//nilai stok
...
response.setHeader("Content-Disposition","attachment; filename=" + "report_stok_global.xls" ); 
%>
<!-- End of Jsp Block -->
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">  
        ...
        <tr> 
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportstock" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top">
                  <td width="10%" height="20" valign="middle" class="command"><%=(textListGlobal[SESS_LANGUAGE][2]).toUpperCase()%> : <%=periode.getPeriodeName().toUpperCase() %> ( <%= periode.getStartDate()%> - <%= periode.getEndDate()%> )</td>
		  ...
		  <td width="89%" height="20" valign="middle" class="command"></td>
                ...
                <tr align="left" valign="top"> 
                  <td height="22" align="center" valign="middle" colspan="3"><%=drawList(out,SESS_LANGUAGE, listStockAll, start,brandInUse,srcReportStock.getLocationId(), listTypeHrga, typeOfBusinessDetail)%></td>
                </tr>
              </table>
            </form>
            <!-- #EndEditable --></td> 
