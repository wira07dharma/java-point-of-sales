...
public static final String textListGlobal[][] = {
	{"Penerimaan","Dari Pembelian","Laporan Per Suplier","Pencarian","Laporan Penerimaan"},
	{"Receive","From Purchase","Report By Supplier","Search","Receive Report"}
};

/* this constant used to list text of listHeader */
public static final String textListHeader[][] = 
{
	{"Lokasi","Supplier","Kategori","Periode","Urut Berdasar","Sub Kategori"," s/d ","Semua Lokasi","Semua Supplier"},
	{"Location","Supplier","Category","Period","Sort By","Sub Category"," to ","All Location","All Supplier"}
};
                  ...
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      ...
                      <tr> 
                        ...
                        <td height="21" width="90%"><%=ControlCombo.draw(frmSrcReportReceive.fieldNames[frmSrcReportReceive.FRM_FIELD_SUPPLIER_ID],null,select_supplier,val_supplier,key_supplier,"","formElemen")%> </td>
                      </tr>
                      <tr> 
