...
function cmdSearch() {
	...
	document.frmsrcdispatchreport.action="reportdispatchkategori_list.jsp";
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      ...
                      <tr> 
                        <td valign="top" align="left"><strong><%=listTextTitle[SESS_LANGUAGE][5]%></strong></td>
                        <td valign="top" align="left"><strong>:</strong></td>
                        <td valign="top" align="left">&nbsp;<%=ControlCombo.draw(frmSrcReportDispatch.fieldNames[frmSrcReportDispatch.FRM_FIELD_CATEGORY_ID],"formElemen", null, ""+srcReportDispatch.getCategoryId(), vectGroupKey, vectGroupVal, null)%></td>
                      </tr>
                      <tr> 
