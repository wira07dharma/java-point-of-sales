...
public static final String textListGlobal[][] = {
	{"LAPORAN STOK PER KATEGORI", "Periode", "Lokasi", "Kategori", "Suplier", "Semua"},
	{"STOCK REPORT BY CATEGORY", "Period", "Location", "Category", "Supplier", "All"}
};
...
headerPdf.add(8, (textListGlobal[SESS_LANGUAGE][3]).toUpperCase()); //category
