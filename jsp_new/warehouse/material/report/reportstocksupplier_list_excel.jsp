...
response.setHeader("Content-Disposition","attachment; filename=" + "report_stok_per_supplier.xsl" ); 
%> 
<!-- End of Jsp Block -->
          ...
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportstock" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top">
                  <td width="10%" height="14" valign="middle" class="command"><b><%=(textListGlobal[SESS_LANGUAGE][2]).toUpperCase()%>:<%=periode.getPeriodeName().toUpperCase()%></b></td>
				  <td width="1%" height="14" valign="middle" class="command"></td>
				  <td width="89%" height="14" valign="middle" class="command"></td>
                </tr>
                <tr align="left" valign="top">
                  <td width="10%" height="14" valign="middle" class="command"><b><%=(textListGlobal[SESS_LANGUAGE][3]).toUpperCase()%>:<%=location.getName().toUpperCase()%></b></td>
				  <td width="1%" height="14" valign="middle" class="command"></td>
				  <td width="89%" height="14" valign="middle" class="command"></td>
                </tr>
                <tr align="left" valign="top">
                  <td width="10%" height="14" valign="middle" class="command"><b><%=(textListGlobal[SESS_LANGUAGE][4]).toUpperCase()%>:<%=contactList.getCompName().toUpperCase()%></b></td>
				  <td width="1%" height="14" valign="middle" class="command"></td>
				  <td width="89%" height="14" valign="middle" class="command"></td>
                </tr>
                <tr align="left" valign="top"> 
