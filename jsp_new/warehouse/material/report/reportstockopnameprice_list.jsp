...
{
	{"No","Tanggal","SKU","Nama","Harga Jual","Qty Opn","Qty Jual","Qty Sys","Selisih","Total Lost"},
...
public String drawList(int language,Vector objectClass, boolean isCategory,
						boolean isSubCategory, boolean isSupplier)
{
	...
	if(objectClass!=null && objectClass.size()>0) {	
		...
		ctrlist.addHeader(textListMaterialHeader[language][4],"25%");
		ctrlist.addHeader(textListMaterialHeader[language][5],"7%");
		ctrlist.addHeader(textListMaterialHeader[language][6],"40%");
                ctrlist.addHeader(textListMaterialHeader[language][7],"40%");
                ctrlist.addHeader(textListMaterialHeader[language][8],"40%");
		ctrlist.addHeader("","40%");
                ctrlist.addHeader(textListMaterialHeader[language][9],"40%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			lstData.add(rowx);
			lstLinkData.add(String.valueOf(soi.getOID()));
		}
		result = ctrlist.draw();
	}
	else {
		result = "<div class=\"msginfo\">&nbsp;&nbsp;no result</div>";
	}
	return result;	
...
function cmdListFirst()
{
	...
	document.frm_reportstockopname.action="reportstockopnameprice_list.jsp";
...
function printForm(){
	window.open("reportstockopnameprice_form_print.jsp","stockreport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}
			...
			%>
				...
				<%
					...
					report.add(srcReportStockOpname);
                                        out.println(drawList(SESS_LANGUAGE,records,isCategory,isSubCategory,isSupplier));
					//report.add(hasil1);
