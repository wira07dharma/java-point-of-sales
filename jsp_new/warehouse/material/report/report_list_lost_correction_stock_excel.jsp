...
response.setHeader("Content-Disposition","attachment; filename=" + "report_list_lost_correction_stock_excel.xls" ); 
%>
<!-- End of Jsp Block -->
          ...
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportstock" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top">
                  <td width="20%" height="14" valign="middle" class="command"><b><%=(textListGlobal[SESS_LANGUAGE][2]).toUpperCase()%>:<%=location.getName().toUpperCase()%></b></td>
                  
                </tr>
                <tr align="left" valign="top">
                    <td width="20%" height="14" valign="middle" class="command"><b><%=(textListGlobal[SESS_LANGUAGE][6]).toUpperCase()%>:<%=Formater.formatDate(srcMatStockOpname.getFromDate(), "dd-MM-yyyy")%> <%=textListGlobal[SESS_LANGUAGE][7]%> <%=Formater.formatDate(srcMatStockOpname.getToDate(), "dd-MM-yyyy")%></b> </td>
                      
                </tr>
                <tr align="left" valign="top">
                  <td width="20%" height="14" valign="middle" class="command"><b><%=(textListOrderItem[SESS_LANGUAGE][4]).toUpperCase()%>:<%=category.getName().toUpperCase()%></b></td>
                </tr>
                <tr align="left" valign="top">
                  <td width="20%" height="14" valign="middle" class="command"><b><%=(textListOrderItem[SESS_LANGUAGE][15]).toUpperCase()%>:<%=contact.getCompName().toUpperCase()%></b></td>

                </tr>
                <tr align="left" valign="top">
                  <td width="20%" height="14" valign="middle" class="command"><b><%=(textListOrderItem[SESS_LANGUAGE][16]).toUpperCase()%>:<%=groupBy.toUpperCase()%></b></td>
