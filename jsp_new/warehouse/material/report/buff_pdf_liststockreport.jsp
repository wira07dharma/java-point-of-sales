...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_STOCK, AppObjInfo.G2_STOCK, AppObjInfo.OBJ_STOCK_REPORT); %>
...
public static final String textListGlobal[][] = {
	{"LAPORAN STOK GLOBAL", "Periode", "Lokasi", "Kategori", "Suplier", "Semua"},
	{"GLOBAL STOCK REPORT", "Periode", "Location", "Category", "Supplier", "All"}
};
...
Vector listStockAll = sessReportStock.getReportStockAll(srcReportStock, calculateQtyNull, 0, 0);
...
for(int i=0; i<listStockAll.size(); i++) {
    ...
    System.out.println(material.getAveragePrice());
...
headerPdf.add(5, " : PERIODE STOCK ");//+periode.getPeriodeName().toUpperCase());
