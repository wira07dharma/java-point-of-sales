...
{
	{"Lokasi","Supplier","Kategori","Tanggal","Urut Berdasar","Alasan","Sub Kategori"},
	{"Location","Supplier","Category","Return Date","Sort By","Reason","Sub Category"}
};
...
function cmdSearch()
{
	...
	document.frmsrcreturnreport.action="reportreturninvoicerekap_list.jsp";
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr> 
                        <td height="21" width="12%"><%=getJspTitle(0,SESS_LANGUAGE,"",true)%></td>
                        ...
                        <td height="21" width="88%">&nbsp; <% 
						  ...
						  %> <%=ControlCombo.draw(frmSrcReportReturn.fieldNames[frmSrcReportReturn.FRM_FIELD_LOCATION_ID], null, ""+srcReportReturn.getLocationId(), val_locationid, key_locationid, "", "formElemen")%> </td>
                      </tr>
                      <tr> 
                        <td  valign="top" width="12%" align="left"><%=getJspTitle(3,SESS_LANGUAGE,"",true)%></td>
                        <td  valign="top" width="0%" align="left">:</td>
                        <td width="88%" valign="top" align="left"> &nbsp; Dari 
                          <%=ControlDate.drawDate(frmSrcReportReturn.fieldNames[FrmSrcReportReturn.FRM_FIELD_DATE_FROM], srcReportReturn.getDateFrom(),"formElemen",1,-5)%> s/d <%=ControlDate.drawDate(frmSrcReportReturn.fieldNames[FrmSrcReportReturn.FRM_FIELD_DATE_TO], srcReportReturn.getDateTo(),"formElemen",1,-5) %> </td>
                      </tr>
                      <tr> 
