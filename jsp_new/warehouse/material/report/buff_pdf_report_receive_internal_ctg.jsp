...
public static final String textListGlobal[][] = {
	{"LAPORAN PENERIMAAN BARANG ANTAR LOKASI PER KATEGORI","Periode"," s/d ", "Lokasi", "Kategori"},
	{"GOODS RECEIVE BETWEEN LOCATION REPORT BY CATEGORY","Period"," to ","Location", "Category"}
};
...
headerPdf.add(8, (textListGlobal[SESS_LANGUAGE][4]).toUpperCase()); //category or supplier
headerPdf.add(9, " : "+category.getName().toUpperCase());
