...
<%
    ...
    int sortBy = FRMQueryString.requestInt(request, "SORT_BY");
    int sortType = FRMQueryString.requestInt(request, "SORT_TYPE");
            ...
            <div class="col-sm-12">
              ...
              <input type="hidden" name="PRICE_TYPE" value="<%=oidPriceType %>">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                    <label class="col-sm-4">QTY 0</label>
                    <div class="col-sm-8">
                        <%
                            String checkQty = "";
                            if (iCommand == Command.LIST && showQtyZero == 1) {
                                checkQty = "checked";
                            }
                        %>
                      <input type="checkbox" <%= showQtyZero == 1 ? checkQty : "" %> value="1" name="<%=FrmSrcReportPotitionStock.fieldNames[FrmSrcReportPotitionStock.FRM_FIELD_SHOW_QTY_ZERO] %>"> Ya
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select class="form-control input-sm" name="SORT_BY">
                        <option <%=(sortBy == 0 ? "selected" : "")%> value="0">Stock ID</option>
                        <option <%=(sortBy == 1 ? "selected" : "")%> value="1">Stock Name</option>
                        <option <%=(sortBy == 2 ? "selected" : "")%> value="2">Brand</option>
                        <option <%=(sortBy == 3 ? "selected" : "")%> value="3">Stock End</option>
                      </select>
                    </div>
                    <div class="col-sm-4">
                      <select class="form-control input-sm" name="SORT_TYPE">
                        <option <%=(sortType == 0 ? "selected" : "")%> value="0">Asc</option>
                        <option <%=(sortType == 1 ? "selected" : "")%> value="1">Desc</option>
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <tbody>
                <%
                    ...
                    if (groupBy == SrcSaleReport.GROUP_BY_SUPPLIER) {
                        order = " con." + PstContactList.fieldNames[PstContactList.FLD_CONTACT_ID] + " ASC ";
                    ...
                    switch(sortBy){
                        case 0: 
                            order = order + ", mat." + PstMaterial.fieldNames[PstMaterial.FLD_SKU] + " "+strSortType;
                            break;
                        case 1:
                            order = order + ", mat." + PstMaterial.fieldNames[PstMaterial.FLD_NAME] + " "+strSortType;
                            break;
                        case 2:
                            order = order + ", cat." + PstCategory.fieldNames[PstCategory.FLD_NAME] + " "+strSortType;
                            break;
                        case 3:
                            order = order + ", END "+strSortType;
                            break;
                    ...
                    ArrayList<String> data = SessReportPotitionStock.drawTableListPosition(whereData, order, periodeStart, periodeEnd, tglMulai, tglAkhir, loc, useForGreenbowl, groupBy, 0, showQtyZero);
                    if (data.size()>0){
