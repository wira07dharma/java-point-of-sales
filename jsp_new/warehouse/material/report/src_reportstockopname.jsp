...
function cmdSearch()
{
	...
	{
		case "0":
			document.frmsrcreportstockopname.action="reportstockopname_list.jsp";
			break;
		case "1":
			document.frmsrcreportstockopname.action="reportstockopnameprice_list.jsp";
			break;
	}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" --> 
            Stock Opname Report &gt; <!-- #EndEditable --></td>
        </tr>
        <tr> 
