<%-- 
    Document   : src_reportposisistock_history
    Created on : Oct 14, 2016, 9:42:41 AM
    Author     : dimata005
--%>
<%@page import="com.dimata.posbo.session.warehouse.SessHistoriPosisiStok"%>
<%@page import="com.dimata.gui.jsp.ControlRadio"%>
...
function cmdSearch() {
    ...
    document.frmsrcReportPotitionStock.action="reportposisistock_list_histori.jsp";
                  ...
                  <td colspan="2">
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      ...
                      <tr>
                        ...
                        <td height="21" width="90%"><%=ControlCombo.draw(frmSrcReportPotitionStock.fieldNames[frmSrcReportPotitionStock.FRM_FIELD_LOCATION_ID], null, ""+srcReportPotitionStock.getLocationId(), val_locationid, key_locationid, "", "formElemen")%> </td>
                      </tr>
                      <tr>
                      ...
                      <tr id="stockValueBy" style="YES; display: none;">
                      ...
                      <tr id="stockValueByz" style="YES; display: none;">
					...
					prTypeKey.add(""+prType.getCode()+"");
                      ...
                      <!-- option summary nd detail -->
                       <tr>
                        ...
                        <td height="21" valign="" width="1%" align="left">:</td>
                        <td height="21" valign="" width="90%" align="left">
                         <input type="radio" name="<%=frmSrcReportPotitionStock.fieldNames[frmSrcReportPotitionStock.FRM_FIELD_VIEW_DEAD_STOK]%>" value="<%=SessHistoriPosisiStok.VIEW_DEAD_STOK_ALL%>" checked> All Status
                         &nbsp;&nbsp;<input type="radio" name="<%=frmSrcReportPotitionStock.fieldNames[frmSrcReportPotitionStock.FRM_FIELD_VIEW_DEAD_STOK]%>" value="<%=SessHistoriPosisiStok.VIEW_DEAD_STOK_NO_MOVE_AND_YES_MOVE_NO_SALE%>" >Hanya Item Aktive
                         &nbsp;&nbsp;<input type="radio" name="<%=frmSrcReportPotitionStock.fieldNames[frmSrcReportPotitionStock.FRM_FIELD_VIEW_DEAD_STOK]%>" value="<%=SessHistoriPosisiStok.VIEW_DEAD_STOK_NO_MOVEMENT%>" >Dead Stok Item (Tidak Ada Perpindahan Data)
                         &nbsp;&nbsp;<input type="radio" name="<%=frmSrcReportPotitionStock.fieldNames[frmSrcReportPotitionStock.FRM_FIELD_VIEW_DEAD_STOK]%>" value="<%=SessHistoriPosisiStok.VIEW_DEAD_STOK_YES_MOVEMENT_NO_SALE%>">Dead Stok Item (Ada Perpindahan Stok Tapi Tidak Ada Penjualan)
                         <%--&nbsp;&nbsp;<input type="radio" name="<%=frmSrcReportPotitionStock.fieldNames[frmSrcReportPotitionStock.FRM_FIELD_VIEW_DEAD_STOK]%>" value="<%=SessHistoriPosisiStok.VIEW_DEAD_STOK_NO_MOVE_AND_YES_MOVE_NO_SALE%>">Dead Stok Tidak ada Dokument dan Tidak ada Penjualan--%>
			</td>
                      </tr>
                      <tr>
