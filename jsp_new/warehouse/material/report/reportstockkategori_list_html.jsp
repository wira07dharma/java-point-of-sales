...
public String drawList(JspWriter outObj, int language, Vector objectClass, long locationId, long categoryId, Vector listTypeHrga) {
	String result = "";
          ...
          <td><!-- #BeginEditable "content" --> 
            <form name="frm_reportstock" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                ...
                <tr align="left" valign="top"> 
                  <td height="22" valign="middle" align="center" colspan="3"><%=drawList(out,SESS_LANGUAGE, listStockPerKategori,srcReportStock.getLocationId(),srcReportStock.getCategoryId(),listTypeHrga)%></td>
                </tr>
              </table>
            </form>
            <!-- #EndEditable --></td> 
