...
public static final String textGlobalTitle[][] = {
	{"LAPORAN PENERIMAAN BARANG PER KATEGORI", "Dari", "s/d", "Lokasi", "Kategori","Semua"},
	{"GOODS RECEIVE REPORT BY CATEGORY", "From", "to", "Location", "Category","All"}
};
...
if (srcReportReceive.getCategoryId() != 0) {
    ...
    category.setName(textGlobalTitle[SESS_LANGUAGE][5]+" "+textGlobalTitle[SESS_LANGUAGE][4]);
}
...
headerPdf.add(6, textGlobalTitle[SESS_LANGUAGE][4]+" : "+category.getName());
