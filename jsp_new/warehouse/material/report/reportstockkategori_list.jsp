...
<%!//
    ...
    public String drawList(JspWriter outObj, int language, Vector objectClass, long locationId, long categoryId, Vector listTypeHrga, int typeOfBusinessDetail) {
        ...
        if (objectClass != null && objectClass.size() > 0) {
            ...
            ctrlist.addHeader(textListMaterialHeader[language][1], "7%");//sku
            ctrlist.addHeader(textListMaterialHeader[language][9], "7%");//barcode            
            ctrlist.addHeader(textListMaterialHeader[language][2], "31%");//nama
            ...
            ctrlist.addHeader(textListMaterialHeader[language][8], "13%");//nilai stock
...
if (srcReportStock.getCategoryId()== 0) {
    category.setName(textListGlobal[SESS_LANGUAGE][5]+" "+textListGlobal[SESS_LANGUAGE][4]);
}
...
function printFormHtml() {
        var pricetypei=document.frm_reportstock.FRM_FIELD_PRICE_TYPE_ID.value;
        if("<%=typeOfBusinessDetail%>" == 2) {
            window.open("report_stock_category.jsp?FRM_FIELD_PRICE_TYPE_ID='"+pricetypei+"'&viewzerostock=<%=viewzerostock%>", "stock_report_by_supplier")
        } else {
                                                        ...
                                                        <table width="55%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr> 
                                                              <!--td nowrap width="6%"><a href="javascript:cmdBack()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnBackOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnBack.jpg" width="24" height="24" alt="<%=ctrLine.getCommand(SESS_LANGUAGE, textListGlobal[SESS_LANGUAGE][6], ctrLine.CMD_BACK_SEARCH, true)%>"></a></td-->
                                                                ...
                                                                <td class="command" nowrap width="92%"><a class="btn btn-primary" href="javascript:cmdBack()"><i class="fa fa-arrow-left"></i> <%=ctrLine.getCommand(SESS_LANGUAGE, textListGlobal[SESS_LANGUAGE][6], ctrLine.CMD_BACK_SEARCH, true)%></a></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <% if (listStockPerKategori.size() != 0) {%>
                                                    <td width="20%"> 
                                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                            <tr> 
                                                              <!--td width="5%" valign="top"><a href="javascript:printFormHtml()"><img src="<%=approot%>/images/BtnPrint.gif" width="31" height="27" border="0" alt="<%=textListGlobal[SESS_LANGUAGE][7]%>"></a></td-->
                                                                <td width="45%" nowrap>&nbsp; <a class="btn btn-primary" href="javascript:printFormHtml()" class="command"><i class="fa fa-print"></i> <%=textListGlobal[SESS_LANGUAGE][7]%></a></td>

<!--td width="5%" valign="top"><a href="javascript:printFormExcel()"><img src="<%=approot%>/images/BtnPrint.gif" width="31" height="27" border="0" alt="<%=textListGlobal[SESS_LANGUAGE][7]%>"></a></td-->
                                                                <td width="45%" nowrap>&nbsp; <a class="btn btn-primary" href="javascript:printFormExcel()" class="command"><i class="fa fa-print"></i> <%=textListGlobal[SESS_LANGUAGE][7]%> Excel</a></td>
                                                            </tr>
                                                        </table>						  
                                                    </td>
                                                    <% } %>
