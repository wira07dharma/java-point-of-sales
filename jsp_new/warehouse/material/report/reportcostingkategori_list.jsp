						...
						boolean isDispatchTo, boolean isSupplier)
{
	...
	if(objectClass!=null && objectClass.size()>0)
	{
		...
		for(int i=0; i<objectClass.size(); i++)
		{
			...
			/*if (cat_name.equals(cat.getName()) == false){
            ...
            */
			...
			totalQty += dfi.getQty();
			subTotalPrice += (dfi.getQty() * mat.getAveragePrice());
...
function cmdListFirst()
{
	...
	document.frm_reportdispatch.action="reportcostingkategori_list.jsp";
...
function cmdBack()
{
	...
	document.frm_reportdispatch.action="src_reportcostingkategori.jsp";
	document.frm_reportdispatch.submit();
}

function printForm(){
	window.open("reportcostingkategori_form_print.jsp","costingkategorireport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}
          ...
          <td><!-- #BeginEditable "content" -->
            <form name="frm_reportdispatch" method="post" action="">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
				...
				<tr align="left" valign="top"> 
                  <td class="command"><strong><%=(textListHeader[SESS_LANGUAGE][4]).toUpperCase()%></strong></td>
				  <td class="command"><strong>:</strong></td>
