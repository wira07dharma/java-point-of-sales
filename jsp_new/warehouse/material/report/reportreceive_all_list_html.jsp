<%-- 
    Document   : reportreceive_all_list_html
    Created on : Aug 19, 2016, 5:27:51 PM
    Author     : dimata005
--%>
<%-- 
    Document   : reportreceive_all_list_excel
    Created on : May 4, 2016, 9:11:39 AM
    Author     : dimata005
--%>
                                ...
                                <form name="frm_reportsale" method="post" action="">
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="3">
                                        ...
                                        <tr align="left" valign="top"> 
                                            ...
                                            <td colspan="2"> <%=location.getName().toUpperCase()%></td>
                                        </tr>
                                        <tr align="left" valign="top"> 
