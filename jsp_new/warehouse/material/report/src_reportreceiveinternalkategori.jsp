...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_RECEIVING, AppObjInfo.G2_LOCATION_RECEIVE_REPORT, AppObjInfo.OBJ_LOCATION_RECEIVE_REPORT_BY_CATEGORY); %>
...
public static final String listTextGlobal[][] = {
	{"LAPORAN PENERIMAAN BARANG ANTAR LOKASI PER KATEGORI","Penerimaan","Dari Toko/Gudang","Laporan Per Kategori","Pencarian",
	 "Cetak Laporan Penerimaan"," Tidak ada data penerimaan barang...","Laporan Penerimaan"},
	{"GOODS RECEIVE BETWEEN LOCATION REPORT BY CATEGORY","Receive","From Store/Warehouse","By Category Report","Search",
	 "Print Receive Report","There is no goods receive data ...","Receive Report"}
};

public static final String listTextTitle[][] = {
	{"Periode"," s/d ", "Lokasi", "Kategori"},
	{"Period"," to ","Location", "Category"}
};
...
function cmdSearch() {
	...
	document.frmsrcreceivereport.action="reportreceiveinternalkategori_list.jsp";
                ...
                <tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                      <tr> 
                        <td valign="top" width="11%" align="left"><strong><%=getJspTitle(0,SESS_LANGUAGE,"",true)%></strong></td>
                        <td valign="top" width="0%" align="left"><strong>:</strong></td>
                        <td width="89%" valign="top" align="left"><%=ControlDate.drawDate(frmSrcReportReceive.fieldNames[FrmSrcReportReceive.FRM_FIELD_DATE_FROM], srcReportReceive.getDateFrom(),"formElemen",1,-5)%><%=getJspTitle(1,SESS_LANGUAGE,"",true)%><%=ControlDate.drawDate(frmSrcReportReceive.fieldNames[FrmSrcReportReceive.FRM_FIELD_DATE_TO], srcReportReceive.getDateTo(),"formElemen",1,-5) %> </td>
                      </tr>
                      <td valign="top" align="left"><strong><%=getJspTitle(2,SESS_LANGUAGE,"",true)%></strong></td>
                      ...
                      <tr> 
                        <td height="21" width="9%"><strong><%=getJspTitle(3,SESS_LANGUAGE,"",true)%></strong></td>
                        <td height="21" width="1%"><strong>:</strong></td>
                        <td height="21" width="90%"><%=ControlCombo.draw(frmSrcReportReceive.fieldNames[frmSrcReportReceive.FRM_FIELD_CATEGORY_ID],"formElemen", null, ""+srcReportReceive.getCategoryId(), vectGroupKey, vectGroupVal, null)%> </td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        ...
                        <td height="21" width="89%" valign="top" align="left"> 
                          <table width="40%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td width="90%" nowrap class="command"><a class="btn-primary btn-lg" href="javascript:cmdSearch()"><i class="fa fa-search"> &nbsp;<%=ctrLine.getCommand(SESS_LANGUAGE,"Penerimaan Barang",ctrLine.CMD_SEARCH,true)%></i></a></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
