...
public static final String textListGlobal[][] = {
	{"Penerimaan","Dari Pengembalian","Laporan Global","Pencarian","Laporan Penerimaan"},
	{"Receive","From Return","Report Global","Search","Receive Report"}
};

/* this constant used to list text of listHeader */
public static final String textListHeader[][] = {
	{"Lokasi","Supplier","Kategori","Periode","Urut Berdasar","Sub Kategori"," s/d ","Semua Lokasi"},
	{"Location","Supplier","Category","Period","Sort By","Sub Category"," to ","All Location"}
};
...
function cmdSearch() {
	...
	document.frmsrcreceivereport.action="reportreceive_return_list.jsp";
				...
				<tr> 
                  <td colspan="2"> 
                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
					  ...
					  <!--tr>
                        <td height="21" valign="top" width="9%" align="left">Currency</td>
                        <td height="21" valign="top" width="1%" align="left">:</td>
                        <td height="21" width="90%" valign="top" align="left"><%=ControlCombo.draw(FrmSrcReportReceive.fieldNames[FrmSrcReportReceive.FRM_FIELD_CURRENCY_ID], null, ""+srcReportReceive.getCurrencyId(), vectCurrVal, vectCurrKey, "")%>  
						</td>
                      </tr-->
                      <tr> 
