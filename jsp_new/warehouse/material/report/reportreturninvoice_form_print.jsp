...
try
{
	Vector vtSess = (Vector)session.getValue("SESS_MAT_RETURN_REPORT_INVOICE");
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr align="center"> 
                        <td width="25%">&nbsp;</td>
                        <td class="listgensell" width="50%"><b>LAPORAN RETUR KE 
                          SUPPLIER PER INVOICE</b></td>
                        <td width="25%">&nbsp;</td>
                      </tr>
                      <tr align="center"> 
                        <td width="25%">&nbsp;</td>
                ...
                <tr> 
                  <td align="center"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="6%" valign="middle" class="listgensell" >&nbsp;LOKASI</td>
                        <td width="2%" valign="middle" class="listgensell">:</td>
                        <td width="92%" valign="middle" class="listgensell"><b><%=lokasi.getName().toUpperCase()%></b></td>
                      </tr>
                    </table></td>
                </tr>
