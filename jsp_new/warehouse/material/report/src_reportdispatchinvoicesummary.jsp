...
<%!
    ...
    {
        {"Periode","Lokasi Asal","Lokasi Tujuan","Mata Uang","Semua Lokasi","Cari Laporan","Kode"},
        {"Period","Origin Location","Location To","Currency","All Location","Search Report","Code"}
    };
%>
<html>
    <head>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            ...
                                            <input id="dateFrom" name="<%= frmSrcReportDispatch.fieldNames[FrmSrcReportDispatch.FRM_FIELD_DATE_FROM]%>" class="form-control dates" type="text">
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            ...
                                            <input id="dateTo" name="<%= frmSrcReportDispatch.fieldNames[FrmSrcReportDispatch.FRM_FIELD_DATE_TO]%>" class="form-control dates" type="text">
                                        </div>
                                    </div> 
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <%=ControlCombo.draw(FrmSrcReportDispatch.fieldNames[FrmSrcReportDispatch.FRM_FIELD_LOCATION_ID], null, ""+srcReportDispatch.getLocationId(), val_locationid, key_locationid, "multiple='multiple' style='width: 100%'", "form-control selects2")%> 
                                    </div>
                                </div>
								<div class="form-group">
                                    <label class="control-label col-sm-2" for="">
                                    ...
                                    <div class="col-sm-10">
                                        <%=ControlCombo.draw(FrmSrcReportDispatch.fieldNames[FrmSrcReportDispatch.FRM_FIELD_DISPATCH_TO], null, ""+srcReportDispatch.getDispatchTo(), val_locationid, key_locationid, "multiple='multiple' style='width: 100%'", "form-control selects2")%> 
                                    </div>
                                </div>
								<div class="form-group">
                                    <label class="control-label col-sm-2" for="">
                                    ...
                                    <div class="col-sm-10">
										<input type="text" class="form-control" name="DISPATCH_CODE">
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        $(document).ready(function () {
            ...
            $("#btnSearch").click(function () {
                ...
                if (tipeBisnisDetail === "2") {
                    $('#datafor').val("getReportBisnisLeburDetail2");
            ...
            function printPenerimaan(elementId) {
                $(elementId).click(function() {
                    var dataSend = $("#frmsrcreceivereport").serialize();
                    window.open("print_report_summary_lebur_jewelry.jsp?" + dataSend + "");
                });
            };
