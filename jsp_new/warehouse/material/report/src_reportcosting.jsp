...
public static final String textListHeader[][] = {
	...
	{"Period"," to ","From Location","To Location","Category","Sort By","Sub Category","Supplier", "Costing Type", "All Locations"}
};
...
function cmdSearch() {
	...
	document.frmsrcdispatchreport.action="reportcosting_list.jsp";
				...
				<tr>
                  <td colspan="2">
					...
					key_costingid.add(cost.getName());
                          ...
                          %>
                          <%=controlCheckBox.draw(frmSrcReportDispatch.fieldNames[frmSrcReportDispatch.FRM_FIELD_COSTING_ID],val_costingid,key_costingid,new Vector())%></td>
                      </tr>
                      <tr>
