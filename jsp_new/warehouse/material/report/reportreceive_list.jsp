...
function printForm() {
    ...
    window.open("reportreceive_list_excel.jsp","salereport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}

function printFormExcel(){
    //window.open("reportreceive_list_html.jsp");
    window.open("reportreceive_list_html.jsp","salereport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}
                      ...
                      <tr> 
                        ...
                        <td width="20%">
						 <table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							%>
							<tr> 
                                <td width="45%" nowrap>&nbsp; <a class="btn-primary btn-lg" href="javascript:printFormExcel()" class="command"><i class="fa fa-print">&nbsp;Export Html</i></a></td>                                  
                              <td width="45%" nowrap>&nbsp; <a class="btn-primary btn-lg" href="javascript:printForm()" class="command"><i class="fa fa-print">&nbsp;Export Excel</i></a></td>
