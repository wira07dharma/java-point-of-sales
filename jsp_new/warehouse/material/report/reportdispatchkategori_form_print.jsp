					...
					<td>
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td class="listgensell" width="50%"><b>LAPORAN PENGIRIMAN 
                          BARANG KE TOKO PER KATEGORI</b></td>
							<td width="25%">&nbsp;</td>
						  </tr>
						  <tr align="center">
							<td width="25%">&nbsp;</td>
				  ...
				  <tr>
					<td>
                      ...
                      <%
						...
						%>
                      <tr> 
                        <td class="listgensell" valign="middle" width="9%" >&nbsp;ASAL</td>
                        <td class="listgensell" valign="middle" width="1%">:</td>
                        <td class="listgensell" valign="middle" width="90%"><%=lokasi.getName().toUpperCase()%></td>
                      </tr>
                      <tr> 
                        <td width="9%" class="listgensell" valign="middle" > &nbsp;TUJUAN</td>
                        <td width="1%" class="listgensell" valign="middle"> : 
                        </td>
                        <td width="90%" class="listgensell" valign="middle"> <b><%=loc1.getName().toUpperCase()%> </b> </td>
                      </tr>
                      <tr>
                        <td class="listgensell" valign="middle" width="9%" >&nbsp;KATEGORI</td>
                        <td class="listgensell" valign="middle" width="1%">:</td>
                        <td class="listgensell" valign="middle" width="90%"><%=categ.getName().toUpperCase()%></td>
                      </tr>
                    </table>
					</td>
				</table>
