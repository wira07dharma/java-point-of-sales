...
{
	{"No","Tanggal","SKU","Nama","Harga Beli","Qty Opn","Qty Sld","Qty Sys","Selisih","Total Lost"},
...
function printForm(){
	window.open("reportstockopnameinvoice_form_print.jsp","stockreport","scrollbars=yes,height=600,width=800,status=no,toolbar=no,menubar=yes,location=no");
}
