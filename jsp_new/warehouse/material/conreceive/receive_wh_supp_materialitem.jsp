...
public Vector drawListRetItem(int language,int iCommand,FrmMatConReceiveItem frmObject,MatConReceiveItem objEntity,Vector objectClass,long recItemId,int start) {
	...
	if(iCommand==Command.ADD || (iCommand==Command.SAVE && frmObject.errorSize()>0)) {
		...
		rowx.add("<input type=\"hidden\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_CURRENCY_ID]+"\" value=\"\">" +
                "<div align=\"right\"><input type=\"text\" size=\"15\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_COST]+"\" value=\""+""+"\" class=\"formElemen\" onkeyup=\"javascript:cntTotal()\" style=\"text-align:right\"></div>");
...
//-->
</script><!-- #BeginTemplate "/Templates/main.dwt" --><!-- DW6 -->
<head>
...
function cmdCheck() {
	var strvalue  = "materialdosearch.jsp?command=<%=Command.FIRST%>"+
					...
					"&mat_vendor="+document.frm_recmaterial.<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_SUPPLIER_ID]%>.value+
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" -->
            Konsinyasi &gt; Terima Barang &gt; Tanpa PO <!-- #EndEditable --></td>
        </tr>
        <tr>
                    ...
                    <table width="100%" border="0" cellpadding="1">
                      <tr>
                        ...
                        <td width="18%" rowspan="4" align="right" valign="top">
                          <textarea name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_REMARK]%>" class="formElemen" wrap="VIRTUAL" rows="3" disabled="true"><%=rec.getRemark()%></textarea>
                        </tr>
                      <tr>
                        <td width="8%" align="left"><%=textListOrderHeader[SESS_LANGUAGE][2]%></td>
                        <td width="27%" align="left"> : <%=ControlDate.drawDateWithStyle(FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_RECEIVE_DATE], rec.getReceiveDate(), 1, -5, "formElemen", "disabled=\"true\"")%></td>
                      ...
                      <tr>
                        ...
                        <td valign="bottom">:
                          ...
                          %>
                        <%=ControlCombo.draw(FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_CURRENCY_ID],"formElemen", null, ""+rec.getCurrencyId(), vectCurrVal, vectCurrKey, "")%></td>
