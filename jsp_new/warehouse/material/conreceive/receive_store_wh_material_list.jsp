...
public static final String textListMaterialHeader[][] =  {
	{"No","Nomor","Tanggal","Terima Dari","Lokasi Penerimaan","Status","Keterangan"},
...
if(iCommand==Command.BACK || iCommand==Command.FIRST || iCommand==Command.PREV || iCommand==Command.NEXT || iCommand==Command.LAST)
{
	 ...
	 { 
		...
		if (srcMatConReceive == null) 
		{
			...
			srcMatConReceive.setLocationType(PstLocation.TYPE_LOCATION_STORE);
			srcMatConReceive.setReceiveSource(PstMatConReceive.SOURCE_FROM_DISPATCH);
		}
	 }
	 catch(Exception e)
	 { 
...
vectSize = sessMatConReceive.getCountSearchNonSupplier(srcMatConReceive);
if(iCommand==Command.FIRST || iCommand==Command.NEXT || iCommand==Command.PREV || iCommand==Command.LAST || iCommand==Command.LIST) {
	start = ctrlMatConReceive.actionList(iCommand,start,vectSize,recordToGet);
}	
Vector records = sessMatConReceive.searchMatConReceiveNonSupplier(srcMatConReceive,start,recordToGet);
%>
<!-- End of Jsp Block -->
<html>
