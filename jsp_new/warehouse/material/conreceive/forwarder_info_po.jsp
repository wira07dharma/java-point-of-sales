...
public static final String textListOrderHeader[][] = {
	{"Nomor","Consignee","Tanggal","Consignor","Status","Keterangan","Nota Consignor","Ppn (%)","Waktu","Sub Total","Mata Uang"},
	{"Number","Consignee","Date","Consignor","Status","Remark","Consignor Invoice","VAT","Time","Sub Total","Currency"}
};
...
%>
	<jsp:forward page="receive_wh_supp_po_material_edit.jsp">
    ...
    <td width="88%" valign="top" align="left">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          Konsinyasi &gt; Terima Barang &gt; Dengan Faktur Order<!-- #EndEditable --></td>
        </tr>
        <tr>
                  ...
                  <td colspan="3">
                    <table width="100%" border="0" cellpadding="1">
                      <tr>
                        ...
                        <td width="9%"><%=textListOrderHeader[SESS_LANGUAGE][5]%>                        
                        <td width="17%" rowspan="4" valign="top">                       <textarea name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_REMARK]%>" class="formElemen" wrap="VIRTUAL" rows="2"><%=rec.getRemark()%></textarea>
                      </tr>
                      <tr>
                        ...
                        <td>:
                          <input type="text" readonly name="txt_ponumber"  value="<%= po.getPoCode() %>" class="formElemen" size="15">
