...
public static final String textListOrderHeader[][] = {
	{"Nomor","Consignee","Tanggal","Consignor","Status","Keterangan","Nomor PO","Nota Consignor","PPN(%)","Waktu","Mata Uang","Konsinyasi","Terima Barang","Dengan Faktur Order"},
	{"Number","Consignee","Date","Consignor","Status","Remark","PO Number","Consignor Invoice","PPN(%)","Time","Currency","Consigment","Receive","With Purchase Order"}
};
...
String recTitle = textListOrderHeader[SESS_LANGUAGE][12];
  ...
  <tr> 
    <td width="88%" valign="top" align="left"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">  
        <tr> 
          <td height="20" class="mainheader"><!-- #BeginEditable "contenttitle" --><%=textListOrderHeader[SESS_LANGUAGE][11]%> &gt; <%=textListOrderHeader[SESS_LANGUAGE][12]%> &gt; <%=textListOrderHeader[SESS_LANGUAGE][13]%><!-- #EndEditable --></td>
        </tr>
        <tr> 
...
function cmdSave() {
	...
	%>
		...
		var notaSupp = document.frm_recmaterial.<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_INVOICE_SUPPLIER]%>.value;
		if(kodePo!='' && notaSupp!=''){
...
function cmdSelectPO(){
	...
	var strvalue  = "podosearch.jsp?command=<%=Command.FIRST%>"+
					"&oidVendor="+document.frm_recmaterial.<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_SUPPLIER_ID]%>.value+
        ...
        <tr> 
          <td>
		    <form name="frm_recmaterial" method="post" action="">
              ...
              <input type="hidden" name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_RECEIVE_SOURCE]%>" value="<%=PstMatConReceive.SOURCE_FROM_SUPPLIER_PO%>">
              <input type="hidden" name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_PURCHASE_ORDER_ID]%>" value="<%=rec.getPurchaseOrderId()%>">
              <input type="hidden" name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_CURRENCY_ID]%>" value="<%=rec.getCurrencyId()%>">
			  <% if(oidReceiveMaterial == 0) { %>
			  	<input type="hidden" name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_TOTAL_PPN]%>" value="">
			  <% } %>
                  ...
                  <td colspan="3">
                    <table width="100%" border="0" cellpadding="1">
                      <tr>
                        ...
                        <td width="17%" rowspan="4" valign="top"><textarea name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_REMARK]%>" class="formElemen" wrap="VIRTUAL" rows="2"><%=rec.getRemark()%></textarea></td>
                      </tr>
                      <tr>
                        ...
                        <td width="24%" align="left">:
						  ...
						  %>
                          <%=ControlCombo.draw(FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_LOCATION_ID], null, select_locationid, val_locationid, key_locationid, "", "formElemen")%> </td>
                        <td valign="bottom"><%=textListOrderHeader[SESS_LANGUAGE][6]%></td>
                        <td>:
                          <input type="text" name="txt_ponumber"  value="<%= po.getPoCode() %>" class="formElemen" size="15">
                          <%if(listMatConReceiveItem.size()==0){%><a href="javascript:cmdSelectPO()">CHK</a><%}%></td>
                        <td align="right">                        </tr>
                      <tr>
                        <td width="9%" align="left"><%=textListOrderHeader[SESS_LANGUAGE][2]%></td>
                        <td width="24%" align="left">: <%=ControlDate.drawDateWithStyle(FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_RECEIVE_DATE], (rec.getReceiveDate()==null) ? new Date() : rec.getReceiveDate(), 1, -5,"formElemen", "")%></td>
                        <td valign="bottom"><%=textListOrderHeader[SESS_LANGUAGE][7]%></td>
                        <td>:
                          <input type="text"  class="formElemen" name="<%=FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_INVOICE_SUPPLIER]%>" value="<%=rec.getInvoiceSupplier()%>"  size="20" style="text-align:right"></td>
                        <td align="right">                        </tr>
                      <tr>
                      ...
                      <tr>
						...
						%>
						<%=ControlCombo.draw(FrmMatConReceive.fieldNames[FrmMatConReceive.FRM_FIELD_RECEIVE_STATUS],null,select_status,val_status,key_status,"","formElemen")%> </td>
						<% } %>
                        <td valign="bottom">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td align="right">                      
                ...
                <tr>
                  ...
                  <td width="30%" valign="top">
                    <table width="100%" border="0">
                      ...
                      %>
                      <tr> 
                        <td width="56%"><div align="right"><%=textListGlobal[SESS_LANGUAGE][2]%> <%=textListOrderItem[SESS_LANGUAGE][5]%></div></td>
					  ...
					  <tr> 
                        <td width="56%"><div align="right"><%=textListGlobal[SESS_LANGUAGE][2]%></div></td>
                        <td width="44%"><div align="right"><b><%=FRMHandler.userFormatStringDecimal(totalBeliWithPPN)%></b></div></td>
                      </tr>
                      <tr> 
                        <td width="56%"><div align="right"><%=textListGlobal[SESS_LANGUAGE][2]%> <%=textListOrderItem[SESS_LANGUAGE][6]%></div></td>
                        <td width="44%"><div align="right"><b><%=FRMHandler.userFormatStringDecimal(totalForwarderCost)%></b></div></td>
                      </tr>
					  <tr> 
                        <td width="56%"><div align="right"><%=textListGlobal[SESS_LANGUAGE][1]%></div></td>
