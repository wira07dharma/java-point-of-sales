...
{
	{"Nomor","Lokasi","Tanggal","Supplier","Status","Keterangan","Nomor PO","Nota Supplier","Ppn (%)"},
	{"No","Location","Date","Supplier","Status","Remark","PO Code","Supplier Invoice","Ppn (%)"}
};
...
{
	{"No","Sku","Nama","Kadaluarsa","Unit","Harga Beli","Harga Jual","Mata Uang","Qty","Total Beli"},
			  ...
			  <table width="100%" cellpadding="1" cellspacing="0">
                ...
                <tr align="center"> 
                  <td colspan="3" class="title" align="center"> 
                    <table width="100%" border="0" cellpadding="1">
                      <tr>
                        <td width="14%" align="left" nowrap><%=textListOrderHeader[SESS_LANGUAGE][0]%></td>
                        <td width="24%" align="left"> : <b><%=rec.getRecCode()%></b>
                        </td>
                      ...
                      <tr>
                        <td width="14%" align="left"><%=textListOrderHeader[SESS_LANGUAGE][1]%></td>
                        <td width="24%" align="left">: 
						  ...
						  %>
                          <%=loc.getName()%></td>
                        <td align="left" valign="top" rowspan="2" width="29%"> 
                          <%//=strComboStatus%> </td>
                        <td width="33%" align="right"><%=textListOrderHeader[SESS_LANGUAGE][6]%> 
                          : <%= po.getPoCode() %> 
                      </tr>
                      <tr>
                        <td width="14%" align="left"><%=textListOrderHeader[SESS_LANGUAGE][2]%></td>
                        <td width="24%" align="left">: <%=Formater.formatDate(rec.getReceiveDate(),"dd MMMM yyyy")%></td>
                        <td width="33%" align="right"><%=textListOrderHeader[SESS_LANGUAGE][7]%>: 
                          <%= rec.getInvoiceSupplier() %></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                              ...
                              <td height="22" valign="middle" colspan="3">
                                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                  <tr align="center">
                                    ...
                                    <td class="formElemen"  width="10%"><%=textListOrderItem[SESS_LANGUAGE][3]%></td>
								  ...
								  %>
                                  <tr >
                                    <td class="formElemen" width="4%" align="center">&nbsp;<%=start%></td>
                                    <td  class="formElemen" width="10%">&nbsp;<%=mat.getSku()%></td>
                                    <td class="formElemen" width="20%">&nbsp;<%=mat.getName()%></td>
                                    <td class="formElemen" width="10%">&nbsp;<%=Formater.formatDate(recItemx.getExpiredDate(), "dd-MM-yyyy")%></td>
