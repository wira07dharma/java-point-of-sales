...
//default theme
  ...
  $('#sticky1').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky2').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky3').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky4').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky5').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky6').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky7').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky8').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky9').cluetip({sticky: true, closePosition: 'title', arrows: true });
  $('#sticky10').cluetip({sticky: true, closePosition: 'title', arrows: true });
