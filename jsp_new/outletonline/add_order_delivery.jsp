<%-- 
    Document   : add_order_delivery
    Created on : Jan 21, 2015, 3:08:37 PM
    Author     : dimata005
--%>
...
<script language="JavaScript">
    ...
    function cmdCheckGuest(nama,address,oid,nasionality){
        ...
        document.frmsrcsalesorder.<%=frmBillMain.fieldNames[FrmBillMain.FRM_FIELD_SHIPPING_ADDRESS]%>.value=nasionality;
            ...
            <div class=row>
                <div class="col-md-12" style="margin-bottom:10px;">
                        ...
                        <div class="form-group">
                            <div class=row>
                                <div class="col-md-12">
                                    <input name="<%=frmBillMain.fieldNames[FrmBillMain.FRM_FIELD_SHIPPING_ADDRESS]%>" id="address" type="text" class="form-control" placeholder="Insert Address.." required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<script language="JavaScript">
    $(document).ready(function(){
        ...
        $(".search").click(function(){
            ajaxScriptParentPage("ajaxDataSource.jsp","Search Member",3,"#myModal",0, "#modal-title", "#modal-body");
        });
        ...
        $("#buttonSave").click(function(){
            ...
            var address = checkedData.data("options").address;
            ...
            document.frmsrcsalesorder.<%=frmBillMain.fieldNames[FrmBillMain.FRM_FIELD_SHIPPING_ADDRESS]%>.value=address;
            document.frmsrcsalesorder.<%=frmBillMain.fieldNames[FrmBillMain.FRM_FIELD_CUSTOMER_ID]%>.value=oid;
