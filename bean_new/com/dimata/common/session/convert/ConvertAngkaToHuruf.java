...
public class ConvertAngkaToHuruf {
    ...
    private String convert3Digit(int n) {
        ...
        switch (div100) {
            ...
            case 8:
            case 9:
                str += convert1Digit(div100) + "ratus ";
                break;
            default:
                str += "";
        }
    ...
    private String convert7_9Digit(long n) {
        ...
        if (div1Juta == 0) {
            return convert5_6Digit(mod1Juta);
        }
        if (mod1Juta > 0) {
            return (convert3Digit(div1Juta) + "juta " + convert5_6Digit(mod1Juta));
        }
    ...
    private String convert10_12Digit(long n) {
        ...
        if (div1Mil == 0) {
            return convert7_9Digit(mod1Mil);
        }
        if (mod1Mil > 0) {
            return (convert3Digit(div1Mil) + "milyar " + convert7_9Digit(mod1Mil));
        }
    ...
    private String convert13_15Digit(long n) {
        ...
        if (div1Tri == 0) {
            return convert10_12Digit(mod1Tri);
        }
        if (mod1Tri > 0) {
            return (convert3Digit(div1Tri) + "trilyun " + convert10_12Digit(mod1Tri));
        }
    ...
    private String convert16_18Digit(long n) {
        ...
        if (div1Qua == 0) {
            return convert13_15Digit(mod1Qua);
        }
        if (mod1Qua > 0) {
            return (convert3Digit(div1Qua) + "quadrilyun " + convert13_15Digit(mod1Qua));
        }
