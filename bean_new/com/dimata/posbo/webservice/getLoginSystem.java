 ...
 * @author dimata005
 */
public class getLoginSystem extends HttpServlet {
 /**
    ...
    public void getListPromotion(HttpServletRequest request){
        ...
        try {
            ...
            whereClause = PstAppUser.fieldNames[PstAppUser.FLD_LOGIN_ID]+"='"+id+"' AND "+PstAppUser.fieldNames[PstAppUser.FLD_PASSWORD]+"='"+password+"' AND "+PstAppUser.fieldNames[PstAppUser.FLD_USER_GROUP_NEW]+"='0'";
