 ...
 */
package com.dimata.posbo.ajax.receive;
 ...
 * @author Regen
 */
public class AjaxReceiveMaterial extends HttpServlet {
//DATATABLES
    ...
    public synchronized void commandSave(HttpServletRequest request) {
        if (this.dataFor.equals("saveKredit")) {
//            cekValidasiDataKredit(request);
        }
    }
    ...
    public void commandList(HttpServletRequest request, HttpServletResponse response) {
        if (this.dataFor.equals("listPinjamanAll")) {
                String[] cols = {
    ...
    public synchronized void commandDelete(HttpServletRequest request) {
        if (this.dataFor.equals("deleteTransaction")) {
//            deleteTransaction(request, this.oid);
        }
    }
