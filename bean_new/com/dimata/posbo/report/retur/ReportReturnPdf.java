...
public class ReportReturnPdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                list = (Vector) sess.getValue("REPORT_RETURN_PDF");
            } catch (Exception e) {
        ...
        if (body != null && body.size() > 0) {
            try{
                for (int i = 0; i < body.size(); i++) {
                    ...
                    totalHpp = Double.parseDouble((String)vctfrs.get(6));
                    subTotalHpp += totalHpp;
                    ...
                    table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(FRMHandler.userFormatStringDecimal(totalHpp), fontLsContent));
