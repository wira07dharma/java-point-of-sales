...
public class ReceiveInternalReportPdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                list = (Vector) sess.getValue("RECEIVE_INTERNAL_REPORT_PDF");
            } catch (Exception e) {
    ...
    private static Table getListHeader(Vector header) throws BadElementException, DocumentException {
        int ctnInt[] = {3, 12, 30, 8, 7, 8, 12, 8, 12};
        ...
        if (body != null && body.size() > 0) {
            try{
                for (int i = 0; i < body.size(); i++) {
                    ...
                    hpp = Double.parseDouble((String)vctfrs.get(8));
                    ...
                    table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(FRMHandler.userFormatStringDecimal(hpp), fontLsContent));
                    ...
                    if (!writer.fitsPage(table)) {
                        ...
                        tempFooter.add(FRMHandler.userFormatStringDecimal(subTotalHpp));
