...
public class SupplierListPdf extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        try {
            ...
            if ((pdfContent != null) && (pdfContent.size() > 0)) {
                ...
                records = SessMemberReg.searchSupplier(srcMemberReg,0,0);
        ...
        if (records != null && records.size() > 0) {
            try{
                for (int i = 0; i < records.size(); i++) {
                    ...
                    table.setDefaultHorizontalAlignment(Table.ALIGN_LEFT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(cekNull(contactList.getCompName()), fontLsContent));
                    
                    table.setDefaultHorizontalAlignment(Table.ALIGN_LEFT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(cekNull(contactList.getPersonName())+" "+cekNull(contactList.getPersonLastname()), fontLsContent));
                    
                    table.setDefaultHorizontalAlignment(Table.ALIGN_LEFT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(cekNull(contactList.getTelpNr()), fontLsContent));
                    
                    table.setDefaultHorizontalAlignment(Table.ALIGN_LEFT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(cekNull(contactList.getFax()), fontLsContent));
                    
                    table.setDefaultHorizontalAlignment(Table.ALIGN_LEFT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(cekNull(contactList.getBussAddress()), fontLsContent));
