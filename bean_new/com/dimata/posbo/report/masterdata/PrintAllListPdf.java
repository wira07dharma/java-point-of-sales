 ...
 * @author Dimata 007
 */
public class PrintAllListPdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                list = SessMaterial.searchMaterial(srcMaterial, 0, 0);
            } catch (Exception e) {
            ...
            if ((list != null) && (list.size() > 0)) {
                ...
                document.add(getContent(list, document, writer, srcMaterial, SESS_LANGUAGE));
    ...
    private static Table getListHeader(int showHpp, int SESS_LANGUAGE, CurrencyType defaultCurrencyType) throws BadElementException, DocumentException {
        ...
        int ctnInt[] = {3, 5, 5, 20, 4, 4};
        Table table = new Table(6);

        int ctnInt1[] = {3, 5, 5, 16, 4, 4, 4};
        int ctnInt2[] = {3, 5, 5, 16, 4};
        if (showHpp == 1) {
            table = new Table(7);
        }
        ...
        try {
            ...
            //table.setWidths(ctnInt);
            if (showHpp == 1) {
                table.setWidths(ctnInt1);
            } else if(useForRaditya.equals("1")){
                table.setWidths(ctnInt2);
            }else{
                table.setWidths(ctnInt);
            }
            ...
            table.addCell(new Phrase(PrintAllListPdf.textListMaterialHeader[SESS_LANGUAGE][0], fontListHeader));

            table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
            table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
            table.setDefaultCellBackgroundColor(bgColor);
            //table.addCell(new Phrase("Kode", fontListHeader));
            table.addCell(new Phrase(PrintAllListPdf.textListMaterialHeader[SESS_LANGUAGE][1], fontListHeader));

            table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
            table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
            table.setDefaultCellBackgroundColor(bgColor);
            //table.addCell(new Phrase("Barcode", fontListHeader));
            table.addCell(new Phrase(PrintAllListPdf.textListMaterialHeader[SESS_LANGUAGE][2], fontListHeader));

            table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
            table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
            table.setDefaultCellBackgroundColor(bgColor);
            //table.addCell(new Phrase("Category / Sub Category / Name", fontListHeader));
            table.addCell(new Phrase(PrintAllListPdf.textListMaterialHeader[SESS_LANGUAGE][3], fontListHeader));

            if (showHpp == 1) {
                table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
                table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                table.setDefaultCellBackgroundColor(bgColor);
                //table.addCell(new Phrase("HPP (Rp)", fontListHeader));
                table.addCell(new Phrase(PrintAllListPdf.textListMaterialHeader[SESS_LANGUAGE][6] + "(" + defaultCurrencyType.getCode() + ")", fontListHeader));
            ...
            table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
            table.setDefaultCellBackgroundColor(bgColor);
            //table.addCell(new Phrase("Mata Uang Jual", fontListHeader));
            table.addCell(new Phrase(PrintAllListPdf.textListMaterialHeader[SESS_LANGUAGE][13], fontListHeader));
            
            if (useForRaditya.equals("0")) {
                table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
                table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                table.setDefaultCellBackgroundColor(bgColor);
                //table.addCell(new Phrase("Harga Jual", fontListHeader));
                table.addCell(new Phrase(PrintAllListPdf.textListMaterialHeader[SESS_LANGUAGE][7], fontListHeader));
            }
    ...
    private static Table getContent(Vector vct, Document document, PdfWriter writer, SrcMaterial srcMaterial, int SESS_LANGUAGE) throws BadElementException, DocumentException {
        ...
        int showHpp = 0;
        showHpp = srcMaterial.getShowHpp();

        CurrencyType defaultCurrencyType = PstCurrencyType.getDefaultCurrencyType();
        //Table table = getListHeader();
        Table table = getListHeader(showHpp, SESS_LANGUAGE, defaultCurrencyType);
        ...
        if (body != null && body.size() > 0) {
            try {
                for (int i = 0; i < body.size(); i++) {
                    ...
                    if (showHpp == 1) {
                        table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
                        table.setDefaultVerticalAlignment(Table.ALIGN_RIGHT);
                        table.addCell(new Phrase("" + FRMHandler.userFormatStringDecimal(matUpdate.getAveragePrice()), fontLsContent));
                    }
                    ...
                    table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(currSell.getCode(), fontLsContent));
                    ...
                    if (useForRaditya.equals("0")) {
                        table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
                        table.setDefaultVerticalAlignment(Table.ALIGN_RIGHT);
                        table.addCell(new Phrase("" + FRMHandler.userFormatStringDecimal(priceSales), fontLsContent));
                    }
...
//                        table.deleteLastRow();
                        ...
                        document.add(getHeader(vHeader));
                        //table = getListHeader();
                        table = getListHeader(showHpp, SESS_LANGUAGE, defaultCurrencyType);
