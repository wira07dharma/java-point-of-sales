...
public class PendingOrderReportPdf extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                list = (Vector) sess.getValue("PENDING_ORDER_REPORT_PDF");
            } catch (Exception e) {
    ...
    private static Table getListHeader(Vector header) throws BadElementException, DocumentException {
        int ctnInt[] = {5, 10, 15, 30, 15, 10, 15};
        ...
        if (body != null && body.size() > 0) {
            try{
                for (int i = 0; i < body.size(); i++) {
                    ...
                    subTotalDp += Double.parseDouble((String)vctfrs.get(6));
                    ...
                    table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase(FRMHandler.userFormatStringDecimal(Double.parseDouble((String)vctfrs.get(6))), fontLsContent));
                    ...
                    if (!writer.fitsPage(table)) {
                        ...
                        /** Sub Total*/
                        tempFooter.add(FRMHandler.userFormatStringDecimal(subTotalDp));
