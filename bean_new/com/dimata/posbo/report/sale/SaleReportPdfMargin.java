...
public class SaleReportPdfMargin extends HttpServlet {
/* Generated by Together */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                list = (Vector) sess.getValue(SaleReportDocument.SALE_REPORT_DOC_MARGIN_PDF);
            } catch (Exception e) {
    ...
    private static Table getListHeader(Vector header) throws BadElementException, DocumentException {
        ...
        int ctnInt[] = {2,5,5, 10, 5, 5, 8,10,11,11}; 
...
//                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
//                    table.addCell(new Phrase((String)vctfrs.get(0), fontListHeader));
//
//                    table.setDefaultColspan(1);
//                    table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
//                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
//                    table.addCell(new Phrase((String)vctfrs.get(1), fontListHeader));
//
//                    table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
//                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
...
//                    table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
//                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
//                    table.addCell(new Phrase((String)vctfrs.get(3), fontListHeader));
...
//
                    table.setDefaultHorizontalAlignment(Table.ALIGN_RIGHT);
                    table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
                    table.addCell(new Phrase((String)footer.get(6), fontLsContent));
