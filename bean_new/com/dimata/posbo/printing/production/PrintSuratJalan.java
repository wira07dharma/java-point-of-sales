 ...
 * @author arise
 */
public class PrintSuratJalan extends HttpServlet {
	...
	public static com.lowagie.text.Font fontTitle = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 13, com.lowagie.text.Font.BOLD, PrintSuratJalan.border);
	public static com.lowagie.text.Font fontTitleUnderline = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 13, com.lowagie.text.Font.BOLD + com.lowagie.text.Font.UNDERLINE, PrintSuratJalan.border);
	public static com.lowagie.text.Font fontMainHeader = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 10, com.lowagie.text.Font.BOLD, PrintSuratJalan.border);
	public static com.lowagie.text.Font fontHeader = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 10, com.lowagie.text.Font.ITALIC, PrintSuratJalan.border);
	public static com.lowagie.text.Font fontHeaderUnderline = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 10, com.lowagie.text.Font.ITALIC + com.lowagie.text.Font.UNDERLINE, PrintSuratJalan.border);
	public static com.lowagie.text.Font fontListHeader = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 10, com.lowagie.text.Font.BOLD, PrintSuratJalan.border);
	public static com.lowagie.text.Font fontLsContent = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 8);
	public static com.lowagie.text.Font fontLsContentUnderline = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 8, com.lowagie.text.Font.UNDERLINE, PrintSuratJalan.border);
	public static com.lowagie.text.Font fontNormal = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 10);
	public static com.lowagie.text.Font fontNormalBold = new com.lowagie.text.Font(com.lowagie.text.Font.STRIKETHRU, 8, com.lowagie.text.Font.BOLD, PrintSuratJalan.border);
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			HeaderFooter footer = new HeaderFooter(new Phrase(new Chunk("", PrintSuratJalan.fontLsContent)), false);
			...
			document.add(PrintSuratJalan.getHeaderImage(SESS_LANGUAGE, gambar));
			document.add(PrintSuratJalan.getSubHeader(SESS_LANGUAGE, pinjaman, bm));

			document = PrintSuratJalan.getContent(listBarang, document, writer, SESS_LANGUAGE);
			document.add(PrintSuratJalan.getApproval(SESS_LANGUAGE, pinjaman, bm));
	...
	private static Table getHeaderImage(int SESS_LANGUAGE, com.lowagie.text.Image gambar)
		...
		try {
			...
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
			table.addCell(new Phrase(PrintSuratJalan.mainTitle[SESS_LANGUAGE][0].toUpperCase(), PrintSuratJalan.fontTitleUnderline));
	...
	private static void createEmptySpace(Table table, int space) throws BadElementException, DocumentException {
		for (int i = 0; i < space; i++) {
			...
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.setDefaultVerticalAlignment(Table.ALIGN_MIDDLE);
			table.addCell(new Phrase("", PrintSuratJalan.fontLsContent));
		}
	...
	private static Table getSubHeader(int SESS_LANGUAGE, Pinjaman pinjaman, BillMain bm)
		...
		// Nama -
		table.addCell(new Phrase(PrintSuratJalan.textHeaderMain[SESS_LANGUAGE][0], PrintSuratJalan.fontNormal));
		table.addCell(new Phrase(":", PrintSuratJalan.fontNormal));
		table.addCell(new Phrase(anggota.getName(), PrintSuratJalan.fontNormal));
		table.addCell(new Phrase("", PrintSuratJalan.fontNormal));
		...
		// Alamat -
		table.addCell(new Phrase(PrintSuratJalan.textHeaderMain[SESS_LANGUAGE][1], PrintSuratJalan.fontNormal));
		table.addCell(new Phrase(":", PrintSuratJalan.fontNormal));
		Cell cell = new Cell(new Phrase(anggota.getAddressPermanent(), PrintSuratJalan.fontNormal));
		cell.setColspan(2);
		table.addCell(cell);
		table.addCell(new Phrase(new Chunk("")));
		table.addCell(new Phrase(new Chunk("")));
	...
	private static Table getListHeader(int SESS_LANGUAGE) throws BadElementException, DocumentException {
		...
		table.setDefaultCellBackgroundColor(PrintSuratJalan.bgColor);
		...
		try {
			...
			//nomor
			Cell cell = new Cell(new Phrase(PrintSuratJalan.textHeaderItem[SESS_LANGUAGE][0],
					PrintSuratJalan.fontListHeader));
			table.addCell(cell);

			//nama barang
			table.setDefaultHorizontalAlignment(Table.ALIGN_LEFT);
			table.addCell(new Phrase(PrintSuratJalan.textHeaderItem[SESS_LANGUAGE][1],
					PrintSuratJalan.fontListHeader));
			//category
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.addCell(new Phrase(PrintSuratJalan.textHeaderItem[SESS_LANGUAGE][2],
					PrintSuratJalan.fontListHeader));
			//qty
			table.addCell(new Phrase(PrintSuratJalan.textHeaderItem[SESS_LANGUAGE][3],
					PrintSuratJalan.fontListHeader));
			//keterangan
			table.addCell(new Phrase(PrintSuratJalan.textHeaderItem[SESS_LANGUAGE][4],
					PrintSuratJalan.fontListHeader));
	...
	private static Document getContent(Vector lists, Document document, PdfWriter writer,
		...
		Table table = PrintSuratJalan.getListHeader(SESS_LANGUAGE);
		...
		try {
			for (int i = 0; i < lists.size(); i++) {
				...
				cell = new Cell(new Phrase(String.valueOf(i + 1), PrintSuratJalan.fontLsContent));
				table.addCell(cell);
				cell = new Cell(new Phrase(bd.getItemName(), PrintSuratJalan.fontLsContent));
				table.setDefaultHorizontalAlignment(Table.ALIGN_LEFT);
				table.addCell(cell);
				table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
				cell = new Cell(new Phrase(cat.getName(), PrintSuratJalan.fontLsContent));
				table.addCell(cell);
				cell = new Cell(new Phrase(Formater.formatNumber(bd.getQty(), "###"), PrintSuratJalan.fontLsContent));
				table.addCell(cell);
				cell = new Cell(new Phrase(bd.getNote(), PrintSuratJalan.fontLsContent));
				table.addCell(cell);
			}
			...
			descTable.addCell(new Phrase(textMessage[SESS_LANGUAGE][0], PrintSuratJalan.fontLsContent));
	...
	private static Table getApproval(int SESS_LANGUAGE, Pinjaman p, BillMain bm) throws BadElementException, DocumentException {
		...
		try {
			...
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.addCell(new Phrase("( " + konsumen.getName() + " )", PrintSuratJalan.fontLsContent));
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.addCell(new Phrase("( " + nameEmp + " )", PrintSuratJalan.fontLsContent));
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.addCell(new Phrase("(_________________________)", PrintSuratJalan.fontLsContent));
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.addCell(new Phrase(textApproval[SESS_LANGUAGE][0], PrintSuratJalan.fontLsContent));
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.addCell(new Phrase(textApproval[SESS_LANGUAGE][1], PrintSuratJalan.fontLsContent));
			table.setDefaultHorizontalAlignment(Table.ALIGN_CENTER);
			table.addCell(new Phrase(textApproval[SESS_LANGUAGE][2] + " " + textApproval[SESS_LANGUAGE][1], PrintSuratJalan.fontLsContent));
