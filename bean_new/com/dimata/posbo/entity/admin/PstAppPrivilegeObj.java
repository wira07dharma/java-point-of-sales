 ...
 */
   ...
   public static JSONObject fetchJSON(long oid){
      ...
      try {
         AppPrivilegeObj appPrivilegeObj = PstAppPrivilegeObj.fetch(oid);
         object.put(PstAppPrivilegeObj.fieldNames[PstAppPrivilegeObj.FLD_PRIV_OBJ_ID], appPrivilegeObj.getPrivObjId());
         object.put(PstAppPrivilegeObj.fieldNames[PstAppPrivilegeObj.FLD_PRIV_ID], appPrivilegeObj.getPrivId());
         object.put(PstAppPrivilegeObj.fieldNames[PstAppPrivilegeObj.FLD_CODE], appPrivilegeObj.getCode());
      }catch(Exception exc){}
      return object;
   }
