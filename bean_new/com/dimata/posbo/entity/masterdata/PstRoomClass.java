...
public class PstRoomClass extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_SHOW_INDEX = 3;
    ...
    public static RoomClass fetchExc(long oid) throws DBException {
        try {
            ...
            entRoomClass.setShowIndex(pstRoomClass.getInt(FLD_SHOW_INDEX));
            return entRoomClass;
    ...
    public static synchronized long updateExc(RoomClass entRoomClass) throws DBException {
        try {
            if (entRoomClass.getOID() != 0) {
                ...
                pstRoomClass.setInt(FLD_SHOW_INDEX, entRoomClass.getShowIndex());
                pstRoomClass.update();
                return entRoomClass.getOID();
            }
        } catch (DBException dbe) {
    ...
    public static void resultToObject(ResultSet rs, RoomClass entRoomClass) {
        try {
            ...
            entRoomClass.setShowIndex(rs.getInt(PstRoomClass.fieldNames[PstRoomClass.FLD_SHOW_INDEX]));
        } catch (Exception e) {
        }
    }
    ...
    public static JSONObject fetchJSON(long oid){
            ...
            try {
                RoomClass roomClass = PstRoomClass.fetchExc(oid);
                object.put(PstRoomClass.fieldNames[PstRoomClass.FLD_POS_ROOM_CLASS_ID], roomClass.getOID());
                object.put(PstRoomClass.fieldNames[PstRoomClass.FLD_CLASS_DESC], roomClass.getClassDesc());
                object.put(PstRoomClass.fieldNames[PstRoomClass.FLD_CLASS_NAME], roomClass.getClassName());
                object.put(PstRoomClass.fieldNames[PstRoomClass.FLD_SHOW_INDEX], roomClass.getShowIndex());
            }catch(Exception exc){}
