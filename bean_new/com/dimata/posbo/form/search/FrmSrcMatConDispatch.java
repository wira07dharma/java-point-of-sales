...
public class FrmSrcMatConDispatch extends FRMHandler implements I_FRMInterface, I_FRMType {
    private SrcMatConDispatch srcMaterialDispatchExc;
    ...
    public FrmSrcMatConDispatch() {
    }
    
    public FrmSrcMatConDispatch(SrcMatConDispatch srcMaterialDispatchExc) {
        this.srcMaterialDispatchExc = srcMaterialDispatchExc;
    }
    
    public FrmSrcMatConDispatch(HttpServletRequest request, SrcMatConDispatch srcMaterialDispatchExc) {
        super(new FrmSrcMatConDispatch(srcMaterialDispatchExc), request);
        this.srcMaterialDispatchExc = srcMaterialDispatchExc;
    }
    ...
    public SrcMatConDispatch getEntityObject(){ return srcMaterialDispatchExc; }
    
    public void requestEntityObject(SrcMatConDispatch srcMaterialDispatchExc) {
        try {
            this.requestParam();
