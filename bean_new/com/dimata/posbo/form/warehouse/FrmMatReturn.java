...
public class FrmMatReturn extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_CURRENCY_ID           = 15;
    ...
    public FrmMatReturn(MatReturn matReturn) {
        this.matReturn = matReturn;
    }
    
    public FrmMatReturn(HttpServletRequest request, MatReturn matReturn) {
        super(new FrmMatReturn(matReturn), request);
        this.matReturn = matReturn;
    }
    ...
    public MatReturn getEntityObject(){ return matReturn; }
    
    public void requestEntityObject(MatReturn matReturn) {
        try {
            this.requestParam();
            ...
            matReturn.setCurrencyId(getLong(FRM_FIELD_CURRENCY_ID));
        }
        catch(Exception e) {
