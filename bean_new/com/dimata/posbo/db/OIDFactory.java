...
{
    private static int appIdx = DBHandler.getIdxappIdx();
    ...
    synchronized public static long generateOID()
    {
        ...
        long oid = dateGenerated.getTime() + (0x0100000000000000L * DBHandler.getIdxappIdx());
        while(lastOID== oid){
	        try{
	            Thread.sleep(1);
	        }catch(Exception e){}
            dateGenerated = new Date();
			oid=dateGenerated.getTime() + (0x0100000000000000L * DBHandler.getIdxappIdx());
