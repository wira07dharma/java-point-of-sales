...
public class DBHandler implements I_DBType {
    ...
    private static int idxappIdx = 7;
    public static boolean configLoaded = false;
    public static DBConfigReader cnfReader;// = new DBConfigReader(CONFIG_FILE);

    /**
     * @return the idxappIdx
     */
    public static int getIdxappIdx() {
        return idxappIdx;
    }

    /**
     * @param aIdxappIdx the idxappIdx to set
     */
    public static void setIdxappIdx(int aIdxappIdx) {
        idxappIdx = aIdxappIdx;
    }
    ...
    throws DBException {
        if(!configLoaded) {
            ...
            try {
                ...
                //dinamis appidx
                String sIdxappIdx = configReader.getConfigValue("idxappIdx");   
                if(sIdxappIdx != null && !sIdxappIdx.equals("")) {
                    setIdxappIdx((new Integer(sIdxappIdx)).intValue());
                }        
    ...
    throws DBException {
        ...
        try {
            ...
            exception.printStackTrace(System.err);
            if(connPool!=null){
                System.out.println(">>>>>>> Current Connection : "+ connPool.getSize() + " of Max "+ dbMaxConn );
            }
        }
   ...
   protected String getFieldSetList() {
    ...
    public static int execUpdate(String sql, Connection connection)
    throws DBException {
        Statement statement = null;
