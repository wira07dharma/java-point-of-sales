...
public class SessJSON {
  ...
  public String toString() {
    json = (!json.equals("")) ? json : extract(this.data, type, keyset);
    return json;
  }
  ...
  public String deface() {
    return deface(this.json);
  }
  
  public static String deface(String str) {
    String d = (((((str.replace(":\"", ": ")).replace("\",", ", ")).replace("[","")).replace("]","<br>")).replace("\"", "")).replace(":\"", ": ");
