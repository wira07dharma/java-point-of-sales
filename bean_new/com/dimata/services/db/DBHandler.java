...
public class DBHandler implements I_DBType
{
    ...
    private static String pstName;
    private static String[] fieldNames;
    private static int[] fieldTypes;

    protected static Vector fieldValues;
    ...
    protected static void deleteRecords(int i, String s)
    throws DBException {
        if(s == "")
            return;
        Connection connection = null;
    ...
    protected static Vector getAllRecords(int i)
    throws DBException {
        loadConfig();
    ...
    protected static Vector getDetailsInt(String s, String s1)
    throws DBException {
    ...
    protected static Vector execQuery(String sql, String classNm)
    throws DBException {
        getLog();
        Connection connection = null;
        Statement statement = null;
