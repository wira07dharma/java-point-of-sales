...
public class SmartUpload {
    ...
    public void upload()
        ...
        for (; totalRead < m_totalBytes; totalRead += readBytes) {
            try {
                ...
                throw new SmartUploadException("Unable to upload file.");
            }
        }
        ...
        do {
            ...
            if (isFile) {
                com.dimata.util.blob.File newFile = new com.dimata.util.blob.File();
    ...
    public void uploadRename(String filePathName)
            throws SmartUploadException, IOException, ServletException {
        int totalRead = 0;
        int readBytes = 0;
        long totalFileSize = 0L;
        ...
        do {
            ...
            dataHeader = getDataHeader();
            m_currentIndex = m_currentIndex + 2;
            isFile = true; //dataHeader.indexOf("filename") > 0;
            fieldName = getDataFieldValue(dataHeader, "name");
            if (isFile) {
                //filePathName = getDataFieldValue(dataHeader, "filename");
