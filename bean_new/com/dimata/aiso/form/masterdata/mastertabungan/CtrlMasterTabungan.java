...
public static int RSLT_OK = 0;
	...
	public CtrlMasterTabungan (HttpServletRequest request){
		...
		masterTabungan = new MasterTabungan();
		...
		frmMasterTabungan = new FrmMasterTabungan(request, masterTabungan);
	...
	private String getSystemMessage(int msgCode){
		...
		switch (msgCode){
			...
			case I_DBExceptionInfo.MULTIPLE_ID :
				...
				this.frmMasterTabungan.addError(FrmMasterTabungan.FRM_FIELD_ID_TABUNGAN, resultText[language][RSLT_EST_CODE_EXIST] );
	...
	public MasterTabungan getMasterTabungan() { return masterTabungan; }



	public FrmMasterTabungan getForm() { return frmMasterTabungan; }
	...
	public int action(int cmd , long oidMasterTabungan){
		...
		switch(cmd){
			...
			case Command.SAVE :
				...
				frmMasterTabungan.requestEntityObject(masterTabungan);
				...
				if(masterTabungan.getOID()==0){
					...
					try{
						...
						long oid = pstMasterTabungan.insertExc(this.masterTabungan);
					...
					try {
						...
						long oid = pstMasterTabungan.updateExc(this.masterTabungan);
